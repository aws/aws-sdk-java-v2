...
public class ByteBufferingSubscriberTest {

    private static final int BUFFER_SIZE = 6;

    private static final Object data = ByteBuffer.allocate(1);
    ...
    public void setup() {
        ...
        bufferingSubscriber = new ByteBufferingSubscriber(mockSubscriber, BUFFER_SIZE);
