...
/**
 * Verifies the CRaC sync warm-up sends its GET through the real {@code Apache5HttpClient} discovered on the classpath.
...
public class Apache5HttpClientWarmUpTest {
    ...
    @Test
    public void warmAll_sendsWarmUpGetThroughApache5Client() {
