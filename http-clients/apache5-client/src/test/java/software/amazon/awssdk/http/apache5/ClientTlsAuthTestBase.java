...
abstract class ClientTlsAuthTestBase {
    ...
    protected static final String TEST_KEY_STORE = "/software/amazon/awssdk/http/apache5/server-keystore";
    protected static final String CLIENT_KEY_STORE = "/software/amazon/awssdk/http/apache5/client1.p12";
