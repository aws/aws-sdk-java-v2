...
public final class ProxyConfiguration implements ToCopyableBuilder<ProxyConfiguration.Builder, ProxyConfiguration> {
    ...
    /**
     * Returns the proxy host name either from the configured endpoint or from the {@code http.proxyHost} system property if
     * {@link Builder#useSystemPropertyValues(Boolean)} is set to {@code true}.
     */
    public String host() {
        return host;
    }
    ...
    /**
     * Returns the proxy port either from the configured endpoint or from the "http.proxyPort" system property if
     * {@link Builder#useSystemPropertyValues(Boolean)} is set to {@code true}.
     * <p>
     * If no value is found in neither of the above options, the default value of {@code 0} is returned.
     */
    public int port() {
        return port;
    }
    ...
    /**
     * Returns the {@link URI#getScheme() scheme} from the configured endpoint. Otherwise return null.
     */
