...
abstract class ClientTlsAuthTestBase {
    ...
    protected static final String TEST_KEY_STORE = "/software/amazon/awssdk/http/apache/async/server-keystore";
    protected static final String CLIENT_KEY_STORE = "/software/amazon/awssdk/http/apache/async/client1.p12";
