...
public class IdleConnectionReaperTest {
    ...
    private final Map<PoolingAsyncClientConnectionManager, Long> connectionManagers = new HashMap<>();
    ...
    public void doesNotShutDownExecutorIfNoManagerRemoved() {
        idleConnectionReaper.registerConnectionManager(connectionManager, 1L);
        PoolingAsyncClientConnectionManager someOtherConnectionManager = mock(PoolingAsyncClientConnectionManager.class);
    ...
    public void testReapsConnections() throws InterruptedException {
        ...
        try {
            ...
            verify(connectionManager, atLeastOnce()).closeIdle(eq(TimeValue.ofMilliseconds(idleTime)));
        } finally {
