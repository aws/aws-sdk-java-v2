...
import software.amazon.awssdk.http.urlconnection.internal.DefaultUrlConnectionFactory;
import software.amazon.awssdk.http.urlconnection.internal.UrlConnectionExecutableHttpRequest;
...
public final class UrlConnectionHttpClient implements SdkHttpClient {
    ...
    private UrlConnectionHttpClient(AttributeMap options, UrlConnectionFactory connectionFactory) {
        ...
        this.connectionFactory = DefaultUrlConnectionFactory.get(options, connectionFactory);
    }
    ...
    public ExecutableHttpRequest prepareRequest(HttpExecuteRequest request) {
        return new UrlConnectionExecutableHttpRequest(connectionFactory, request);
    }
