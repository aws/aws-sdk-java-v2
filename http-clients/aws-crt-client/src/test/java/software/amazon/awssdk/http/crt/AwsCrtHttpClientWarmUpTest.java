...
/**
 * Verifies the CRaC sync warm-up sends its GET through the real CRT sync client discovered on the classpath. The stub mirrors
 * a real STS {@code GET} (302 redirect, empty body); the warm-up must not follow the redirect.
 */
public class AwsCrtHttpClientWarmUpTest {

    @Rule
    public WireMockRule mockServer = new WireMockRule(0);

    @Test
    public void warmAll_sendsWarmUpGetThroughCrtClient() {
