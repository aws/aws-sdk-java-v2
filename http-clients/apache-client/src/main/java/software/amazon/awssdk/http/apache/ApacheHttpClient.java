...
public final class ApacheHttpClient implements SdkHttpClient {
    ...
    public interface Builder extends SdkHttpClient.Builder<ApacheHttpClient.Builder> {
         ...
         * <p>
         * When enabled, the actual KeepAlive mechanism is dependent on the Operating System and
         * therefore additional TCP KeepAlive values (timeout, number of packets, etc) must be configured via the Operating
         * System (sysctl on Linux/Mac, and Registry values on Windows).
         */
