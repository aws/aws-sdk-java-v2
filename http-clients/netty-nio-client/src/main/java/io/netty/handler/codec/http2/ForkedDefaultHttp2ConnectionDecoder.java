 ...
 */
@UnstableApi
public class ForkedDefaultHttp2ConnectionDecoder implements Http2ConnectionDecoder {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(ForkedDefaultHttp2ConnectionDecoder.class);
    ...
    public ForkedDefaultHttp2ConnectionDecoder(Http2Connection connection,
