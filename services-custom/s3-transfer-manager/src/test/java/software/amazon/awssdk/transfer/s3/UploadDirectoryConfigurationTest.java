...
public class UploadDirectoryConfigurationTest {
    ...
    public void getters_allPropertiesSet() {
        ...
        assertThat(object.followSymbolicLinks()).contains(true);
        assertThat(object.recursive()).contains(false);
        assertThat(object.maxDepth()).contains(100);
    }
    ...
    public void getters_allPropertiesAbsent() {
        ...
        assertThat(object.recursive()).isEmpty();
        assertThat(object.maxDepth()).isEmpty();
    }
    ...
    public void equalsHashCode() {
        ...
        assertThat(object1.hashCode()).isNotEqualTo(object3.hashCode());
    }
}
