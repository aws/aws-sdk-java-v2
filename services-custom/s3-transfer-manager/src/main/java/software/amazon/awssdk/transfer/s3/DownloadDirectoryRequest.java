...
public final class DownloadDirectoryRequest
    ...
    public interface Builder extends CopyableBuilder<Builder, DownloadDirectoryRequest> {
        ...
        /**
         * Specify a function used to transform the {@link DownloadFileRequest}s generated by this {@link DownloadDirectoryRequest}.
         * The provided function is called once for each file that is downloaded, allowing you to modify the paths resolved by
         * TransferManager on a per-file basis, modify the created {@link GetObjectRequest} before it is passed to S3, or
         ...
         * </pre>
         *
         * @param downloadFileRequestTransformer A transformer to use for modifying the file-level download requests before execution
         * @return This builder for method chaining
         */
        Builder downloadFileRequestTransformer(Consumer<DownloadFileRequest.Builder> downloadFileRequestTransformer);

        /**
         * Specify a function used to transform the {@link ListObjectsV2Request}s generated by this {@link DownloadDirectoryRequest}.
         * The provided function is called once, allowing you to modify {@link ListObjectsV2Request} before it is passed to S3.
         *
         * <p>The factory receives the {@link ListObjectsV2Request}s created by Transfer Manager and returns a (potentially modified)
