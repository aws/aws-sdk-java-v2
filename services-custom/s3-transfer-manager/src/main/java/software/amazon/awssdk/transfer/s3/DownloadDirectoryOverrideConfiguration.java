...
public final class DownloadDirectoryOverrideConfiguration implements ToCopyableBuilder<
    ...
    public interface Builder extends CopyableBuilder<Builder, DownloadDirectoryOverrideConfiguration> {
         ...
         *
         * <p>The factory receives the {@link DownloadFileRequest}s created by Transfer Manager for each file in the directory
         * being uploaded, and returns a (potentially modified) {@code DownloadFileRequest}.
         *
         * <p>
         * <b>Usage Example:</b>
         * <pre>
