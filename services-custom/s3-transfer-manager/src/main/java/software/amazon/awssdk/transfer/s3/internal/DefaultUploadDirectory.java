...
@SdkInternalApi
public class DefaultUploadDirectory implements UploadDirectory {
    private final CompletableFuture<CompletedUploadDirectory> completionFuture;

    public DefaultUploadDirectory(CompletableFuture<CompletedUploadDirectory> completionFuture) {
