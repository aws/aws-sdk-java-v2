...
public interface S3TransferManager extends SdkAutoCloseable {
     ...
     * requests, i.e., there might be failed uploads in a successfully completed response. As a result, you should check for
     ...
     */
    default DirectoryUpload downloadDirectory(DownloadDirectoryRequest downloadDirectoryRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     */
    default DirectoryUpload downloadDirectory(Consumer<DownloadDirectoryRequest.Builder> requestBuilder) {
        Validate.paramNotNull(requestBuilder, "requestBuilder");
