...
public interface EnhancedDocument {
    ...
    interface Builder {
        ...
        /**
         * Appends an attribute with the given name with a null value to the document builder. This method should be used if the
         * attribute needs to be explicitly set to null in the DynamoDB table         *
         * @param attributeName the name of the attribute to be added to the document.
