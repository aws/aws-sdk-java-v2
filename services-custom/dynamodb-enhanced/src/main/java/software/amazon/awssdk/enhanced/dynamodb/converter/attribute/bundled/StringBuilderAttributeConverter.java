...
public final class StringBuilderAttributeConverter implements AttributeConverter<StringBuilder> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(StringBuilder input, ConversionContext context) {
        return STRING_CONVERTER.toAttributeValue(input.toString(), context);
    }

    @Override
    public StringBuilder fromAttributeValue(ItemAttributeValue input,
                                            ConversionContext context) {
        return new StringBuilder(STRING_CONVERTER.fromAttributeValue(input, context));
    }
}
