...
public final class AutoGeneratedTimestampRecordExtension implements DynamoDbEnhancedClientExtension {
    ...
    private void processTopLevelMapAttribute(
        ...
        if (processed != value.m()) {
            updatedItems.put(key, AttributeValue.fastM(processed));
        }
    }
    ...
    private void processTopLevelListOfMapsAttribute(
        ...
        List<AttributeValue> updatedList = new ArrayList<>(value.l().size());
        for (AttributeValue listItem : value.l()) {
            if (hasMap(listItem)) {
                updatedList.add(AttributeValue.fastM(processNestedObject(listItem.m(),
                                                                     elementListSchema,
                                                                     currentInstant,
                                                                     nestedSchemaCache,
                                                                     listElementSchemaCache)));
        ...
        updatedItems.put(key, AttributeValue.fastL(updatedList));
    }
    ...
    private AttributeValue replacedNestedMapValueIfModified(
        ...
        return AttributeValue.fastM(processed);
    }
    ...
    private AttributeValue replacedNestedListValueIfModified(
        ...
        List<AttributeValue> updatedList = new ArrayList<>(nestedValue.l().size());
        ...
        for (AttributeValue listItem : nestedValue.l()) {
            if (hasMap(listItem)) {
                ...
                AttributeValue updatedItem = AttributeValue.fastM(processedItem);
        ...
        return AttributeValue.fastL(updatedList);
    }
