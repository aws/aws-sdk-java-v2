        ...
        for (Map.Entry<String, TableSchema<?>> pathEntry : schemasPerPath.entrySet()) {
            ...
            for (String attrName : customMetadataObject) {
                ...
                try {
                    ...
                    // Schema does not support converterForAttribute (e.g. custom or third-party schema).
                    // Skip this attribute — same behaviour as getNestedSchema.
                    continue;
                }
                if (converter != null) {
    ...
    private Map<String, AttributeValue> applyAutoGeneratedTimestampsToMap(
        ...
        for (String key : customMetadataObject) {
            ...
            try {
                ...
                // Schema does not support converterForAttribute (e.g. custom or third-party schema).
                // Skip this attribute — same behaviour as processFlattenedNestedAttributes.
                continue;
            }
            if (converter != null) {
                if (!mapCopied) {
