...
/**
 * Read-only metadata describing a vector index on a mapped table. Used when resolving {@code table.vectorIndex(indexName)}
...
public final class VectorIndexMetadata {
    ...
    private VectorIndexMetadata(Builder builder) {
    ...
    /**
     * Creates a {@link VectorIndexMetadata} from an {@link EnhancedVectorIndex}.
     */
    public static VectorIndexMetadata fromEnhancedVectorIndex(EnhancedVectorIndex enhancedVectorIndex) {
        return builder().indexName(enhancedVectorIndex.indexName())
                        .vectorAttributeName(enhancedVectorIndex.vectorAttributeName())
                        .dimensions(enhancedVectorIndex.dimensions())
                        .distanceFunction(enhancedVectorIndex.distanceFunction())
                        .projection(enhancedVectorIndex.projection())
                        .searchSchemaElements(enhancedVectorIndex.searchSchemaElements())
                        .build();
    }
    ...
    public boolean equals(Object o) {
        ...
        VectorIndexMetadata that = (VectorIndexMetadata) o;
    ...
    /**
     * A builder for {@link VectorIndexMetadata}.
     */
    @NotThreadSafe
    public static final class Builder {
        ...
        /**
         * Adds a single search schema element to this vector index definition. Elements are accumulated incrementally when
         * building vector index metadata from annotations.
         */
        public Builder addSearchSchemaElement(SearchSchemaElement element) {
            if (this.searchSchemaElements == null) {
                this.searchSchemaElements = new ArrayList<>();
            }
            this.searchSchemaElements.add(element);
            return this;
        }

        public VectorIndexMetadata build() {
            return new VectorIndexMetadata(this);
        }
    }
}
