 ...
 * Examples:
 * <ul>
 *     <li>{@code Instant.EPOCH.plusSeconds(1)} is stored as {@code ItemAttributeValue.fromString("1970-01-01T00:00:01Z")}</li>
 *     <li>{@code Instant.EPOCH.minusSeconds(1)} is stored as {@code ItemAttributeValue.fromString("1969-12-31T23:59:59Z")}</li>
 *     <li>{@code Instant.EPOCH.plusMillis(1)} is stored as {@code ItemAttributeValue.fromString("1970-01-01T00:00:00.001Z")}</li>
