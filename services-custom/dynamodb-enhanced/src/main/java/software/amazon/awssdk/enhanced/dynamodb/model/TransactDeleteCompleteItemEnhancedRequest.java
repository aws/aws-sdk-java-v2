 ...
 * {@link DynamoDbEnhancedAsyncClient#transactWriteItems(TransactWriteItemsEnhancedRequest)} operation.
 * <p>
 * A valid request object must contain a primary {@link Key} to reference the item to delete.
 */
@SdkPublicApi
@ThreadSafe
public final class TransactDeleteCompleteItemEnhancedRequest<T> {
    ...
    private TransactDeleteCompleteItemEnhancedRequest(Builder<T> builder) {
     ...
     * {@link ReturnValuesOnConditionCheckFailure#UNKNOWN_TO_SDK_VERSION}. The raw value returned by the service is available from
     * {@link #returnValuesOnConditionCheckFailureAsString}.
     *
    ...
    public boolean equals(Object o) {
        ...
        TransactDeleteCompleteItemEnhancedRequest<?> that = (TransactDeleteCompleteItemEnhancedRequest<?>) o;
    ...
    public static final class Builder<T> {
        ...
        /**
         * Sets the primary {@link Key} that will be used to match the item to delete on the builder by accepting a consumer of
         * {@link Key.Builder}.
         *
        ...
        /**
         * Sets the item to delete from DynamoDB. The key will be extracted from this item. This is useful when you want to delete
         * an item with version checking.
         *
        ...
        /**
         * Defines a logical expression on an item's attribute values which, if evaluating to true, will allow the delete
         * operation to succeed. If evaluating to false, the operation will not succeed.
         * <p>
        ...
        /**
         * Use <code>ReturnValuesOnConditionCheckFailure</code> to get the item attributes if the <code>Delete</code> condition
        ...
        public TransactDeleteCompleteItemEnhancedRequest<T> build() {
            return new TransactDeleteCompleteItemEnhancedRequest<>(this);
        }
    }
}