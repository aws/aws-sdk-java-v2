...
/**
 * A converter between {@link ZonedDateTime} and {@link ItemAttributeValue}.
 *
 * <p>
 ...
 *     {@code ItemAttributeValue.fromString("-999999999-01-01T00:00:00+18:00")}</li>
 ...
 *     {@code ItemAttributeValue.fromString("1970-01-01T00:00:00Z")}</li>
 * </ul>
 *
 * <p>
...
public final class ZonedDateTimeAsStringAttributeConverter implements AttributeConverter<ZonedDateTime> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(ZonedDateTime input, ConversionContext context) {
        return TimeConversion.toStringAttributeValue(input);
    }

    @Override
    public ZonedDateTime fromAttributeValue(ItemAttributeValue input,
                                            ConversionContext context) {
        return TimeConversion.zonedDateTimeFromAttributeValue(input);
    }
}
