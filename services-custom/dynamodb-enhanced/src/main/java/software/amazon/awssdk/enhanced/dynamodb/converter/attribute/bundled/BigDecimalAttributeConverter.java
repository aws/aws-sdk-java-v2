...
/**
 * A converter between {@link BigDecimal} and {@link ItemAttributeValue}.
 *
 * <p>
...
public final class BigDecimalAttributeConverter implements AttributeConverter<BigDecimal> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(BigDecimal input, ConversionContext context) {
        return ItemAttributeValue.fromNumber(STRING_CONVERTER.toString(input));
    }

    @Override
    public BigDecimal fromAttributeValue(ItemAttributeValue input,
