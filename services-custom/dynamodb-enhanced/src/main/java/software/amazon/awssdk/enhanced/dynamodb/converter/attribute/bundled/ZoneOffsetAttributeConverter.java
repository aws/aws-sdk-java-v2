...
/**
 * A converter between {@link ZoneOffset} and {@link ItemAttributeValue}.
 *
 * <p>
...
public final class ZoneOffsetAttributeConverter implements AttributeConverter<ZoneOffset> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(ZoneOffset input, ConversionContext context) {
        return ItemAttributeValue.fromString(STRING_CONVERTER.toString(input));
    }

    @Override
    public ZoneOffset fromAttributeValue(ItemAttributeValue input,
