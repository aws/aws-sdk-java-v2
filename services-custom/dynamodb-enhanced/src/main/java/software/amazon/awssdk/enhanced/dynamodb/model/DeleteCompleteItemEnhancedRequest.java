...
@SdkPublicApi
@ThreadSafe
public final class DeleteCompleteItemEnhancedRequest<T> {
    ...
    private DeleteCompleteItemEnhancedRequest(Builder<T> builder) {
    ...
    public boolean equals(Object o) {
        ...
        DeleteCompleteItemEnhancedRequest that = (DeleteCompleteItemEnhancedRequest) o;
    ...
    public static final class Builder<T> {
        ...
        public DeleteCompleteItemEnhancedRequest<T> build() {
            return new DeleteCompleteItemEnhancedRequest<>(this);
        }
    }
}
