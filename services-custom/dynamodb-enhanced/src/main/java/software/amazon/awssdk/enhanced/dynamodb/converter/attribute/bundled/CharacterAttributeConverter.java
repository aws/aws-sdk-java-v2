...
/**
 * A converter between {@link Character} and {@link ItemAttributeValue}.
 *
 * <p>
...
public final class CharacterAttributeConverter implements AttributeConverter<Character> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(Character input, ConversionContext context) {
        return ItemAttributeValue.fromString(STRING_CONVERTER.toString(input));
    }

    @Override
    public Character fromAttributeValue(ItemAttributeValue input,
