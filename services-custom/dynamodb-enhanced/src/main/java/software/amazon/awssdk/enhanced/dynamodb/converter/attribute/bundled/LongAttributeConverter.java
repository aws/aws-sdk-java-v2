...
/**
 * A converter between {@link Long} and {@link ItemAttributeValue}.
 *
 * <p>
...
@ThreadSafe
@Immutable
public final class LongAttributeConverter implements AttributeConverter<Long> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(Long input, ConversionContext context) {
        return ItemAttributeValue.fromNumber(STRING_CONVERTER.toString(input));
    }

    @Override
    public Long fromAttributeValue(ItemAttributeValue input,
