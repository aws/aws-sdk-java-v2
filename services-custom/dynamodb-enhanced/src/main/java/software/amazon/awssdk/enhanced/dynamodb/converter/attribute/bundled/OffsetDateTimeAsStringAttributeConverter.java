...
/**
 * A converter between {@link OffsetDateTime} and {@link ItemAttributeValue}.
 *
 * <p>
 ...
 * Examples:
 * <ul>
 *     <li>{@code OffsetDateTime.MIN} is stored as {@code ItemAttributeValue.fromString("-999999999-01-01T00:00:00+18:00")}</li>
 *     <li>{@code OffsetDateTime.MAX} is stored as
 *     {@code ItemAttributeValue.fromString("+999999999-12-31T23:59:59.999999999-18:00")}</li>
 *     <li>{@code Instant.EPOCH.atOffset(ZoneOffset.UTC).plusSeconds(1)} is stored as
 *     {@code ItemAttributeValue.fromString("1970-01-01T00:00:01Z")}</li>
 *     <li>{@code Instant.EPOCH.atOffset(ZoneOffset.UTC).minusSeconds(1)} is stored as
 *     {@code ItemAttributeValue.fromString("1969-12-31T23:59:59Z")}</li>
 *     <li>{@code Instant.EPOCH.atOffset(ZoneOffset.UTC).plusMillis(1)} is stored as
 *     {@code ItemAttributeValue.fromString("1970-01-01T00:00:00.001Z")}</li>
 *     <li>{@code Instant.EPOCH.atOffset(ZoneOffset.UTC).minusMillis(1)} is stored as
 *     {@code ItemAttributeValue.fromString("1969-12-31T23:59:59.999Z")}</li>
 *     <li>{@code Instant.EPOCH.atOffset(ZoneOffset.UTC).plusNanos(1)} is stored as
 *     {@code ItemAttributeValue.fromString("1970-01-01T00:00:00.000000001Z")}</li>
 *     <li>{@code Instant.EPOCH.atOffset(ZoneOffset.UTC).minusNanos(1)} is stored as
 *     {@code ItemAttributeValue.fromString("1969-12-31T23:59:59.999999999Z")}</li>
 * </ul>
 *
 * <p>
...
public final class OffsetDateTimeAsStringAttributeConverter implements AttributeConverter<OffsetDateTime> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(OffsetDateTime input, ConversionContext context) {
        return TimeConversion.toStringAttributeValue(input);
    }

    @Override
    public OffsetDateTime fromAttributeValue(ItemAttributeValue input,
                                             ConversionContext context) {
        return TimeConversion.offsetDateTimeFromAttributeValue(input);
    }
}
