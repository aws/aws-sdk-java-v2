...
public final class AttributeTypes {
    ...
    public static AttributeType<Boolean> booleanType() {
        return StaticAttributeType.create(obj -> AttributeValue.builder().bool(obj).build(),
                                          AttributeValue::bool,
                                          AttributeValueType.BOOL);
    }

    public static AttributeType<String> stringType() {
        return StaticAttributeType.create(obj -> AttributeValue.builder().s(obj).build(),
                                AttributeValue::s,
    ...
    public static AttributeType<Set<String>> stringSetType() {
        return StaticAttributeType.create(stringSet -> AttributeValue.builder().ss(stringSet).build(),
    ...
    public static <T extends Number> AttributeType<T> numberType(Function<String, T> stringToNumber) {
        return StaticAttributeType.create(obj -> AttributeValue.builder().n(obj.toString()).build(),
