...
public final class AtomicBooleanAttributeConverter implements AttributeConverter<AtomicBoolean> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(AtomicBoolean input, ConversionContext context) {
        return ItemAttributeValue.fromBoolean(input.get());
    }

    @Override
    public AtomicBoolean fromAttributeValue(ItemAttributeValue input,
