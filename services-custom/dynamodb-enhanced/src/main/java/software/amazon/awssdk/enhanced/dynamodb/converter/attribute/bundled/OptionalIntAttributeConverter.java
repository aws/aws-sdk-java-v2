...
/**
 * A converter between {@link OptionalInt} and {@link ItemAttributeValue}.
 *
 * <p>
 ...
 * the {@link OptionalSubtypeAttributeConverter} along with a {@link BigInteger}. For shorter numbers, consider using the
...
public final class OptionalIntAttributeConverter implements AttributeConverter<OptionalInt> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(OptionalInt input, ConversionContext context) {
        if (input.isPresent()) {
    ...
    @Override
    public OptionalInt fromAttributeValue(ItemAttributeValue input,
