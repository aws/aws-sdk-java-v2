...
/**
 * A converter between {@link LocalDate} and {@link ItemAttributeValue}.
 *
 * <p>
 ...
 * Examples:
 * <ul>
 *     <li>{@code LocalDate.of(1988, 5, 21)} is stored as {@code ItemAttributeValue.fromNumber("19880521000000")}</li>
 *     <li>{@code LocalDateTime.of(-1988, 5, 21)} is stored as {@code ItemAttributeValue.fromNumber("-19880521000000")}</li>
 * </ul>
 *
 * <p>
...
public final class LocalDateAttributeConverter implements AttributeConverter<LocalDate> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(LocalDate input, ConversionContext context) {
        return LOCAL_DATE_TIME_ATTRIBUTE_CONVERTER.toAttributeValue(input.atStartOfDay(), context);
    }

    @Override
    public LocalDate fromAttributeValue(ItemAttributeValue input,
                                        ConversionContext context) {
        return LOCAL_DATE_TIME_ATTRIBUTE_CONVERTER.fromAttributeValue(input, context).toLocalDate();
    }
}
