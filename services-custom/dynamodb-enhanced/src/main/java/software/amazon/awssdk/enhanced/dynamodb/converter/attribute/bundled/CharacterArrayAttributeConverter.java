...
/**
 * A converter between {@code char[]} and {@link ItemAttributeValue}.
 *
 * <p>
...
public final class CharacterArrayAttributeConverter implements AttributeConverter<char[]> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(char[] input, ConversionContext context) {
        return ItemAttributeValue.fromString(CHAR_ARRAY_STRING_CONVERTER.toString(input));
    }

    @Override
    public char[] fromAttributeValue(ItemAttributeValue input,
                                     ConversionContext context) {
        return CHAR_ARRAY_STRING_CONVERTER.fromString(STRING_ATTRIBUTE_CONVERTER.fromAttributeValue(input,
                                                                                                    context));
    }
}
