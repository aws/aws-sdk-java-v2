...
@SdkPublicApi
@ThreadSafe
public interface DynamoDbAsyncVectorIndex<T> {
     ...
     * @return A {@link CompletableFuture} of {@link SearchVectorsEnhancedResponse}.
     */
    default CompletableFuture<SearchVectorsEnhancedResponse<T>> searchVectorsWithResponse(
