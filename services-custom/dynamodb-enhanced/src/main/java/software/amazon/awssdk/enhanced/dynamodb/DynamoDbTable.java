...
public interface DynamoDbTable<T> extends MappedTableResource<T> {
     ...
     * @return A {@link DynamoDbVectorIndex} object that can be used to execute vector search commands against.
     */
    default DynamoDbVectorIndex<T> vectorIndex(String indexName) {
