...
/**
 * A converter between {@link LocalDateTime} and {@link ItemAttributeValue}.
 *
 * <p>
 ...
 *     {@code ItemAttributeValue.fromNumber("19880521000000")}</li>
 *     <li>{@code LocalDateTime.of(-1988, 5, 21, 0, 0, 0)} is stored as
 *     {@code ItemAttributeValue.fromNumber("-19880521000000")}</li>
 *     <li>{@code LocalDateTime.of(1988, 5, 21, 0, 0, 0).plusSeconds(1)} is stored as
 *     {@code ItemAttributeValue.fromNumber("19880521000001")}</li>
 *     <li>{@code LocalDateTime.of(1988, 5, 21, 0, 0, 0).minusSeconds(1)} is stored as
 *     {@code ItemAttributeValue.fromNumber("19880520235959")}</li>
 *     <li>{@code LocalDateTime.of(1988, 5, 21, 0, 0, 0).plusNanos(1)} is stored as
 *     {@code ItemAttributeValue.fromNumber("19880521000000.0000000001")}</li>
 *     <li>{@code LocalDateTime.of(1988, 5, 21, 0, 0, 0).minusNanos(1)} is stored as
 *     {@code ItemAttributeValue.fromNumber("19880520235959.999999999")}</li>
 * </ul>
 *
 * <p>
...
public final class LocalDateTimeAttributeConverter implements AttributeConverter<LocalDateTime> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(LocalDateTime input, ConversionContext context) {
        String value = "" +
                       input.getYear() +
    ...
    @Override
    public LocalDateTime fromAttributeValue(ItemAttributeValue input,
