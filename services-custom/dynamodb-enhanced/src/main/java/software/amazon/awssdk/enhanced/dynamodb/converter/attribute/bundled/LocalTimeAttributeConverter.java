...
/**
 * A converter between {@link LocalTime} and {@link ItemAttributeValue}.
 *
 * <p>
 ...
 * Examples:
 * <ul>
 *     <li>{@code LocalTime.of(5, 30, 0)} is stored as {@code ItemAttributeValue.fromNumber("053000")}</li>
 *     <li>{@code LocalDateTime.of(5, 30, 0, 1)} is stored as {@code ItemAttributeValue.fromNumber("053000.000000001")}</li>
 * </ul>
 *
 * <p>
...
public final class LocalTimeAttributeConverter implements AttributeConverter<LocalTime> {
    ...
    @Override
    public ItemAttributeValue toAttributeValue(LocalTime input, ConversionContext context) {
        String value = "" +
    ...
    @Override
    public LocalTime fromAttributeValue(ItemAttributeValue input,
