...
import software.amazon.awssdk.extensions.dynamodb.mappingclient.converter.internal.TimeConversion;
 ...
 * Examples:
 * <ul>
 *     <li>{@code OffsetDateTime.MIN} is stored as {@code ItemAttributeValueMapper.fromString("-999999999-01-01T00:00:00+18:00")}</li>
...
public final class OffsetDateTimeAsStringAttributeConverter implements AttributeConverter<OffsetDateTime> {
    ...
    public OffsetDateTime transformTo(AttributeValue input) {
        return TimeConversion.offsetDateTimeFromAttributeValue(ItemAttributeValue.fromGeneratedAttributeValue(input));
    }
}
