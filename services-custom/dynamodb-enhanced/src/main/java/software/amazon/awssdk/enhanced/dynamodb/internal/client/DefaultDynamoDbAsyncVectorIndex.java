...
import software.amazon.awssdk.enhanced.dynamodb.DynamoDbAsyncVectorIndex;
...
@SdkInternalApi
public final class DefaultDynamoDbAsyncVectorIndex<T> implements DynamoDbAsyncVectorIndex<T> {
    ...
    DefaultDynamoDbAsyncVectorIndex(DynamoDbAsyncClient dynamoDbClient,
    ...
    @Override
    public CompletableFuture<SearchVectorsEnhancedResponse<T>> searchVectorsWithResponse(
        SearchVectorsEnhancedRequest request) {
        SearchVectorsOperation<T> operation = SearchVectorsOperation.create(request);
        return operation.executeOnVectorIndexAsync(tableSchema, tableName, indexName, extension, dynamoDbClient);
    }
    ...
    public boolean equals(Object o) {
        ...
        DefaultDynamoDbAsyncVectorIndex<?> that = (DefaultDynamoDbAsyncVectorIndex<?>) o;
