...
import software.amazon.awssdk.enhanced.dynamodb.model.RecordWithFlattenMap;
...
public abstract class DynamoDbEnhancedIntegrationTestBase extends AwsIntegrationTestBase {
    ...
    protected static final TableSchema<RecordWithFlattenMap> RECORD_WITH_FLATTEN_MAP_TABLE_SCHEMA =
        StaticTableSchema.builder(RecordWithFlattenMap.class)
                         .newItemSupplier(RecordWithFlattenMap::new)
                         .addAttribute(String.class, a -> a.name("id")
                                                           .getter(RecordWithFlattenMap::getId)
                                                           .setter(RecordWithFlattenMap::setId)
                                                           .tags(primaryPartitionKey(), secondaryPartitionKey("index1")))
                         .addAttribute(Integer.class, a -> a.name("sort")
                                                            .getter(RecordWithFlattenMap::getSort)
                                                            .setter(RecordWithFlattenMap::setSort)
                                                            .tags(primarySortKey(), secondarySortKey("index1")))
                         .addAttribute(Integer.class, a -> a.name("value")
                                                            .getter(RecordWithFlattenMap::getValue)
                                                            .setter(RecordWithFlattenMap::setValue))
                         .addAttribute(String.class, a -> a.name("gsi_id")
                                                           .getter(RecordWithFlattenMap::getGsiId)
                                                           .setter(RecordWithFlattenMap::setGsiId)
                                                           .tags(secondaryPartitionKey("gsi_keys_only")))
                         .addAttribute(Integer.class, a -> a.name("gsi_sort")
                                                            .getter(RecordWithFlattenMap::getGsiSort)
                                                            .setter(RecordWithFlattenMap::setGsiSort)
                                                            .tags(secondarySortKey("gsi_keys_only")))
                         .addAttribute(String.class, a -> a.name("stringAttribute")
                                                           .getter(RecordWithFlattenMap::getStringAttribute)
                                                           .setter(RecordWithFlattenMap::setStringAttribute))
                         .flatten("attributesMap",
                                  RecordWithFlattenMap::getAttributesMap,
                                  RecordWithFlattenMap::setAttributesMap)
                         .build();
    ...
    protected static final List<RecordWithFlattenMap> RECORDS_WITH_FLATTEN_MAP =
        IntStream.range(0, 9)
                 .mapToObj(i -> new RecordWithFlattenMap()
                     .setId("id-value")
                     .setSort(i)
                     .setValue(i)
                     .setStringAttribute(getStringAttrValue(10 * 1024))
