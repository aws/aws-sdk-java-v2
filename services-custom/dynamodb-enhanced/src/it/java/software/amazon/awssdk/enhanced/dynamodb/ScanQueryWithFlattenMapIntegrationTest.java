...
public class ScanQueryWithFlattenMapIntegrationTest extends DynamoDbEnhancedIntegrationTestBase {
    ...
    private static DynamoDbTable<RecordWithFlattenMap> mappedTable;
    ...
    public void queryWithFlattenMapRecord_correctlyRetrievesProjectedAttributes() {
        ...
        Iterator<Page<RecordWithFlattenMap>> results =
        ...
        Page<RecordWithFlattenMap> page1 = results.next();
        assertThat(results.hasNext(), is(true));
        Page<RecordWithFlattenMap> page2 = results.next();
        ...
        List<RecordWithFlattenMap> page1Items = page1.items();
        ...
        List<RecordWithFlattenMap> page2Items = page2.items();
