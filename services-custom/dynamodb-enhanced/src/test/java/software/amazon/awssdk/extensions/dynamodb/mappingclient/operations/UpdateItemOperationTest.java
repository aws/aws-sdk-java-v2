...
public class UpdateItemOperationTest {
    ...
    public void generateRequest_withExtensions_conflictingExpressionValue_throwsRuntimeException() {
        ...
        try {
            updateItemOperation.generateRequest(FakeItem.getTableSchema(), PRIMARY_CONTEXT, mockMapperExtension);
    ...
    public void transformResponse_withExtension_returnsCorrectTransformedItem() {
        ...
        when(mockMapperExtension.afterRead(anyMap(), any(), any())).thenReturn(
        ...
        verify(mockMapperExtension).afterRead(baseFakeMap, PRIMARY_CONTEXT, FakeItem.getTableMetadata());
    }
    ...
    public void transformResponse_afterReadThrowsException_throwsIllegalStateException() {
        ...
        updateItemOperation.transformResponse(response, FakeItem.getTableSchema(), PRIMARY_CONTEXT, mockMapperExtension);
    }
    ...
    public void generateTransactWriteItem_basicRequest() {
        ...
        verify(updateItemOperation).generateRequest(FakeItem.getTableSchema(), context, mockMapperExtension);
    }
