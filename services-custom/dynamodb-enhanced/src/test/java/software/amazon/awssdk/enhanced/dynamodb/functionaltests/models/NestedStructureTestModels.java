...
/**
 * Shared models used by various tests for nested structures, auto-generated timestamps, and update behavior testing. This file
 * contains models for different schema types (Bean, Immutable, Static, Static-Immutable) with various nesting levels and
 * collection types.
 */
public final class NestedStructureTestModels {

    private NestedStructureTestModels() {
    }
    ...
    public static class SimpleBeanWithList {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(id, attr, time, childList);
        }
    }
    ...
    public static class SimpleBeanWithSet {
        ...
        public SimpleBeanWithSet setAttr(String attr) {
            this.attr = attr;
            return this;
        }
    ...
    public static class SimpleBeanWithMap {
        ...
        public SimpleBeanWithMap setAttr(String attr) {
            this.attr = attr;
            return this;
        }
    ...
    public static class SimpleBeanChild {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(id, that.id) && Objects.equals(attr, that.attr) && Objects.equals(time, that.time);
        }

        @Override
        public int hashCode() {
            return Objects.hash(id, attr, time);
        }
    }
    ...
    public static class NestedBeanWithList {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(id, attr, time, level2);
        }
    }
    ...
    public static TableSchema<SimpleImmutableRecordWithList> buildStaticImmutableSchemaForSimpleRecordWithList() {
        TableSchema<SimpleImmutableChild> childSchema =
            StaticImmutableTableSchema.builder(SimpleImmutableChild.class, SimpleImmutableChild.Builder.class)
        ...
        return StaticImmutableTableSchema.builder(SimpleImmutableRecordWithList.class, SimpleImmutableRecordWithList.Builder.class)
