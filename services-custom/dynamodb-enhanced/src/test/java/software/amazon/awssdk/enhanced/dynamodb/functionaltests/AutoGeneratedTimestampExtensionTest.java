...
public class AutoGeneratedTimestampExtensionTest extends LocalDynamoDbSyncTestBase {
        ...
        StaticTableSchema
            ...
            .addAttribute(
                EnhancedType.documentOf(
                    BeanWithInvalidNestedAttributeName.BeanWithInvalidNestedAttributeNameChild.class,
                    StaticTableSchema
                        .builder(BeanWithInvalidNestedAttributeName.BeanWithInvalidNestedAttributeNameChild.class)
                        .newItemSupplier(BeanWithInvalidNestedAttributeName.BeanWithInvalidNestedAttributeNameChild::new)
                        .addAttribute(Instant.class,
                                      a -> a.name("childAttr_NESTED_ATTR_UPDATE_")
                                            .getter(BeanWithInvalidNestedAttributeName.BeanWithInvalidNestedAttributeNameChild::getAttr_NESTED_ATTR_UPDATE_)
                                            .setter(BeanWithInvalidNestedAttributeName.BeanWithInvalidNestedAttributeNameChild::setAttr_NESTED_ATTR_UPDATE_)
                                            .tags(autoGeneratedTimestampAttribute()))
                        .build()),
    ...
    public void beforeWrite_withListContainingNullElements_handlesNullsGracefully() {
        ...
        List<AutogeneratedTimestampTestModels.SimpleBeanChild> listWithNulls = new ArrayList<>();
        listWithNulls.add(null);
        listWithNulls.add(new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child1"));
        listWithNulls.add(null);
        listWithNulls.add(new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child2"));
    ...
    public void beforeWrite_withNestedListOfMaps_updatesTimestampsInListElements() {
        ...
        SimpleBeanWithList item = new SimpleBeanWithList()
            ...
            .setChildList(Arrays.asList(
                new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child1"),
                new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child2"),
                new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child3")
            ));
    ...
    public void beforeWrite_withMultipleNestedListUpdates_updatesAllTimestamps() {
        ...
        table.updateItem(new SimpleBeanWithList()
                             .setId("1")
                             .setChildList(Arrays.asList(
                                 new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child1_updated"),
                                 new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child2_updated"),
                                 new AutogeneratedTimestampTestModels.SimpleBeanChild().setId("child3_new")
                             )));
