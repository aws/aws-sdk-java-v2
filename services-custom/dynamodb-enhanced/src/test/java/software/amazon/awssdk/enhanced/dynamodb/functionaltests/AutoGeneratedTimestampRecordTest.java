...
public class AutoGeneratedTimestampRecordTest extends LocalDynamoDbSyncTestBase {
    ...
    public void putNewRecordSetsInitialAutoGeneratedTimestampIncludingNestedFields() {
        ...
        Record expectedRecord = new Record().setId("id")
                                            ...
                                            .setNestedRecord(expectedNestedRecord);
    ...
    public void updateNewRecordSetsAutoFormattedDate() {
        Record result = mappedTable.updateItem(r -> r.item(new Record().setId("id").setAttribute("one")
                                                                       .setNestedRecord(new NestedRecord()
                                                                                            .setNestedAttribute("attribute"))));
        GetItemResponse itemAsStoredInDDB = getItemAsStoredFromDDB();
        FlattenedRecord flattenedRecord = new FlattenedRecord().setGenerated(MOCKED_INSTANT_NOW);
        NestedRecord expectedNestedRecord = new NestedRecord().setNestedTimeAttribute(MOCKED_INSTANT_NOW)
    ...
    public void putItemFollowedByUpdatesShouldGenerateTimestampsOnNestedFields() {
        ...
        assertThat(itemAsStoredInDDB.item().get("nestedRecord").m().get("nestedAttribute").s(), is("attribute"));
        ...
        mappedTable.updateItem(r -> r.item(new Record().setId("id").setAttribute("one")
                                                       .setNestedRecord(new NestedRecord().setNestedAttribute(
                                                           "attribute1"))));
        itemAsStoredInDDB = getItemAsStoredFromDDB();

        assertThat(itemAsStoredInDDB.item().get("nestedRecord").m().get("nestedAttribute").s(), is("attribute1"));
        assertThat(itemAsStoredInDDB.item().get("nestedRecord").m().get("nestedTimeAttribute").s(),
        ...
        assertThat(itemAsStoredInDDB.item().get("nestedRecord").m().get("nestedAttribute").s(), is("attribute2"));
        assertThat(itemAsStoredInDDB.item().get("nestedRecord").m().get("nestedTimeAttribute").s(),
    ...
    private static class Record {
        ...
        public NestedRecord getNestedRecord() { return nestedRecord;}

        public Record setNestedRecord(NestedRecord nestedRecord) {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(id, record.id) &&
                   ...
                   Objects.equals(nestedRecord, record.nestedRecord);
        }
    ...
    private static class NestedRecord {
        ...
        public NestedRecord setNestedTimeAttribute(Instant nestedTimeAttribute) {
