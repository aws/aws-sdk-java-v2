...
import software.amazon.awssdk.enhanced.dynamodb.mapper.testbeans.flattenmap.NestedMultipleFlattenMapBean;
...
public class FlattenMapBeanTableSchemaTest {
    ...
    public void serializeBean_withFlattenMapAndFlattenRecord_successfullyFlattens() {
        ...
        BeanTableSchema<FlattenMapAndFlattenRecordBean> beanTableSchema =
            BeanTableSchema.create(FlattenMapAndFlattenRecordBean.class);
        Map<String, AttributeValue> itemMap = beanTableSchema.itemToMap(bean, true);
    ...
    @Test
    public void serializeBean_withNestedMultipleFlattenMaps_throwsIllegalArgumentException() {
        exception.expect(IllegalArgumentException.class);
        exception.expectMessage("Multiple @DynamoDbFlatten Map<String, String> properties found. "
                                + "Only one flattened map per class is supported.");

        BeanTableSchema.create(NestedMultipleFlattenMapBean.class);
    }
