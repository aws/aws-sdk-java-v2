...
@DynamoDbBean
public class MultipleFlattenMapsOnRecordInvalidBean {
    private String id;
    ...
    public void setSecondaryAttributesMap(Map<String, String> abstractMap) {
        this.secondaryAttributesMap = abstractMap;
    }
}