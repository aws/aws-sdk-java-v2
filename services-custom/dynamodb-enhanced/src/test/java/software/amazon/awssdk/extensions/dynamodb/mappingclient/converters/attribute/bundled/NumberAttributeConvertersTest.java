...
import software.amazon.awssdk.extensions.dynamodb.mappingclient.converter.attribute.bundled.BigIntegerAttributeConverter;
...
public class NumberAttributeConvertersTest {
    ...
    public void atomicIntegerAttributeConverterBehaves() {
        ...
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("1.0")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("1.0")));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(Integer.toString(Integer.MIN_VALUE))))
                .hasValue(Integer.MIN_VALUE);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("-42"))).hasValue(-42);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-42"))).hasValue(-42);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).hasValue(0);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42"))).hasValue(42);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("42"))).hasValue(42);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(Integer.toString(Integer.MAX_VALUE))))
    ...
    public void atomicLongAttributeConverterBehaves() {
        ...
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("1.0")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("1.0")));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(Long.toString(Long.MIN_VALUE))))
        ...
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42"))).hasValue(42);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("42"))).hasValue(42);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(Long.toString(Long.MAX_VALUE))))
    ...
    public void bigDecimalAttributeConverterBehaves() {
        ...
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("X")));

        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(TIIIINY_NUMBER)).toString()).isEqualTo(TIIIINY_NUMBER);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-43.0")).toString()).isEqualTo("-43.0");
        assertThat(transformTo(converter, ItemAttributeValue.fromString("-42.42")).toString()).isEqualTo("-42.42");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-42")).toString()).isEqualTo("-42");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0")).toString()).isEqualTo("0");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42")).toString()).isEqualTo("42");
        assertThat(transformTo(converter, ItemAttributeValue.fromString("42.42")).toString()).isEqualTo("42.42");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("43.0")).toString()).isEqualTo("43.0");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(HUUUUGE_NUMBER)).toString()).isEqualTo(HUUUUGE_NUMBER);
    }
    ...
    public void bigIntegerAttributeConverterBehaves() {
        ...
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(TIIIINY_NUMBER)).toString()).isEqualTo(TIIIINY_NUMBER);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("-42")).toString()).isEqualTo("-42");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-42")).toString()).isEqualTo("-42");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0")).toString()).isEqualTo("0");
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42")).toString()).isEqualTo("42");
        assertThat(transformTo(converter, ItemAttributeValue.fromString("42")).toString()).isEqualTo("42");
    ...
    public void floatAttributeConverterBehaves() {
        ...
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("2E308")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("-2E308")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("NaN")));

        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("1.4E-45")))
                .isCloseTo(Float.MIN_VALUE, offset(1E-10f));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-42.42"))).isCloseTo(-42.42f, offset(1E-10f));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo(0f);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42.42"))).isCloseTo(42.42f, offset(1E-10f));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("3.4028235E38")))
    ...
    public void doubleAttributeConverterBehaves() {
        ...
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("4.9E-324")))
                .isCloseTo(Double.MIN_VALUE, offset(1E-10));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-42.42"))).isCloseTo(-42.42d, offset(1E-10));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo(0d);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42.42"))).isCloseTo(42.42d, offset(1E-10));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("1.7976931348623157E308")))
    ...
    public void shortAttributeConverterBehaves() {
        ...
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-32768"))).isEqualTo(Short.MIN_VALUE);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo((short) 0);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("32767"))).isEqualTo(Short.MAX_VALUE);
    }
    ...
    public void integerAttributeConverterBehaves() {
        ...
        assertThat(transformTo(converter, ItemAttributeValue.fromString("-42"))).isEqualTo(-42);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-42"))).isEqualTo(-42);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo(0);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42"))).isEqualTo(42);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("42"))).isEqualTo(42);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(Integer.toString(Integer.MAX_VALUE))))
    ...
    public void longAttributeConverterBehaves() {
        ...
        assertThat(transformTo(converter, ItemAttributeValue.fromString("-42"))).isEqualTo(-42L);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-42"))).isEqualTo(-42L);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo(0L);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("42"))).isEqualTo(42L);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("42"))).isEqualTo(42L);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(Long.toString(Long.MAX_VALUE))))
