...
import static software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.NestedStaticChildRecordWithList;
import static software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.buildStaticImmutableSchemaForNestedRecordWithList;
import static software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.buildStaticImmutableSchemaForSimpleRecordWithList;
import static software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.buildStaticSchemaForNestedRecordWithList;
import static software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.buildStaticSchemaForSimpleRecordWithList;
...
import software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.NestedBeanWithList;
import software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.NestedImmutableRecordWithList;
import software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.NestedStaticRecordWithList;
import software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.SimpleBeanWithList;
import software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.SimpleImmutableRecordWithList;
import software.amazon.awssdk.enhanced.dynamodb.functionaltests.models.UpdateBehaviorTestModels.SimpleStaticRecordWithList;
...
public class NestedUpdateBehaviorTest extends LocalDynamoDbSyncTestBase {
    ...
    public void beanSchema_nestedRecord_writeIfNotExists_isRespected() {
        ...
        DynamoDbTable<NestedBeanWithList> table =
            createAndPut("nested-bean-write-if-not-exists",
                         ...
                         new NestedBeanWithList()
                             .setId("1")
                             .setAttr("attr_level1")
                             .setLevel2(new UpdateBehaviorTestModels.NestedBeanChild().setAttr("attr_level2")));
        ...
        NestedBeanWithList updated = table.getItem(r -> r.key(k -> k.partitionValue("1")));
        assertThat(updated.getAttr()).isEqualTo("attr_level1"); // should NOT change
    ...
    public void immutableSchema_simpleRecord_writeIfNotExists_isRespected() {
            ...
            createAndPut("simple-immutable-write-if-not-exists",
                         ...
                         SimpleImmutableRecordWithList
                             ...
                             .childList(Arrays.asList(
                                 UpdateBehaviorTestModels.SimpleImmutableChild.builder().id("child1").attr("attr_child1").build(),
                                 UpdateBehaviorTestModels.SimpleImmutableChild.builder().id("child2").attr("attr_child2").build()))
                             .build());
        ...
        SimpleImmutableRecordWithList updated = SimpleImmutableRecordWithList.builder()
                                                                             .id("1").attr("updated_level1")
                                                                             .build();
        table.updateItem(r -> r.item(updated).ignoreNullsMode(IgnoreNullsMode.SCALAR_ONLY));

        SimpleImmutableRecordWithList afterUpdate = table.getItem(r -> r.key(k -> k.partitionValue("1")));
    ...
    public void immutableSchema_nestedRecord_writeIfNotExists_isRespected() {
        ...
        DynamoDbTable<NestedImmutableRecordWithList> table =
            createAndPut("nested-immutable-write-if-not-exists",
                         ...
                         NestedImmutableRecordWithList
                             ...
                             .id("1")
                             .attr("attr_level1")
                             .level2(UpdateBehaviorTestModels.NestedImmutableChildRecordWithList
        ...
        NestedImmutableRecordWithList afterUpdate = table.getItem(r -> r.key(k -> k.partitionValue("1")));
        assertThat(afterUpdate.getAttr()).isEqualTo("attr_level1"); // should NOT change
    ...
    public void staticSchema_simpleRecord_writeIfNotExists_isRespected() {
        ...
        SimpleStaticRecordWithList updated = table.getItem(r -> r.key(k -> k.partitionValue("1")));
        assertThat(updated.getAttr()).isEqualTo("attr_level1"); // should NOT change
    ...
    public void staticSchema_nestedRecord_writeIfNotExists_isRespected() {
        ...
        NestedStaticRecordWithList result = table.getItem(r -> r.key(k -> k.partitionValue("1")));
        assertThat(result.getAttr()).isEqualTo("attr_level1");
        assertThat(result.getLevel2()).isNotNull();
        assertThat(result.getLevel2().getAttr()).isEqualTo("attr_level2");
        ...
        NestedStaticRecordWithList updated = table.getItem(r -> r.key(k -> k.partitionValue("1")));
        assertThat(updated.getAttr()).isEqualTo("attr_level1"); // should NOT change
        assertThat(updated.getLevel2().getAttr()).isEqualTo("attr_level2"); // should NOT change
    ...
    public void staticSchema_nestedRecord_writeAlways_updatesValues() {
        DynamoDbTable<NestedStaticRecordWithList> table = createAndPut(
            ...
            new NestedStaticRecordWithList()
                .setId("1")
                .setAttr("attr_level1")
                .setLevel2(new UpdateBehaviorTestModels.NestedStaticChildRecordWithList().setAttr("attr_level2")));
