...
public class GlobalDateTimeAttributeConvertersTest {
    ...
    public void instantAsIntegerAttributeConverterBehaves() {
        ...
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("-31557014167219201")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("0.0000000000")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromNumber("31556889864403200")));

        // InstantAsIntegerAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-31557014167219200"))).isEqualTo(Instant.MIN);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("-0.001"))).isEqualTo(Instant.EPOCH.minusMillis(1));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber(".0"))).isEqualTo(Instant.EPOCH);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0."))).isEqualTo(Instant.EPOCH);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo(Instant.EPOCH);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0.000"))).isEqualTo(Instant.EPOCH);
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0.001"))).isEqualTo(Instant.EPOCH.plusMillis(1));
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("31556889864403199.999999999"))).isEqualTo(Instant.MAX);

        // InstantAsStringAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00Z"))).isEqualTo(Instant.EPOCH);

        // OffsetDateTimeAsStringAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00+01:00")))
                .isEqualTo(Instant.EPOCH.minus(1, ChronoUnit.HOURS));

        // ZonedDateTimeAsStringAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T01:00:00+01:00[Europe/Paris]")))
    ...
    public void instantAsStringAttributeConverterBehaves() {
        ...
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("-1000000001-12-31T23:59:59.999999999Z")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("X")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("+1000000001-01-01T00:00:00Z")));

        // InstantAsIntegerAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo(Instant.EPOCH);

        // InstantAsStringAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromString("-1000000000-01-01T00:00:00Z"))).isEqualTo(Instant.MIN);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1969-12-31T23:59:59.999Z"))).isEqualTo(Instant.EPOCH.minusMillis(1));
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00Z"))).isEqualTo(Instant.EPOCH);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00.001Z"))).isEqualTo(Instant.EPOCH.plusMillis(1));
        assertThat(transformTo(converter, ItemAttributeValue.fromString("+1000000000-12-31T23:59:59.999999999Z"))).isEqualTo(Instant.MAX);
    ...
    public void offsetDateTimeAsStringAttributeConverterBehaves() {
        ...
        // InstantAsIntegerAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromNumber("0"))).isEqualTo(epochUtc);

        // InstantAsStringAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00Z"))).isEqualTo(epochUtc);

        // OffsetDateTimeAsStringAttributeConverter format
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00+01:00")))
                .isEqualTo(OffsetDateTime.of(1970, 1, 1, 0, 0, 0, 0, ZoneOffset.ofHours(1)));
        assertThat(transformTo(converter, ItemAttributeValue.fromString("-999999999-01-01T00:00:00+18:00")))
                .isEqualTo(OffsetDateTime.MIN);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1969-12-31T23:59:59.999999999Z")))
                .isEqualTo(epochUtc.minusNanos(1));
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00Z")))
                .isEqualTo(epochUtc);
        assertThat(transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00.000000001Z")))
                .isEqualTo(epochUtc.plusNanos(1));
        assertThat(transformTo(converter, ItemAttributeValue.fromString("+999999999-12-31T23:59:59.999999999-18:00")))
    ...
    public void zonedDateTimeAsStringAttributeConverterBehaves() {
        ...
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("X")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("+1000000001-01-01T00:00:00Z")));
        assertFails(() -> transformTo(converter, ItemAttributeValue.fromString("1970-01-01T00:00:00+01:00[FakeZone]")));
