...
public class Document2AttributeValueValidator {

    public static boolean validateSpecificGetter(AttributeValue value, Default2EnhancedDocument enhancedDocument, String key) {
