...
@DynamoDbBean
public class BeanWithInvalidAttributeNameOnRoot {
    ...
    public BeanWithInvalidAttributeNameOnRoot setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public BeanWithInvalidAttributeNameOnRoot setAttr_NESTED_ATTR_UPDATE_(Instant attr_NESTED_ATTR_UPDATE_) {
