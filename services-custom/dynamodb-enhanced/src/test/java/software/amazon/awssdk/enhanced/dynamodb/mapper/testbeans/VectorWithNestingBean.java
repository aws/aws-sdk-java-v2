...
@DynamoDbBean
public class VectorWithNestingBean {
    private String id;
    private String category;
    private List<Float> embedding;
    private AbstractBean innerBean;
    private AbstractImmutable innerImmutable;
    ...
    public AbstractImmutable getInnerImmutable() {
        return innerImmutable;
    }

    public void setInnerImmutable(AbstractImmutable innerImmutable) {
        this.innerImmutable = innerImmutable;
    }
}
