...
public final class UpdateBehaviorTestModels {
    ...
    /**
     * Plain POJO with no DynamoDB annotations. Serialization is handled entirely by a custom converter. Mirrors
     * {@link AutogeneratedTimestampTestModels.CustomConvertedPojo} for update behavior tests.
     */
    ...
    /**
     * Custom converter for {@code List<CustomConvertedPojo>}. The SDK should not attempt to resolve a {@link TableSchema} for
     * {@link CustomConvertedPojo} when this converter is present.
     */
    public static class CustomConvertedPojoListConverter
        implements AttributeConverter<List<CustomConvertedPojo>> {

        @Override
        public AttributeValue transformFrom(
            List<CustomConvertedPojo> input) {
            if (input == null) {
        ...
        @Override
        public List<CustomConvertedPojo> transformTo(
    ...
    /**
     * Custom converter for {@code Map<String, CustomConvertedPojo>}.
     */
    public static class CustomConvertedPojoMapConverter
        implements AttributeConverter<Map<String, CustomConvertedPojo>> {

        @Override
        public AttributeValue transformFrom(
            Map<String, CustomConvertedPojo> input) {
            if (input == null) {
                return AttributeValue.builder().nul(true).build();
            }
            Map<String, AttributeValue> map = new HashMap<>();
            input.forEach((key, value) -> {
                ...
                inner.put("label", AttributeValue.builder().s(value.getLabel()).build());
                inner.put("count", AttributeValue.builder().n(String.valueOf(value.getCount())).build());
                map.put(key, AttributeValue.builder().m(inner).build());
            });
            return AttributeValue.builder().m(map).build();
        }

        @Override
        public Map<String, CustomConvertedPojo> transformTo(
            AttributeValue input) {
            if (input.m() == null) {
                return new HashMap<>();
            }
            Map<String, CustomConvertedPojo> result = new HashMap<>();
            input.m().forEach((key, value) -> {
    ...
    /**
     * Bean combining {@code @DynamoDbUpdateBehavior} fields with a {@code @DynamoDbConvertedBy} list whose element type
     * ({@link CustomConvertedPojo}) has no DynamoDB annotations. Mirrors
     * {@link AutogeneratedTimestampTestModels.BeanWithCustomConvertedList} for update behavior tests.
     */
    @DynamoDbBean
    public static class BeanWithCustomConvertedList {
        ...
        public BeanWithCustomConvertedList setWriteAlwaysField(String v) {
            this.writeAlwaysField = v;
            return this;
        }
        ...
        public BeanWithCustomConvertedList setWriteOnceField(String v) {
            this.writeOnceField = v;
            return this;
        }
        ...
        public BeanWithCustomConvertedList setCustomItems(List<CustomConvertedPojo> v) {
            this.customItems = v;
            return this;
        }
    }
    ...
    /**
     * Bean combining {@code @DynamoDbUpdateBehavior} fields with a {@code @DynamoDbConvertedBy} map whose value type
     * ({@link CustomConvertedPojo}) has no DynamoDB annotations.
     */
    @DynamoDbBean
    public static class BeanWithCustomConvertedMap {
        ...
        public BeanWithCustomConvertedMap setWriteAlwaysField(String v) {
            this.writeAlwaysField = v;
            return this;
        }
        ...
        public BeanWithCustomConvertedMap setWriteOnceField(String v) {
            this.writeOnceField = v;
            return this;
        }
        ...
        public BeanWithCustomConvertedMap setCustomMap(Map<String, CustomConvertedPojo> v) {
            this.customMap = v;
            return this;
        }
    }
