...
public final class UpdateBehaviorTestModels {
    ...
    /**
     * Test model with an invalid root-level attribute name containing the reserved '_NESTED_ATTR_UPDATE_' pattern.
     * Used to test validation of attribute names that conflict with internal DynamoDB Enhanced Client conventions.
     */
    @DynamoDbBean
    ...
    /**
     * Test model with an invalid nested attribute name containing the reserved '_NESTED_ATTR_UPDATE_' pattern.
     * Used to test validation of nested attribute names that conflict with internal DynamoDB Enhanced Client conventions.
     */
    @DynamoDbBean
    public static class BeanWithInvalidNestedAttributeName {
        ...
        public BeanWithInvalidNestedAttributeName setNestedChildAttribute(
            BeanWithInvalidNestedAttributeNameChild nestedChildAttribute) {
        ...
        public static class BeanWithInvalidNestedAttributeNameChild {
            ...
            public BeanWithInvalidNestedAttributeNameChild setNestedChildAttribute(
                BeanWithInvalidNestedAttributeNameChild nestedChildAttribute) {
                this.nestedChildAttribute = nestedChildAttribute;
                return this;
            }
