...
public class EmptyBinaryByteArrayAttributesTest {
    ...
    private static final AttributeValue EMPTY_BINARY_AV = new AttributeValue().withB(ByteBuffer.wrap(EMPTY_BINARY));
    ...
    public void testSaveUsingUpdate() {
        ...
        assertEquals(EMPTY_BINARY_AV, attributeValueUpdate.getValue());
