...
public class TableMapperIntegrationTest extends AbstractKeyAndValIntegrationTestCase {
    ...
    public void testQueryBeginsWith() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").beginsWith(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryBetween() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").between(object.getQueryDate(), object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryGreaterThanOrEqualTo() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").ge(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryGreaterThan() {
        ...
        assertEquals(0, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").gt(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryEqualTo() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").eq(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryIn() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").in(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryLessThanOrEqualTo() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").le(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryLessThan() {
        ...
        assertEquals(0, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").lt(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryNotEqualTo() {
        ...
        assertEquals(0, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").ne(object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryAnyBetween() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").betweenAny(object.getQueryDate(), object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryAnyBetweenLoNull() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").betweenAny(null, object.getQueryDate()))
            ).getResults().size());
    }
    ...
    public void testQueryAnyBetweenHiNull() {
        ...
        assertEquals(1, mapper.queryPage(new DynamoDBQueryExpression<KeyAndDateValue>()
                .withHashKeyValues(object).withConsistentRead(true)
                .withQueryFilterEntry("queryDate", mapper.field("queryDate").betweenAny(object.getQueryDate(), null))
            ).getResults().size());
    }
