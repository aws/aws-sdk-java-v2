...
import software.amazon.awssdk.mapper.dynamodb.pojos.PhoneNumber;
...
public class TestObjectCreator {
    ...
    public static TransactionWriteTestData createMultipleObjectTestDataForTransactionWrite(DynamoDBMapper dynamoDBMapper,
        ...
        // Create and add conditionCheck
        Object obj = getTestObject(transactionWriteTestRequest.isMultiTable, 0);
        writeExpressionAndReturnValue = generateWriteExpressionAndReturnValueFlag(obj, transactionWriteTestRequest.conditionCheckConditionExpressionMode, 0);
        dynamoDBMapper.save(obj);
        oldExistingObjects.add(obj);
        ...
        obj = getTestObject(transactionWriteTestRequest.isMultiTable, 0);
        writeExpressionAndReturnValue = generateWriteExpressionAndReturnValueFlag(obj, transactionWriteTestRequest.deleteConditionExpressionMode, 0);
        dynamoDBMapper.save(obj);
    ...
    public static List<Object> extractObjectKeysForValidResponseSendingOperations(List<Object> allExistingObjects) {
        ...
        responseObjectKeys.add(allExistingObjects.get(5)); // For objectToBeDeleted
    ...
    public static List<Object> extractExpectedResponseObjects(List<Object> allExistingObjects) {
        ...
        responseObjects.add(null); // For objectToBeDeleted
