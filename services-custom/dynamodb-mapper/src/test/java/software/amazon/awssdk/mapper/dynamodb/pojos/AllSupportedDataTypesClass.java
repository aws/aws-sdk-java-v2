 ...
 * data type.
 */
@DynamoDBTable(tableName = "aws-java-sdk-all-supported-types")
public class AllSupportedDataTypesClass {
    ...
    public boolean equals(Object obj) {
        ...
        if ( getClass() != obj.getClass() )
            return false;
        AllSupportedDataTypesClass other = (AllSupportedDataTypesClass) obj;
