 ...
 */
public class BatchWriteTest extends LocalDynamoDBTestBase {
    ...
    public void testErrorHandling() {
        ...
        for (Object obj : objs.subList(25, 50)) {
            RangeKeyClass loaded = mapper.load(RangeKeyClass.class, ((RangeKeyClass) obj).getKey(), ((RangeKeyClass) obj).getRangeKey());
            assertEquals(obj, loaded);
        }
    }
