...
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.AWS4_SIGNING_ALGORITHM;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.X_AMZ_CONTENT_SHA256;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerUtils.addHostHeader;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerUtils.deriveSigningKey;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerUtils.hashCanonicalRequest;

import software.amazon.awssdk.annotations.SdkInternalApi;
import software.amazon.awssdk.http.SdkHttpRequest;
import software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant;
import software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerUtils;
