...
public abstract class SdkInputStream extends InputStream implements Releasable {
    ...
    /**
     * Aborts with subclass specific abortion logic executed if needed. Note the interrupted status of the thread is cleared by
     * this method.
     *
     * @throws RuntimeException if found necessary.
     */
