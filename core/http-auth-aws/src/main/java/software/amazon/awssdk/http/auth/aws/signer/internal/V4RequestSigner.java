...
import static software.amazon.awssdk.http.auth.aws.signer.internal.V4CanonicalRequest.getSignedHeadersString;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.AWS4_SIGNING_ALGORITHM;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerUtils.addDateHeader;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerUtils.formatDateTime;
