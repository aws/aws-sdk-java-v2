...
import static software.amazon.awssdk.http.auth.aws.util.CanonicalRequestV2.getSignedHeadersString;
 ...
 */
@SdkProtectedApi
public class DefaultAwsV4QueryHttpSigner implements BaseAwsV4HttpSigner<AwsV4HttpProperties> {

    private final BaseAwsV4HttpSigner<AwsV4HttpProperties> v4Signer;

    public DefaultAwsV4QueryHttpSigner(BaseAwsV4HttpSigner<AwsV4HttpProperties> v4Signer) {
