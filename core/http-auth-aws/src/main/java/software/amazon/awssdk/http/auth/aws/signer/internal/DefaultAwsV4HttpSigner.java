...
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.CredentialUtils.sanitizeCredentials;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.OptionalDependencyLoaderUtil.getEventStreamV4PayloadSigner;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.PRESIGN_URL_MAX_EXPIRATION_DURATION;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.STREAMING_EVENTS_PAYLOAD;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.STREAMING_SIGNED_PAYLOAD;
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.STREAMING_SIGNED_PAYLOAD_TRAILER;
...
import static software.amazon.awssdk.http.auth.aws.signer.internal.util.SignerConstant.UNSIGNED_PAYLOAD;
...
import software.amazon.awssdk.http.auth.aws.signer.internal.util.CredentialUtils;
import software.amazon.awssdk.http.auth.signer.spi.AsyncSignRequest;
import software.amazon.awssdk.http.auth.signer.spi.AsyncSignedRequest;
...
import software.amazon.awssdk.http.auth.signer.spi.SignedRequest;
