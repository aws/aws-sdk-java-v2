...
public final class SignerUtils {
    ...
    public static void moveContentLength(SdkHttpRequest.Builder request) {
        if (!request.firstMatchingHeader(SignerConstant.X_AMZ_DECODED_CONTENT_LENGTH).isPresent()) {
            ...
            request.putHeader(SignerConstant.X_AMZ_DECODED_CONTENT_LENGTH, contentLength)
