...
public interface AsyncResponseTransformer<ResponseT, ResultT> {
     ...
     * after the entire response body has finished streaming.) You are responsible for subscribing to this publisher and managing
     * the associated back-pressure. Therefore, this transformer is only recommended for advanced use cases.
     *
     * @param <ResponseT> Pojo response type.
     * @return AsyncResponseTransformer instance.
     */
