...
public class AsyncBeforeTransmissionExecutionInterceptorsStage implements
    ...
    public CompletableFuture<SdkHttpFullRequest> execute(CompletableFuture<SdkHttpFullRequest> input,
        ...
        CompletableFuture<SdkHttpFullRequest> beforeTransmissionFuture = input.thenApply(request -> {
            try {
                InterruptMonitor.checkInterrupted();
            } catch (InterruptedException e) {
                throw CompletableFutureUtils.errorAsCompletionException(e);
            }
        ...
        return CompletableFutureUtils.forwardExceptionTo(beforeTransmissionFuture, input);
    }
}
