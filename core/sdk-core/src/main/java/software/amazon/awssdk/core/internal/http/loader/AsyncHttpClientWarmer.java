...
import software.amazon.awssdk.core.internal.warmup.RegionEndpointResolver;
import software.amazon.awssdk.core.internal.warmup.WarmUpDiscovery;
...
/**
 * Warms every async {@link SdkAsyncHttpService} on the classpath for CRaC warm-up: builds each client and sends a best-effort
