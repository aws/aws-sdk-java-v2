...
public final class ClientOverrideConfiguration
    ...
    private static final class DefaultClientOverrideConfigurationBuilder implements Builder {
        ...
        public void setMetricConfigurationProvider(MetricConfigurationProvider metricConfigurationProvider) {
            metricConfigurationProvider(metricConfigurationProvider);
        }
        ...
        public void setMetricPublisherConfiguration(MetricPublisherConfiguration metricPublisherConfiguration) {
            metricPublisherConfiguration(metricPublisherConfiguration);
        }
