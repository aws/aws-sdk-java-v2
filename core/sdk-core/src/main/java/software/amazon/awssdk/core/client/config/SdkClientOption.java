...
public final class SdkClientOption<T> extends ClientOption<T> {
     ...
     *
     * @deprecated Use {@link #CLIENT_ENDPOINT_PROVIDER}'s {@link SdkClientEndpointProvider#isEndpointOverridden()}.
     */
    @Deprecated
     ...
     */
    public static final SdkClientOption<SdkClientEndpointProvider> CLIENT_ENDPOINT_PROVIDER =
        new SdkClientOption<>(SdkClientEndpointProvider.class);
