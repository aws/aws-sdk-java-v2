...
class SdkUserAgentTest {
    ...
    void sdkUserAgentStringValidation(String description, String expected, SdkUserAgentProperties requestUserAgent,
                                      SystemUserAgent systemUserAgent) {
        String userAgent = SdkUserAgent.buildSdkUserAgentString(systemUserAgent, requestUserAgent);
    ...
    private static Stream<Arguments> inputValues() {
        ...
        SdkUserAgentProperties minimalProperties = sdkProperties(null, null, null, null, null);
        SdkUserAgentProperties maximalProperties = sdkProperties("standard", "arbitrary", "async", "Netty", "PROC");
        ...
        return Stream.of(
            ...
            Arguments.of("standard sysagent, request values - authSource",
                         "aws-sdk-java/2.26.22-SNAPSHOT ua/2.0 os/Mac_OS_X#14.6.1 lang/java#21.0.2 "
                         + "md/OpenJDK_64-Bit_Server_VM#21.0.2+13-LTS md/vendor#Amazon.com_Inc. md/en_US md/Kotlin md/Scala "
                         + "exec-env/lambda cfg/auth-source#PROC",
                         sdkProperties(null, null, null, null, "PROC"),
                         maximalSysAgent),
            Arguments.of("standard sysagent, request values - maximal",
                         ...
                         + "lang/java#21.0.2 "
                         + "md/OpenJDK_64-Bit_Server_VM#21.0.2+13-LTS md/vendor#Amazon.com_Inc. md/en_US md/Kotlin md/Scala "
                         + "exec-env/lambda cfg/retry-mode#standard cfg/auth-source#PROC",
                         maximalProperties,
                         maximalSysAgent)
            );
    }

    private static SdkUserAgentProperties sdkProperties(String retryMode, String internalMarker,
                                                        String io, String http, String authSource) {
        SdkUserAgentProperties properties = new SdkUserAgentProperties();
        ...
        if (authSource != null) {
            properties.putAttribute(AUTH_SOURCE, authSource);
        }
