...
public class ConnectionUtilsComponentTest {
    ...
    @ClassRule
    public static WireMockRule mockProxyServer = new WireMockRule(wireMockConfig().port(0), false);

    @Rule
    public WireMockRule mockServer = new WireMockRule(wireMockConfig().port(0), false);
