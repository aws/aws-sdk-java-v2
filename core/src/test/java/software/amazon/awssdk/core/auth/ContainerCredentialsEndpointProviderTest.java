...
import static software.amazon.awssdk.core.AwsSystemSetting.AWS_CONTAINER_CREDENTIALS_RELATIVE_URI;
...
import software.amazon.awssdk.core.auth.ContainerCredentialsProvider.ContainerCredentialsEndpointProvider;
...
public class ContainerCredentialsEndpointProviderTest {
    ...
    public void takesUriFromTheEnvironmentVariable() throws IOException {
        ...
        helper.set(AwsSystemSetting.AWS_CONTAINER_CREDENTIALS_FULL_URI.environmentVariable(), fullUri);
    ...
    public void onlyLocalHostAddressesAreValid() throws IOException {
        helper.set(AwsSystemSetting.AWS_CONTAINER_CREDENTIALS_FULL_URI.environmentVariable(), "https://google.com/endpoint");
        sut.endpoint();
    }

    @Test
    public void authorizationHeaderIsPresentIfEnvironmentVariableSet() {
        helper.set(AwsSystemSetting.AWS_CONTAINER_AUTHORIZATION_TOKEN.environmentVariable(), "hello authorized world!");
