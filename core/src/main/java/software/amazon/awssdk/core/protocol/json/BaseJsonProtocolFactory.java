...
public abstract class BaseJsonProtocolFactory {
    ...
    protected final JsonClientMetadata metadata;
     ...
     */
    public abstract <T> JsonResponseHandler<T> createResponseHandler(JsonOperationMetadata operationMetadata, Unmarshaller<T,
    ...
    protected final boolean isCborEnabled() {
        return metadata.isSupportsCbor() && CBOR_ENABLED.getBooleanValueOrThrow();
    }
