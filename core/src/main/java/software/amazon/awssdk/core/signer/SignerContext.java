...
public final class SignerContext {
    ...
    private SignerContext(Builder builder) {
    ...
    public Builder toBuilder() {
        return builder().putAllAttributes(attributes);
    }
    ...
    public static final class Builder {
         ...
         */
        public <U> Builder putAttribute(ExecutionAttribute<U> attribute, U value) {
            this.attributes.put(attribute, value);
            return this;
        }

        public Builder putAllAttributes(Map<ExecutionAttribute<?>, Object> attributes) {
