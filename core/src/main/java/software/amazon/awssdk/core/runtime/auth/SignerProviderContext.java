...
public class SignerProviderContext {
    ...
    private final RequestOverrideConfiguration requestConfig;
    ...
    public RequestOverrideConfiguration getRequestConfig() {
    ...
    public static class Builder {
        ...
        private RequestOverrideConfiguration requestConfig;
        ...
        public Builder withRequestConfig(final RequestOverrideConfiguration requestConfig) {
