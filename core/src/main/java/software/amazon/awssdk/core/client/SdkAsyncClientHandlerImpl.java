...
@ThreadSafe
@SdkProtectedApi
class SdkAsyncClientHandlerImpl extends BaseClientHandler implements AsyncClientHandler {
    ...
    private <InputT extends SdkRequest, OutputT, ReturnT> CompletableFuture<ReturnT> execute(
        ...
        //TODO: confirm isCalculateCrc32FromCompressedData should always be false
        HttpResponseAdapter responseAdapter
                = r -> SdkHttpResponseAdapter.adapt(false, marshalled, r);
