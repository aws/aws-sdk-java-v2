 ...
 * @param <PublisherT> Type of the Publisher delivered to onStream.
 * @param <ReturnT> Type this response handler produces. I.E. the type you are transforming the response into.
 */
public interface BaseAsyncResponseTransformer<ResponseT, PublisherT extends SdkPublisher<?>, ReturnT> {
