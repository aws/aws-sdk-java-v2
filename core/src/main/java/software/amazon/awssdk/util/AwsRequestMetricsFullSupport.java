...
public class AwsRequestMetricsFullSupport extends AwsRequestMetrics {
    ...
    private static final Logger log = LoggerFactory.getLogger(AwsRequestMetricsFullSupport.class);
    ...
    public void startEvent(String eventName) {
        ...
        eventsBeingProfiled.put(eventName, TimingInfo.startTimingFullSupport(System.nanoTime())); // ignoring the wall clock time
    }
