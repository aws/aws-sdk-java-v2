...
/**
 * An implementation of a {@link AwsV4HttpSigner} that can be used to generate a presigned request with
 * an expiration (i.e. S3 pre-signed URLs).
 */
@SdkProtectedApi
public final class DefaultAwsV4PresignedHttpSigner implements AwsV4HttpSigner<AwsV4PresignedHttpProperties> {

    private final AwsV4HttpSigner<AwsV4HttpProperties> v4Signer;

    public DefaultAwsV4PresignedHttpSigner(AwsV4HttpSigner<AwsV4HttpProperties> v4Signer) {
