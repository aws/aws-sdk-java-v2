...
import software.amazon.awssdk.http.auth.internal.util.ClassLoaderHelper;
...
public final class DefaultAwsV4HttpSigner implements AwsV4HttpSigner {
    ...
    private static BaseAwsV4HttpSigner<?> loadEventStreamSigner(BaseAwsV4HttpSigner<?> v4Signer) {
        String classPath = "software.amazon.awssdk.http.auth.eventstream.internal.DefaultAwsV4EventStreamHttpSigner";
        try {
