...
class AwsV4HttpSignerTest {
    ...
    public void testSigning() {
        ...
        SyncHttpSignRequest<? extends AwsCredentialsIdentity> request = generateBasicRequest(
            SdkHttpRequest.builder(),
            SyncHttpSignRequest.builder(AwsCredentialsIdentity.create("access", "secret"))
        );
    ...
    public void testAsyncSigning() {
        ...
        // Test request without 'x-amz-sha256' header
        AsyncHttpSignRequest<? extends AwsCredentialsIdentity> request = generateBasicAsyncRequest(
            SdkHttpRequest.builder(),
            AsyncHttpSignRequest.builder(AwsCredentialsIdentity.create("access", "secret"))
        );

        AsyncSignedHttpRequest signedRequest = signer.signAsync(request);
    ...
    public void testAnonymous() {
        SyncHttpSignRequest<? extends AwsCredentialsIdentity> request = generateBasicRequest(
            SdkHttpRequest.builder()
                .putRawQueryParameter("Foo", (String) null),
            SyncHttpSignRequest.builder(new AnonymousCredentialsIdentity())
        );
    ...
    public void xAmznTraceId_NotSigned() {
        ...
        SyncHttpSignRequest<? extends AwsCredentialsIdentity> request = generateBasicRequest(
            ...
            SyncHttpSignRequest.builder(AwsCredentialsIdentity.create("akid", "skid"))
        );
    ...
    // Helpers for tests
    private static SyncHttpSignRequest<? extends AwsCredentialsIdentity> generateBasicRequest(
        SdkHttpRequest.Builder requestBuilder,
        SyncHttpSignRequest.Builder<? extends AwsCredentialsIdentity> signRequestBuilder
    ) {
    ...
    private static AsyncHttpSignRequest<? extends AwsCredentialsIdentity> generateBasicAsyncRequest(
        SdkHttpRequest.Builder requestBuilder,
        AsyncHttpSignRequest.Builder<? extends AwsCredentialsIdentity> signRequestBuilder
    ) {
