...
/**
 * Presigning-related parameters that are used during Sigv4a signing.
 */
@SdkPublicApi
public final class Aws4aPresignerParams extends Aws4aSignerParams {

    private final Instant expirationTime;

    private Aws4aPresignerParams(BuilderImpl builder) {
        super(builder);
    ...
    private static final class BuilderImpl extends Aws4aSignerParams.BuilderImpl<Builder> implements Builder {
        ...
        @Override
        public Aws4aPresignerParams build() {
            return new Aws4aPresignerParams(this);
        }
    }
}
