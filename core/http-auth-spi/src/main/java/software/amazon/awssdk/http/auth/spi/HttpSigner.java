...
public interface HttpSigner<IdentityT> {
    ...
    /**
     * Method that takes in inputs to sign a request and returns a signed version of the request.
     *
     * @param request The inputs to sign a request, with sync payload.
     ...
     * Method that takes in inputs to sign a request and returns a signed version of the request.
     *
     * @param request The inputs to sign a request, with async payload.
     * @return A signed version of the request.
     */
