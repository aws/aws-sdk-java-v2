...
package software.amazon.awssdk.http.auth.signer.spi;

import java.time.Clock;
import java.util.concurrent.CompletableFuture;
import java.util.function.Consumer;
import software.amazon.awssdk.annotations.SdkPublicApi;
import software.amazon.awssdk.http.auth.signer.spi.internal.DefaultAsyncSignRequest;
import software.amazon.awssdk.http.auth.signer.spi.internal.DefaultSignRequest;
