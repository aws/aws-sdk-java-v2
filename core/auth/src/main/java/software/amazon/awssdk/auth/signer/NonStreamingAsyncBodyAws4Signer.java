 ...
 */
@SdkPublicApi
public final class NonStreamingAsyncBodyAws4Signer extends BaseAws4Signer implements NonStreamingAsyncBodySigner {
    ...
    public static NonStreamingAsyncBodyAws4Signer create() {
        return new NonStreamingAsyncBodyAws4Signer();
    }
}
