...
public final class JsonContentResolverFactory {
     ...
     */
    static final JsonContentTypeResolver ION_BINARY = new JsonContentTypeResolverImpl("application/x-amz-ion-");

    /**
     * Content type resolver implementation for debugging Ion-enabled services.
     */
    static final JsonContentTypeResolver ION_TEXT = new JsonContentTypeResolverImpl("text/x-amz-ion-");

    /**
     * Content type resolver implementation for AWS_CBOR enabled services.
     */
    static final JsonContentTypeResolver AWS_CBOR = new JsonContentTypeResolverImpl("application/x-amz-cbor-");

    /**
     * Content type resolver implementation for plain text AWS_JSON services.
     */
    static final JsonContentTypeResolver AWS_JSON = new JsonContentTypeResolverImpl("application/x-amz-json-");
