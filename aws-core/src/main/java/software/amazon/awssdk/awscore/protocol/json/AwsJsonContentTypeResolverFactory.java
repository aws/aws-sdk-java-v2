...
import software.amazon.awssdk.core.protocol.json.JsonContentTypeResolverImpl;

@SdkInternalApi
public final class AwsJsonContentTypeResolverFactory {
    ...
    private AwsJsonContentTypeResolverFactory() {
    }
}
