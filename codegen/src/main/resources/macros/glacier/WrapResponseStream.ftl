...
result.setBody(new LengthCheckInputStream(result.getBody(), Long.parseLong(response.getHttpResponse().getHeaders().get("Content-Length")), software.amazon.awssdk.core.util.LengthCheckInputStream.INCLUDE_SKIPPED_BYTES));
