...
package software.amazon.awssdk.codegen.poet.warmup;
...
public class WarmUpProviderSpec implements ClassSpec {
    ...
    private static final ClassName CANNED_RESPONSE_HTTP_CLIENT =
        ClassName.get("software.amazon.awssdk.core.warmup.http", "CannedResponseHttpClient");
    private static final ClassName CANNED_RESPONSE_ASYNC_HTTP_CLIENT =
        ClassName.get("software.amazon.awssdk.core.warmup.http", "CannedResponseAsyncHttpClient");
    ...
    public ClassName className() {
        return ClassName.get(model.getMetadata().getFullWarmUpInternalPackageName(),
    ...
    private CodeBlock cannedResponseInitializer(Protocol protocol) {
        switch (protocol) {
            ...
            default:
                throw new IllegalStateException("Unsupported protocol for warm-up canned response: " + protocol
