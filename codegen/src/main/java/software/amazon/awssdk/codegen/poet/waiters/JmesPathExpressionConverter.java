 ...
 */
public class JmesPathExpressionConverter {
    private final ClassName runtimeClass;

    public JmesPathExpressionConverter(ClassName runtimeClass) {
    ...
    private class Visitor implements JmesPathVisitor {
        ...
        private void visitOneExpressionParamFunction(List<FunctionArg> functionArgs, String functionName) {
