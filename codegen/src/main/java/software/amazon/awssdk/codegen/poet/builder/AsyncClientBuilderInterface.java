...
public class AsyncClientBuilderInterface implements ClassSpec {
    ...
    private final MultipartCustomization multipartCustomization;
    ...
    public AsyncClientBuilderInterface(IntermediateModel model) {
        ...
        this.multipartCustomization = model.getCustomizationConfig().getMultipartCustomization();
    }
    ...
    public TypeSpec poetSpec() {
        ...
        if (this.multipartCustomization != null) {
    ...
    private void includeMultipartMethod(TypeSpec.Builder builder) {
        ...
        // method .multipartEnabled(Boolean)
        builder.addMethod(
        ...
        // method .multipartConfiguration(MultipartConfiguration)
        ...
        // method .multipartConfiguration(Consumer<MultipartConfiguration>)
