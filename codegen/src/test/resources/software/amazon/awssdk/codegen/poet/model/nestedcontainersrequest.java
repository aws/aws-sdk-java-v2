...
public final class NestedContainersRequest extends JsonProtocolTestsRequest implements
    ...
    private static final Map<String, SdkField<?>> SDK_NAME_TO_FIELD = Collections
            .unmodifiableMap(new HashMap<String, SdkField<?>>() {
                {
                    put("ListOfListOfStrings", LIST_OF_LIST_OF_STRINGS_FIELD);
                    put("ListOfListOfListOfStrings", LIST_OF_LIST_OF_LIST_OF_STRINGS_FIELD);
                    put("MapOfStringToListOfListOfStrings", MAP_OF_STRING_TO_LIST_OF_LIST_OF_STRINGS_FIELD);
                }
            });
