...
public interface QueryWaiter extends SdkAutoCloseable {
    /**
     * Polls {@link QueryClient#aPostOperation} API until the desired condition {@code BigDecimalValueTest} is met, or
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilBigDecimalValueTest(APostOperationRequest aPostOperationRequest) {
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilBigDecimalValueTest(
        Consumer<APostOperationRequest.Builder> aPostOperationRequest) {
        return waitUntilBigDecimalValueTest(APostOperationRequest.builder().applyMutation(aPostOperationRequest).build());
    }
    ...
    /**
     * Polls {@link QueryClient#aPostOperation} API until the desired condition {@code DoubleValueTest} is met, or until
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilDoubleValueTest(APostOperationRequest aPostOperationRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilDoubleValueTest(
        Consumer<APostOperationRequest.Builder> aPostOperationRequest) {
        return waitUntilDoubleValueTest(APostOperationRequest.builder().applyMutation(aPostOperationRequest).build());
    }
    ...
    /**
     * Polls {@link QueryClient#aPostOperation} API until the desired condition {@code FloatValueTest} is met, or until
     * it is determined that the resource will never enter into the desired state
     *
     * @param aPostOperationRequest
     *        the request to be used for polling
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilFloatValueTest(APostOperationRequest aPostOperationRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilFloatValueTest(
        Consumer<APostOperationRequest.Builder> aPostOperationRequest) {
        return waitUntilFloatValueTest(APostOperationRequest.builder().applyMutation(aPostOperationRequest).build());
    }
    ...
    /**
     * Polls {@link QueryClient#aPostOperation} API until the desired condition {@code LongValueTest} is met, or until
     * it is determined that the resource will never enter into the desired state
     *
     * @param aPostOperationRequest
     *        the request to be used for polling
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilLongValueTest(APostOperationRequest aPostOperationRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     *         condition
     */
    default WaiterResponse<APostOperationResponse> waitUntilLongValueTest(
        Consumer<APostOperationRequest.Builder> aPostOperationRequest) {
        return waitUntilLongValueTest(APostOperationRequest.builder().applyMutation(aPostOperationRequest).build());
    }
