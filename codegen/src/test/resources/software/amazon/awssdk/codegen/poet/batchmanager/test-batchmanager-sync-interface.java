...
import software.amazon.awssdk.services.batchmanagertest.batchmanager.internal.DefaultBatchManagerTestBatchManager;
...
public interface BatchManagerTestBatchManager extends SdkAutoCloseable {
    ...
    /**
     * Create a builder that can be used to configure and create a {@link BatchManagerTestBatchManager}.
     *
     * @return a builder
     */
    static Builder builder() {
        return DefaultBatchManagerTestBatchManager.builder();
    }
    ...
    interface Builder {
         ...
         * @return a reference to this object so that method calls can be chained together.
         */
        Builder client(BatchManagerTestClient client);
        ...
        /**
         * Builds an instance of {@link BatchManagerTestBatchManager} based on the configurations supplied to this
         * builder
         *
         * @return An initialized {@link BatchManagerTestBatchManager}
         */
        BatchManagerTestBatchManager build();
    }
}
