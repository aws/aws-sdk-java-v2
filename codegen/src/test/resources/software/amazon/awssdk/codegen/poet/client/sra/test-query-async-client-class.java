...
import software.amazon.awssdk.services.query.model.PresignedCustomOperationRequest;
import software.amazon.awssdk.services.query.model.PresignedCustomOperationResponse;
...
final class DefaultQueryAsyncClient implements QueryAsyncClient {
     ...
     *         instance of this type.</li>
     *         </ul>
     * @sample QueryAsyncClient.PresignedCustomOperation
     * @see <a href="https://docs.aws.amazon.com/goto/WebAPI/query-service-2010-05-08/PresignedCustomOperation"
     *      target="_top">AWS API Documentation</a>
     */
    @Override
    public CompletableFuture<PresignedCustomOperationResponse> presignedCustomOperation(
        ...
        try {
            ...
            HttpResponseHandler<PresignedCustomOperationResponse> responseHandler = protocolFactory
                .createResponseHandler(PresignedCustomOperationResponse::builder);
