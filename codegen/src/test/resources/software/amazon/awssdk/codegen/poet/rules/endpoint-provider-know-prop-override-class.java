...
public final class DefaultQueryEndpointProvider implements QueryEndpointProvider {
    ...
    private <T> void addKnownProperty(EndpointAttributeProvider<T> provider, Endpoint.Builder builder, Value value) {
    ...
    private void addKnownProperties(Endpoint.Builder builder, Map<String, Value> properties) {
        List<EndpointAttributeProvider<?>> knownProperties = software.module.test.KNOWN_PROPS;
