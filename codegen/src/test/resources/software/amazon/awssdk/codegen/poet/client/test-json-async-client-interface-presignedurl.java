...
public interface JsonAsyncClient extends AwsClient {
     ...
     *      target="_top">AWS API Documentation</a>
     */
    default CompletableFuture<OperationWithNoneAuthTypeResponse> operationWithNoneAuthType(
        OperationWithNoneAuthTypeRequest operationWithNoneAuthTypeRequest) {
        throw new UnsupportedOperationException();
    }

    /**
     * Invokes the OperationWithNoneAuthType operation asynchronously.<br/>
     * <p>
     ...
     * @param operationWithNoneAuthTypeRequest
     *        A {@link Consumer} that will call methods on
     *        {@link software.amazon.awssdk.services.json.model.OperationWithNoneAuthTypeRequest.Builder} to create a
     *        request.
     * @return A Java Future containing the result of the OperationWithNoneAuthType operation returned by the service.<br/>
     *         The CompletableFuture returned by this method can be completed exceptionally with the following
     *         exceptions. The exception returned is wrapped with CompletionException, so you need to invoke
     ...
     */
    default CompletableFuture<OperationWithNoneAuthTypeResponse> operationWithNoneAuthType(
        Consumer<OperationWithNoneAuthTypeRequest.Builder> operationWithNoneAuthTypeRequest) {
