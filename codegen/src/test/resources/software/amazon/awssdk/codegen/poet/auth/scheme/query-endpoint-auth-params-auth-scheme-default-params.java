...
public final class DefaultQueryAuthSchemeParams implements QueryAuthSchemeParams {
  ...
  public Optional<Boolean> useFipsEndpoint() {
    return Optional.ofNullable(useFipsEndpoint);
  }
  ...
  @Override
  public Optional<Boolean> defaultTrueParam() {
    return Optional.ofNullable(defaultTrueParam);
  }

  @Override
  public Optional<String> defaultStringParam() {
    return Optional.ofNullable(defaultStringParam);
  }

  @Override
  public Optional<String> deprecatedParam() {
    return Optional.ofNullable(deprecatedParam);
  }

  @Override
  public Optional<Boolean> booleanContextParam() {
    return Optional.ofNullable(booleanContextParam);
  }

  @Override
  public Optional<String> stringContextParam() {
    return Optional.ofNullable(stringContextParam);
  }

  @Override
  public Optional<String> operationContextParam() {
    return Optional.ofNullable(operationContextParam);
  }
