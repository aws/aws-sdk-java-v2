...
@SdkInternalApi
public final class DefaultS3ControlAuthSchemeProvider implements S3ControlAuthSchemeProvider {
    private static final DefaultS3ControlAuthSchemeProvider DEFAULT = new DefaultS3ControlAuthSchemeProvider();

    private DefaultS3ControlAuthSchemeProvider() {
    }

    public static DefaultS3ControlAuthSchemeProvider create() {
        return DEFAULT;
    }

    @Override
    public List<AuthSchemeOption> resolveAuthScheme(S3ControlAuthSchemeParams params) {
