 ...
 * {@link QueryAuthSchemeParams}, and resolves a list of {@link AuthOption} based on the given parameters.
 */
...
public interface QueryAuthSchemeProvider extends AuthSchemeProvider {
     ...
     */
    List<AuthOption> resolveAuthScheme(QueryAuthSchemeParams authSchemeParams);

    /**
     * Resolve the auth schemes based on the given set of parameters.
     */
    default List<AuthOption> resolveAuthScheme(Consumer<QueryAuthSchemeParams.Builder> consumer) {
