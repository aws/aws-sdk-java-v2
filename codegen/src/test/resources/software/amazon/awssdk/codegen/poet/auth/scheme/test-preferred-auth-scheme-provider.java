...
@SdkInternalApi
public final class PreferredJsonAuthSchemeProvider implements JsonAuthSchemeProvider {
    private final JsonAuthSchemeProvider delegate;

    private final List<String> authSchemePreference;

    public PreferredJsonAuthSchemeProvider(JsonAuthSchemeProvider delegate, List<String> authSchemePreference) {
