...
public class SamplesClassSpecTest {


    @Test
    public void syncWaiterInterface() throws Exception {
        ClassSpec sampleInterface = new SampleClassSpec(ClientTestModels.queryServiceModels());
        assertThat(sampleInterface, generatesTo("query-sync-waiter-interface.java"));
    }
