...
public class AuthSchemeSpecTest {
    ...
    @Test
    public void authSchemeEndpointParams() {
        ClassSpec authSchemeEndpointParams = new AuthSchemeParamsSpec(ClientTestModels
                                                                          .queryServiceModelsEndpointAuthParams());
        assertThat(authSchemeEndpointParams, generatesTo("auth-scheme-params.java"));
    }

    @Test
    public void authSchemeEndpointProvider() {
        ClassSpec authSchemeEndpointProvider = new AuthSchemeProviderSpec(ClientTestModels
                                                                              .queryServiceModelsEndpointAuthParams());
        assertThat(authSchemeEndpointProvider, generatesTo("auth-scheme-provider.java"));
    }

    @Test
    public void defaultAuthSchemeEndpointParams() {
        ClassSpec defaultAuthSchemeEndpointParams = new DefaultAuthSchemeParamsSpec(ClientTestModels
                                                                                        .queryServiceModelsEndpointAuthParams());
        assertThat(defaultAuthSchemeEndpointParams, generatesTo("default-auth-scheme-params.java"));
    }

    @Test
    public void defaultAuthSchemeEndpointProvider() {
        ClassSpec defaultAuthSchemeEndpointProvider = new DefaultAuthSchemeProviderSpec(ClientTestModels
                                                                                            .queryServiceModelsEndpointAuthParams());
        assertThat(defaultAuthSchemeEndpointProvider, generatesTo("default-auth-scheme-provider.java"));
    }
*/
