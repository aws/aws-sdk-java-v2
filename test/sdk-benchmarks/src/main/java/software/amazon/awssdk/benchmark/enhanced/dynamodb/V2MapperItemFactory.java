...
public final class V2MapperItemFactory extends ItemFactory<AttributeValue> {
    public V2MapperHugeBean v2MapperHugeBean() {
        return V2MapperHugeBean.fromHugeBean(super.hugeBean());
    }

    public V2MapperTinyBean v2MapperTinyBean() {
        return V2MapperTinyBean.fromTinyBean(super.tinyBean());
    }

    public V2MapperSmallBean v2MapperSmallBean() {
        return V2MapperSmallBean.fromSmallBean(super.smallBean());
    }

    public V2MapperHugeBeanFlat v2MapperHugeBeanFlat() {
        return V2MapperHugeBeanFlat.fromHugeBeanFlat(super.hugeBeanFlat());
    }
    ...
    public static class V2MapperTinyBean extends ItemFactory.TinyBean {
        ...
        private static V2MapperTinyBean fromTinyBean(TinyBean tb) {
            V2MapperTinyBean b = new V2MapperTinyBean();
    ...
    public static class V2MapperSmallBean extends ItemFactory.SmallBean {
        ...
        public ByteBuffer getBinaryAttrV2Mapper() {
            return binaryAttr;
        }

        @DynamoDBAttribute(attributeName = "binaryAttr")
        public void setBinaryAttrV2Mapper(ByteBuffer binaryAttr) {
        ...
        private static V2MapperSmallBean fromSmallBean(SmallBean sb) {
            V2MapperSmallBean b = new V2MapperSmallBean();
            b.setStringAttr(sb.getStringAttr());
            b.setBinaryAttrV2Mapper(sb.getBinaryAttr().asByteBuffer());
    ...
    public static class V2MapperHugeBean extends ItemFactory.HugeBean {
        ...
        public Map<String, ByteBuffer> getMapAttr1V2Mapper() {
            return mapAttr1;
        }

        @DynamoDBAttribute(attributeName = "mapAttr1")
        public void setMapAttr1V2Mapper(Map<String, ByteBuffer> mapAttr1) {
            this.mapAttr1 = mapAttr1;
        }

        @DynamoDBAttribute(attributeName = "mapAttr2")
        public Map<String, List<ByteBuffer>> getMapAttr2V2Mapper() {
            return mapAttr2;
        }

        @DynamoDBAttribute(attributeName = "mapAttr2")
        public void setMapAttr2V2Mapper(Map<String, List<ByteBuffer>> mapAttr2) {
            this.mapAttr2 = mapAttr2;
        }

        @DynamoDBAttribute(attributeName = "mapAttr3")
        public Map<String, List<Map<String, List<ByteBuffer>>>> getMapAttr3V2Mapper() {
            return mapAttr3;
        }

        @DynamoDBAttribute(attributeName = "mapAttr3")
        public void setMapAttr3V2Mapper(Map<String, List<Map<String, List<ByteBuffer>>>> mapAttr3) {
            this.mapAttr3 = mapAttr3;
        }

        private static V2MapperHugeBean fromHugeBean(HugeBean hb) {
            V2MapperHugeBean b = new V2MapperHugeBean();
            b.setHashKey(hb.getHashKey());
            b.setStringAttr(hb.getStringAttr());
            b.setBinaryAttrV2Mapper(hb.getBinaryAttr().asByteBuffer());
            b.setListAttr(hb.getListAttr());

            b.setMapAttr1V2Mapper(hb.getMapAttr1()
                    .entrySet().stream()
                    .collect(Collectors.toMap(Map.Entry::getKey, e -> e.getValue().asByteBuffer())));

            b.setMapAttr2V2Mapper(hb.getMapAttr2()
                    .entrySet().stream()
                    .collect(Collectors.toMap(Map.Entry::getKey,
                        e -> e.getValue().stream().map(SdkBytes::asByteBuffer).collect(Collectors.toList()))));

            Map<String, List<Map<String, List<ByteBuffer>>>> mapAttr3V2Mapper = hb.getMapAttr3()
                    .entrySet().stream()
            ...
            b.setMapAttr3V2Mapper(mapAttr3V2Mapper);
    ...
    public static class V2MapperHugeBeanFlat extends HugeBeanFlat {
        ...
        public static V2MapperHugeBeanFlat fromHugeBeanFlat(HugeBeanFlat b) {
            V2MapperHugeBeanFlat bean = new V2MapperHugeBeanFlat();
            for (int i = 1; i <= 63; ++i) {
                try {
                    Method setter = V2MapperHugeBeanFlat.class.getMethod("setStringAttr" + i, String.class);
