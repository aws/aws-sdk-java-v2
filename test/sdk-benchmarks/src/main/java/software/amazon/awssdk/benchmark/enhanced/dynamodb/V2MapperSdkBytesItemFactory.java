...
public final class V2MapperSdkBytesItemFactory extends ItemFactory<AttributeValue> {
    ...
    public static class V2MapperSmallBean extends ItemFactory.SmallBean {
        ...
        public SdkBytes getBinaryAttrV2Mapper() {
            return binaryAttr;
        }

        @DynamoDBAttribute(attributeName = "binaryAttr")
        public void setBinaryAttrV2Mapper(SdkBytes binaryAttr) {
        ...
        private static V2MapperSmallBean fromSmallBean(SmallBean sb) {
            ...
            b.setBinaryAttrV2Mapper(sb.getBinaryAttr());
    ...
    public static class V2MapperHugeBean extends ItemFactory.HugeBean {
        ...
        public Map<String, SdkBytes> getMapAttr1V2Mapper() {
            return mapAttr1;
        }

        @DynamoDBAttribute(attributeName = "mapAttr1")
        public void setMapAttr1V2Mapper(Map<String, SdkBytes> mapAttr1) {
            this.mapAttr1 = mapAttr1;
        }

        @DynamoDBAttribute(attributeName = "mapAttr2")
        public Map<String, List<SdkBytes>> getMapAttr2V2Mapper() {
            return mapAttr2;
        }

        @DynamoDBAttribute(attributeName = "mapAttr2")
        public void setMapAttr2V2Mapper(Map<String, List<SdkBytes>> mapAttr2) {
            this.mapAttr2 = mapAttr2;
        }

        @DynamoDBAttribute(attributeName = "mapAttr3")
        public Map<String, List<Map<String, List<SdkBytes>>>> getMapAttr3V2Mapper() {
            return mapAttr3;
        }

        @DynamoDBAttribute(attributeName = "mapAttr3")
        public void setMapAttr3V2Mapper(Map<String, List<Map<String, List<SdkBytes>>>> mapAttr3) {
