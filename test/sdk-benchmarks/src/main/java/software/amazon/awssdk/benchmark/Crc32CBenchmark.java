...
import software.amazon.awssdk.core.checksums.Crc32CChecksum2;
...
public class Crc32CBenchmark {
    ...
    public static class ChecksumState {
        ...
        public void setup() {
            switch (checksumProvider) {
                case "crt":
                    sdkChecksum = () -> new Crc32CChecksum(true); // CRT implementation
                    break;
                case "sdk":
                    sdkChecksum = () -> new Crc32CChecksum(false); // SDK implementation
                    break;
                case "java":
                    sdkChecksum = () -> new Crc32CChecksum2(); // JDK implementation
                    break;
                default:
    ...
    public static void main(String[] args) throws Exception {
        Options opt = new OptionsBuilder()
            .include(Crc32CBenchmark.class.getSimpleName())
            .build();
        new Runner(opt).run();
    }
}
