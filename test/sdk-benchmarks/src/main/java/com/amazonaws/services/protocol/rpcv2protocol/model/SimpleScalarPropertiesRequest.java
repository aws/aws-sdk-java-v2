...
public class SimpleScalarPropertiesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SimpleScalarPropertiesRequest withTrueBooleanValue(Boolean trueBooleanValue) {
    ...
    public SimpleScalarPropertiesRequest withFalseBooleanValue(Boolean falseBooleanValue) {
    ...
    public SimpleScalarPropertiesRequest withByteValue(Integer byteValue) {
    ...
    public SimpleScalarPropertiesRequest withDoubleValue(Double doubleValue) {
    ...
    public SimpleScalarPropertiesRequest withFloatValue(Float floatValue) {
    ...
    public SimpleScalarPropertiesRequest withIntegerValue(Integer integerValue) {
    ...
    public SimpleScalarPropertiesRequest withLongValue(Long longValue) {
    ...
    public SimpleScalarPropertiesRequest withShortValue(Integer shortValue) {
    ...
    public SimpleScalarPropertiesRequest withStringValue(String stringValue) {
    ...
    public SimpleScalarPropertiesRequest withBlobValue(java.nio.ByteBuffer blobValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SimpleScalarPropertiesRequest == false)
            return false;
        SimpleScalarPropertiesRequest other = (SimpleScalarPropertiesRequest) obj;
    ...
    @Override
    public SimpleScalarPropertiesRequest clone() {
        return (SimpleScalarPropertiesRequest) super.clone();
    }
