...
/**
 * Abstract implementation of {@code AmazonProtocolQuery}. Convenient method forms pass through to the corresponding
 * overload that takes a request object, which throws an {@code UnsupportedOperationException}.
 */

public class AbstractAmazonProtocolQuery implements AmazonProtocolQuery {

    protected AbstractAmazonProtocolQuery() {
    }
