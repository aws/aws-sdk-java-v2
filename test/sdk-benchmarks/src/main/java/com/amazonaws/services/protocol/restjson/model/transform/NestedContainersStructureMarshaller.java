...
/**
 * NestedContainersStructureMarshaller
 */

@SdkInternalApi
public class NestedContainersStructureMarshaller {
    ...
    private static final NestedContainersStructureMarshaller instance = new NestedContainersStructureMarshaller();

    public static NestedContainersStructureMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NestedContainersStructure nestedContainersStructure, ProtocolMarshaller protocolMarshaller) {

        if (nestedContainersStructure == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(nestedContainersStructure.getListOfListsOfStrings(), LISTOFLISTSOFSTRINGS_BINDING);
            protocolMarshaller.marshall(nestedContainersStructure.getListOfListsOfStructs(), LISTOFLISTSOFSTRUCTS_BINDING);
            protocolMarshaller.marshall(nestedContainersStructure.getListOfListsOfAllTypesStructs(), LISTOFLISTSOFALLTYPESSTRUCTS_BINDING);
            protocolMarshaller.marshall(nestedContainersStructure.getListOfListOfListsOfStrings(), LISTOFLISTOFLISTSOFSTRINGS_BINDING);
            protocolMarshaller.marshall(nestedContainersStructure.getMapOfStringToListOfListsOfStrings(), MAPOFSTRINGTOLISTOFLISTSOFSTRINGS_BINDING);
            protocolMarshaller.marshall(nestedContainersStructure.getStringMember(), STRINGMEMBER_BINDING);
        } catch (Exception e) {
