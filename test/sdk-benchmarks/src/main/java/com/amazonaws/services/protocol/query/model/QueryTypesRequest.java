...
public class QueryTypesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public QueryTypesRequest withFlattenedListOfStrings(String... flattenedListOfStrings) {
    ...
    public QueryTypesRequest withFlattenedListOfStrings(java.util.Collection<String> flattenedListOfStrings) {
    ...
    public QueryTypesRequest withNonFlattenedListWithLocation(String... nonFlattenedListWithLocation) {
    ...
    public QueryTypesRequest withNonFlattenedListWithLocation(java.util.Collection<String> nonFlattenedListWithLocation) {
    ...
    public QueryTypesRequest withFlattenedListOfStructs(SimpleStruct... flattenedListOfStructs) {
    ...
    public QueryTypesRequest withFlattenedListOfStructs(java.util.Collection<SimpleStruct> flattenedListOfStructs) {
    ...
    public QueryTypesRequest withFlattenedListWithLocation(String... flattenedListWithLocation) {
    ...
    public QueryTypesRequest withFlattenedListWithLocation(java.util.Collection<String> flattenedListWithLocation) {
    ...
    public QueryTypesRequest withFlattenedMap(java.util.Map<String, String> flattenedMap) {
     ...
     *
     * @see QueryTypesRequest#withFlattenedMap
     * @returns a reference to this object so that method calls can be chained together.
     */

    public QueryTypesRequest addFlattenedMapEntry(String key, String value) {
    ...
    public QueryTypesRequest clearFlattenedMapEntries() {
    ...
    public QueryTypesRequest withFlattenedMapWithLocation(java.util.Map<String, String> flattenedMapWithLocation) {
     ...
     *
     * @see QueryTypesRequest#withFlattenedMapWithLocation
     * @returns a reference to this object so that method calls can be chained together.
     */

    public QueryTypesRequest addFlattenedMapWithLocationEntry(String key, String value) {
    ...
    public QueryTypesRequest clearFlattenedMapWithLocationEntries() {
    ...
    public QueryTypesRequest withNonFlattenedMapWithLocation(java.util.Map<String, String> nonFlattenedMapWithLocation) {
     ...
     *
     * @see QueryTypesRequest#withNonFlattenedMapWithLocation
     * @returns a reference to this object so that method calls can be chained together.
     */

    public QueryTypesRequest addNonFlattenedMapWithLocationEntry(String key, String value) {
    ...
    public QueryTypesRequest clearNonFlattenedMapWithLocationEntries() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof QueryTypesRequest == false)
            return false;
    ...
    @Override
    public QueryTypesRequest clone() {
        return (QueryTypesRequest) super.clone();
    }
