...
public class MembersInHeadersRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public MembersInHeadersRequest withStringMember(String stringMember) {
    ...
    public MembersInHeadersRequest withBooleanMember(Boolean booleanMember) {
    ...
    public MembersInHeadersRequest withIntegerMember(Integer integerMember) {
    ...
    public MembersInHeadersRequest withLongMember(Long longMember) {
    ...
    public MembersInHeadersRequest withFloatMember(Float floatMember) {
    ...
    public MembersInHeadersRequest withDoubleMember(Double doubleMember) {
    ...
    public MembersInHeadersRequest withTimestampMember(java.util.Date timestampMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MembersInHeadersRequest == false)
            return false;
    ...
    @Override
    public MembersInHeadersRequest clone() {
        return (MembersInHeadersRequest) super.clone();
    }
