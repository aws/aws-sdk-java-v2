...
/**
 * Client for accessing JsonProtocolTests asynchronously. Each asynchronous method will return a Java Future object
 * representing the asynchronous operation; overloads which accept an {@code AsyncHandler} can be used to receive
 * notification when an asynchronous operation completes.
 */
@ThreadSafe

public class AmazonProtocolRestJsonAsyncClient extends AmazonProtocolRestJsonClient implements AmazonProtocolRestJsonAsync {
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on JsonProtocolTests. A credentials provider chain
     ...
     * @deprecated use {@link AmazonProtocolRestJsonAsyncClientBuilder#defaultClient()}
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient() {
     ...
     * @see DefaultAWSCredentialsProviderChain
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     * @deprecated use {@link AmazonProtocolRestJsonAsyncClientBuilder#withClientConfiguration(ClientConfiguration)}
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient(ClientConfiguration clientConfiguration) {
        this(DefaultAWSCredentialsProviderChain.getInstance(), clientConfiguration, newFixedThreadPool(clientConfiguration.getMaxConnections()));
    }

    /**
     * Constructs a new asynchronous client to invoke service methods on JsonProtocolTests using the specified AWS
     * account credentials.
     * <p>
     * Asynchronous methods are delegated to a fixed-size thread pool containing 50 threads (to match the default
     * maximum number of concurrent connections to the service).
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     * @deprecated use {@link AmazonProtocolRestJsonAsyncClientBuilder#withCredentials(AWSCredentialsProvider)}
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient(AWSCredentials awsCredentials) {
     ...
     * @deprecated use {@link AmazonProtocolRestJsonAsyncClientBuilder#withCredentials(AWSCredentialsProvider)} and
     *             {@link AmazonProtocolRestJsonAsyncClientBuilder#withExecutorFactory(com.amazonaws.client.builder.ExecutorFactory)}
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient(AWSCredentials awsCredentials, ExecutorService executorService) {
     ...
     *        The executor service by which all asynchronous requests will be executed.
     * @deprecated use {@link AmazonProtocolRestJsonAsyncClientBuilder#withCredentials(AWSCredentialsProvider)} and
     *             {@link AmazonProtocolRestJsonAsyncClientBuilder#withClientConfiguration(ClientConfiguration)} and
     *             {@link AmazonProtocolRestJsonAsyncClientBuilder#withExecutorFactory(com.amazonaws.client.builder.ExecutorFactory)}
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient(AWSCredentials awsCredentials, ClientConfiguration clientConfiguration, ExecutorService executorService) {
     ...
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient(AWSCredentialsProvider awsCredentialsProvider) {
        this(awsCredentialsProvider, newFixedThreadPool(DEFAULT_THREAD_POOL_SIZE));
    }

    /**
     * Constructs a new asynchronous client to invoke service methods on JsonProtocolTests using the provided AWS
     ...
     * @see java.util.concurrent.Executors#newFixedThreadPool(int)
     * @deprecated use {@link AmazonProtocolRestJsonAsyncClientBuilder#withCredentials(AWSCredentialsProvider)} and
     *             {@link AmazonProtocolRestJsonAsyncClientBuilder#withClientConfiguration(ClientConfiguration)}
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient(AWSCredentialsProvider awsCredentialsProvider, ClientConfiguration clientConfiguration) {
     ...
     */
    @Deprecated
    public AmazonProtocolRestJsonAsyncClient(AWSCredentialsProvider awsCredentialsProvider, ExecutorService executorService) {
    ...
    public static AmazonProtocolRestJsonAsyncClientBuilder asyncBuilder() {
        return AmazonProtocolRestJsonAsyncClientBuilder.standard();
    }

    /**
     * Constructs a new asynchronous client to invoke service methods on JsonProtocolTests using the specified
     * parameters.
     *
     * @param asyncClientParams
     *        Object providing client parameters.
     */
    AmazonProtocolRestJsonAsyncClient(AwsAsyncClientParams asyncClientParams) {
     ...
     */
    AmazonProtocolRestJsonAsyncClient(AwsAsyncClientParams asyncClientParams, boolean endpointDiscoveryEnabled) {
    ...
    @Override
    public java.util.concurrent.Future<FurtherNestedContainersResult> furtherNestedContainersAsync(FurtherNestedContainersRequest request) {

        return furtherNestedContainersAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<FurtherNestedContainersResult> furtherNestedContainersAsync(final FurtherNestedContainersRequest request,
            final com.amazonaws.handlers.AsyncHandler<FurtherNestedContainersRequest, FurtherNestedContainersResult> asyncHandler) {
        final FurtherNestedContainersRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<FurtherNestedContainersResult>() {
            @Override
            public FurtherNestedContainersResult call() throws Exception {
                FurtherNestedContainersResult result = null;

                try {
                    result = executeFurtherNestedContainers(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
    ...
    @Override
    public java.util.concurrent.Future<GetOperationWithBodyResult> getOperationWithBodyAsync(GetOperationWithBodyRequest request) {

        return getOperationWithBodyAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<GetOperationWithBodyResult> getOperationWithBodyAsync(final GetOperationWithBodyRequest request,
            final com.amazonaws.handlers.AsyncHandler<GetOperationWithBodyRequest, GetOperationWithBodyResult> asyncHandler) {
        final GetOperationWithBodyRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<GetOperationWithBodyResult>() {
            @Override
            public GetOperationWithBodyResult call() throws Exception {
                GetOperationWithBodyResult result = null;

                try {
                    result = executeGetOperationWithBody(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
    ...
    @Override
    public java.util.concurrent.Future<HeadOperationResult> headOperationAsync(HeadOperationRequest request) {

        return headOperationAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<HeadOperationResult> headOperationAsync(final HeadOperationRequest request,
            final com.amazonaws.handlers.AsyncHandler<HeadOperationRequest, HeadOperationResult> asyncHandler) {
        final HeadOperationRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<HeadOperationResult>() {
            @Override
            public HeadOperationResult call() throws Exception {
                HeadOperationResult result = null;

                try {
                    result = executeHeadOperation(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
    ...
    @Override
    public java.util.concurrent.Future<JsonValuesOperationResult> jsonValuesOperationAsync(JsonValuesOperationRequest request) {

        return jsonValuesOperationAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<JsonValuesOperationResult> jsonValuesOperationAsync(final JsonValuesOperationRequest request,
            final com.amazonaws.handlers.AsyncHandler<JsonValuesOperationRequest, JsonValuesOperationResult> asyncHandler) {
        final JsonValuesOperationRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<JsonValuesOperationResult>() {
            @Override
            public JsonValuesOperationResult call() throws Exception {
                JsonValuesOperationResult result = null;

                try {
                    result = executeJsonValuesOperation(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
    ...
    @Override
    public java.util.concurrent.Future<NestedContainersResult> nestedContainersAsync(NestedContainersRequest request) {

        return nestedContainersAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<NestedContainersResult> nestedContainersAsync(final NestedContainersRequest request,
            final com.amazonaws.handlers.AsyncHandler<NestedContainersRequest, NestedContainersResult> asyncHandler) {
        final NestedContainersRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<NestedContainersResult>() {
            @Override
            public NestedContainersResult call() throws Exception {
                NestedContainersResult result = null;

                try {
                    result = executeNestedContainers(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
    ...
    @Override
    public java.util.concurrent.Future<OperationWithExplicitPayloadStructureResult> operationWithExplicitPayloadStructureAsync(
            OperationWithExplicitPayloadStructureRequest request) {

        return operationWithExplicitPayloadStructureAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<OperationWithExplicitPayloadStructureResult> operationWithExplicitPayloadStructureAsync(
            final OperationWithExplicitPayloadStructureRequest request,
            final com.amazonaws.handlers.AsyncHandler<OperationWithExplicitPayloadStructureRequest, OperationWithExplicitPayloadStructureResult> asyncHandler) {
        final OperationWithExplicitPayloadStructureRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<OperationWithExplicitPayloadStructureResult>() {
            @Override
            public OperationWithExplicitPayloadStructureResult call() throws Exception {
                OperationWithExplicitPayloadStructureResult result = null;

                try {
                    result = executeOperationWithExplicitPayloadStructure(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
    ...
    @Override
    public java.util.concurrent.Future<OperationWithNoInputOrOutputResult> operationWithNoInputOrOutputAsync(OperationWithNoInputOrOutputRequest request) {

        return operationWithNoInputOrOutputAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<OperationWithNoInputOrOutputResult> operationWithNoInputOrOutputAsync(final OperationWithNoInputOrOutputRequest request,
            final com.amazonaws.handlers.AsyncHandler<OperationWithNoInputOrOutputRequest, OperationWithNoInputOrOutputResult> asyncHandler) {
        final OperationWithNoInputOrOutputRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<OperationWithNoInputOrOutputResult>() {
            @Override
            public OperationWithNoInputOrOutputResult call() throws Exception {
                OperationWithNoInputOrOutputResult result = null;

                try {
                    result = executeOperationWithNoInputOrOutput(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
    ...
    @Override
    public java.util.concurrent.Future<StreamingInputOperationResult> streamingInputOperationAsync(StreamingInputOperationRequest request) {

        return streamingInputOperationAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<StreamingInputOperationResult> streamingInputOperationAsync(final StreamingInputOperationRequest request,
            final com.amazonaws.handlers.AsyncHandler<StreamingInputOperationRequest, StreamingInputOperationResult> asyncHandler) {
        final StreamingInputOperationRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<StreamingInputOperationResult>() {
            @Override
            public StreamingInputOperationResult call() throws Exception {
                StreamingInputOperationResult result = null;

                try {
                    result = executeStreamingInputOperation(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
