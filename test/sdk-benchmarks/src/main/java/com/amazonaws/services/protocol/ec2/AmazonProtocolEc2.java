...
/**
 * Interface for accessing EC2ProtocolTests.
 * <p>
 * <b>Note:</b> Do not directly implement this interface, new methods are added to it regularly. Extend from
 * {@link AbstractAmazonProtocolEc2} instead.
 * </p>
 */

public interface AmazonProtocolEc2 {
    ...
    /**
     * Overrides the default endpoint for this client ("https://protocol-ec2.us-east-1.amazonaws.com"). Callers can use
     * this method to control which AWS region they want to work with.
     * <p>
     * Callers can pass in just the endpoint (ex: "protocol-ec2.us-east-1.amazonaws.com") or a full URL, including the
     * protocol (ex: "https://protocol-ec2.us-east-1.amazonaws.com"). If the protocol is not specified here, the default
     ...
     *
     * @param endpoint
     *        The endpoint (ex: "protocol-ec2.us-east-1.amazonaws.com") or a full URL, including the protocol (ex:
     *        "https://protocol-ec2.us-east-1.amazonaws.com") of the region specific AWS endpoint this client will
     *        communicate with.
    ...
    /**
     * An alternative to {@link AmazonProtocolEc2#setEndpoint(String)}, sets the regional endpoint for this client's
     ...
     *      Documentation</a>
     */
    Ec2TypesResult ec2Types(Ec2TypesRequest ec2TypesRequest);
