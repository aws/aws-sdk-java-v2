...
/**
 * Abstract implementation of {@code AmazonProtocolRestJson}. Convenient method forms pass through to the corresponding
 * overload that takes a request object, which throws an {@code UnsupportedOperationException}.
 */

public class AbstractAmazonProtocolRestJson implements AmazonProtocolRestJson {

    protected AbstractAmazonProtocolRestJson() {
    }
