...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/restjson-2016-03-11/SimpleStruct" target="_top">AWS API
 *      Documentation</a>
 */
...
public class SimpleStruct implements Serializable, Cloneable, StructuredPojo {
    ...
    public SimpleStruct withStringMember(String stringMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SimpleStruct == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.protocol.restjson.model.transform.SimpleStructMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
