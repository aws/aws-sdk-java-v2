...
public class RpcV2CborListsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RpcV2CborListsRequest withStringList(String... stringList) {
    ...
    public RpcV2CborListsRequest withStringList(java.util.Collection<String> stringList) {
    ...
    public RpcV2CborListsRequest withStringSet(String... stringSet) {
    ...
    public RpcV2CborListsRequest withStringSet(java.util.Collection<String> stringSet) {
    ...
    public RpcV2CborListsRequest withIntegerList(Integer... integerList) {
    ...
    public RpcV2CborListsRequest withIntegerList(java.util.Collection<Integer> integerList) {
    ...
    public RpcV2CborListsRequest withBooleanList(Boolean... booleanList) {
    ...
    public RpcV2CborListsRequest withBooleanList(java.util.Collection<Boolean> booleanList) {
    ...
    public RpcV2CborListsRequest withTimestampList(java.util.Date... timestampList) {
    ...
    public RpcV2CborListsRequest withTimestampList(java.util.Collection<java.util.Date> timestampList) {
    ...
    public RpcV2CborListsRequest withEnumList(String... enumList) {
    ...
    public RpcV2CborListsRequest withEnumList(java.util.Collection<String> enumList) {
    ...
    public RpcV2CborListsRequest withEnumList(FooEnum... enumList) {
    ...
    public RpcV2CborListsRequest withIntEnumList(Integer... intEnumList) {
    ...
    public RpcV2CborListsRequest withIntEnumList(java.util.Collection<Integer> intEnumList) {
    ...
    public RpcV2CborListsRequest withNestedStringList(java.util.List<String>... nestedStringList) {
    ...
    public RpcV2CborListsRequest withNestedStringList(java.util.Collection<java.util.List<String>> nestedStringList) {
    ...
    public RpcV2CborListsRequest withStructureList(StructureListMember... structureList) {
    ...
    public RpcV2CborListsRequest withStructureList(java.util.Collection<StructureListMember> structureList) {
    ...
    public RpcV2CborListsRequest withBlobList(java.nio.ByteBuffer... blobList) {
    ...
    public RpcV2CborListsRequest withBlobList(java.util.Collection<java.nio.ByteBuffer> blobList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RpcV2CborListsRequest == false)
            return false;
        RpcV2CborListsRequest other = (RpcV2CborListsRequest) obj;
    ...
    @Override
    public RpcV2CborListsRequest clone() {
        return (RpcV2CborListsRequest) super.clone();
    }
