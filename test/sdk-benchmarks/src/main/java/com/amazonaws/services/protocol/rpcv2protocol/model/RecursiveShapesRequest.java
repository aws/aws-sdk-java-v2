...
public class RecursiveShapesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RecursiveShapesRequest withNested(RecursiveShapesInputOutputNested1 nested) {
        setNested(nested);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RecursiveShapesRequest == false)
            return false;
        RecursiveShapesRequest other = (RecursiveShapesRequest) obj;
    ...
    @Override
    public RecursiveShapesRequest clone() {
        return (RecursiveShapesRequest) super.clone();
    }
