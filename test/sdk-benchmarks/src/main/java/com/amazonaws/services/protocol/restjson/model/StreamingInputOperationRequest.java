...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/restjson-2016-03-11/StreamingInputOperation" target="_top">AWS
 *      API Documentation</a>
 */

public class StreamingInputOperationRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StreamingInputOperationRequest withStreamingMember(java.io.InputStream streamingMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StreamingInputOperationRequest == false)
            return false;
        StreamingInputOperationRequest other = (StreamingInputOperationRequest) obj;
    ...
    @Override
    public StreamingInputOperationRequest clone() {
        return (StreamingInputOperationRequest) super.clone();
    }
