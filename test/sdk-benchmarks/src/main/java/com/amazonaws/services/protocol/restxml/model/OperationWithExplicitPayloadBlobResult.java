...
public class OperationWithExplicitPayloadBlobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public OperationWithExplicitPayloadBlobResult withPayloadMember(java.nio.ByteBuffer payloadMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OperationWithExplicitPayloadBlobResult == false)
            return false;
        OperationWithExplicitPayloadBlobResult other = (OperationWithExplicitPayloadBlobResult) obj;
    ...
    @Override
    public OperationWithExplicitPayloadBlobResult clone() {
        try {
            return (OperationWithExplicitPayloadBlobResult) super.clone();
