...
public class AllTypesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AllTypesResult withListOfMaps(java.util.Map<String, String>... listOfMaps) {
    ...
    public AllTypesResult withListOfMaps(java.util.Collection<java.util.Map<String, String>> listOfMaps) {
    ...
    public AllTypesResult withMapOfStringToIntegerList(java.util.Map<String, java.util.List<Integer>> mapOfStringToIntegerList) {
     ...
     *
     * @see AllTypesResult#withMapOfStringToIntegerList
     * @returns a reference to this object so that method calls can be chained together.
     */

    public AllTypesResult addMapOfStringToIntegerListEntry(String key, java.util.List<Integer> value) {
    ...
    public AllTypesResult clearMapOfStringToIntegerListEntries() {
    ...
    public AllTypesResult withMapOfStringToStruct(java.util.Map<String, SimpleStruct> mapOfStringToStruct) {
     ...
     *
     * @see AllTypesResult#withMapOfStringToStruct
     * @returns a reference to this object so that method calls can be chained together.
     */

    public AllTypesResult addMapOfStringToStructEntry(String key, SimpleStruct value) {
    ...
    public AllTypesResult clearMapOfStringToStructEntries() {
    ...
    public AllTypesResult withStructWithNestedBlob(StructWithNestedBlobType structWithNestedBlob) {
    ...
    public AllTypesResult withRecursiveStruct(RecursiveStructType recursiveStruct) {
    ...
    public AllTypesResult withPolymorphicTypeWithSubTypes(BaseType polymorphicTypeWithSubTypes) {
    ...
    public AllTypesResult withPolymorphicTypeWithoutSubTypes(SubTypeOne polymorphicTypeWithoutSubTypes) {
