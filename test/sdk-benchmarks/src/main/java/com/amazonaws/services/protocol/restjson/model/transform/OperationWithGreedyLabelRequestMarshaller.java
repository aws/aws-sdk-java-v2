...
@SdkInternalApi
public class OperationWithGreedyLabelRequestMarshaller {
    ...
    private static final OperationWithGreedyLabelRequestMarshaller instance = new OperationWithGreedyLabelRequestMarshaller();

    public static OperationWithGreedyLabelRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(OperationWithGreedyLabelRequest operationWithGreedyLabelRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(operationWithGreedyLabelRequest.getNonGreedyPathParam(), NONGREEDYPATHPARAM_BINDING);
            protocolMarshaller.marshall(operationWithGreedyLabelRequest.getGreedyPathParam(), GREEDYPATHPARAM_BINDING);
        } catch (Exception e) {
