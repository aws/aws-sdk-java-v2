...
public class OperationWithExplicitPayloadStructureRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public OperationWithExplicitPayloadStructureRequest withPayloadMember(SimpleStruct payloadMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OperationWithExplicitPayloadStructureRequest == false)
            return false;
    ...
    @Override
    public OperationWithExplicitPayloadStructureRequest clone() {
        return (OperationWithExplicitPayloadStructureRequest) super.clone();
    }
