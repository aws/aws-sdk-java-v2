...
public class JsonValuesOperationRequest extends AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public JsonValuesOperationRequest withJsonValueHeaderMember(String jsonValueHeaderMember) {
    ...
    public JsonValuesOperationRequest withJsonValueMember(String jsonValueMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JsonValuesOperationRequest == false)
            return false;
    ...
    @Override
    public JsonValuesOperationRequest clone() {
        return (JsonValuesOperationRequest) super.clone();
    }
