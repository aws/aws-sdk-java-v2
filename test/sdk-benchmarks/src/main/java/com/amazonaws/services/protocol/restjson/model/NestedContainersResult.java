...
public class NestedContainersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public NestedContainersResult withListOfListsOfStrings(java.util.List<String>... listOfListsOfStrings) {
    ...
    public NestedContainersResult withListOfListsOfStrings(java.util.Collection<java.util.List<String>> listOfListsOfStrings) {
    ...
    public NestedContainersResult withListOfListsOfStructs(java.util.List<SimpleStruct>... listOfListsOfStructs) {
    ...
    public NestedContainersResult withListOfListsOfStructs(java.util.Collection<java.util.List<SimpleStruct>> listOfListsOfStructs) {
    ...
    public NestedContainersResult withListOfListsOfAllTypesStructs(java.util.List<AllTypesStructure>... listOfListsOfAllTypesStructs) {
    ...
    public NestedContainersResult withListOfListsOfAllTypesStructs(java.util.Collection<java.util.List<AllTypesStructure>> listOfListsOfAllTypesStructs) {
    ...
    public NestedContainersResult withListOfListOfListsOfStrings(java.util.List<java.util.List<String>>... listOfListOfListsOfStrings) {
    ...
    public NestedContainersResult withListOfListOfListsOfStrings(java.util.Collection<java.util.List<java.util.List<String>>> listOfListOfListsOfStrings) {
    ...
    public NestedContainersResult withMapOfStringToListOfListsOfStrings(
     ...
     *
     * @see NestedContainersResult#withMapOfStringToListOfListsOfStrings
     * @returns a reference to this object so that method calls can be chained together.
     */

    public NestedContainersResult addMapOfStringToListOfListsOfStringsEntry(String key, java.util.List<java.util.List<String>> value) {
    ...
    public NestedContainersResult clearMapOfStringToListOfListsOfStringsEntries() {
    ...
    public NestedContainersResult withStringMember(String stringMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NestedContainersResult == false)
            return false;
