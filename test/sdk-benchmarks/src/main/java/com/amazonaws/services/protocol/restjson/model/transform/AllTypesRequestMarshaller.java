...
@SdkInternalApi
public class AllTypesRequestMarshaller {
    ...
    private static final AllTypesRequestMarshaller instance = new AllTypesRequestMarshaller();

    public static AllTypesRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(AllTypesRequest allTypesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(allTypesRequest.getStringMember(), STRINGMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getIntegerMember(), INTEGERMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getBooleanMember(), BOOLEANMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getFloatMember(), FLOATMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getDoubleMember(), DOUBLEMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getLongMember(), LONGMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getSimpleList(), SIMPLELIST_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getListOfMaps(), LISTOFMAPS_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getListOfStructs(), LISTOFSTRUCTS_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getMapOfStringToIntegerList(), MAPOFSTRINGTOINTEGERLIST_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getMapOfStringToString(), MAPOFSTRINGTOSTRING_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getMapOfStringToStruct(), MAPOFSTRINGTOSTRUCT_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getTimestampMember(), TIMESTAMPMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getStructWithNestedTimestampMember(), STRUCTWITHNESTEDTIMESTAMPMEMBER_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getBlobArg(), BLOBARG_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getStructWithNestedBlob(), STRUCTWITHNESTEDBLOB_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getBlobMap(), BLOBMAP_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getListOfBlobs(), LISTOFBLOBS_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getRecursiveStruct(), RECURSIVESTRUCT_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getPolymorphicTypeWithSubTypes(), POLYMORPHICTYPEWITHSUBTYPES_BINDING);
            protocolMarshaller.marshall(allTypesRequest.getPolymorphicTypeWithoutSubTypes(), POLYMORPHICTYPEWITHOUTSUBTYPES_BINDING);
        } catch (Exception e) {
