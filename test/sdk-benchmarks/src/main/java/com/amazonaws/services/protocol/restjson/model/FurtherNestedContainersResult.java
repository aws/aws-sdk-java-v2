...
public class FurtherNestedContainersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public FurtherNestedContainersResult withListOfNested(NestedContainersStructure... listOfNested) {
    ...
    public FurtherNestedContainersResult withListOfNested(java.util.Collection<NestedContainersStructure> listOfNested) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FurtherNestedContainersResult == false)
            return false;
        FurtherNestedContainersResult other = (FurtherNestedContainersResult) obj;
    ...
    @Override
    public FurtherNestedContainersResult clone() {
        try {
            return (FurtherNestedContainersResult) super.clone();
