...
/**
 * QueryTypesResult StAX Unmarshaller
 */


public class QueryTypesResultStaxUnmarshaller implements Unmarshaller<QueryTypesResult, StaxUnmarshallerContext> {
    ...
    public QueryTypesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        QueryTypesResult queryTypesResult = new QueryTypesResult();
        int originalDepth = context.getCurrentDepth();
        int targetDepth = originalDepth + 1;
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("FlattenedListOfStrings", targetDepth)) {
                    queryTypesResult.withFlattenedListOfStrings(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("NonFlattenedListWithLocation", targetDepth)) {
                    queryTypesResult.withNonFlattenedListWithLocation(new ArrayList<String>());
                    continue;
                }

                if (context.testExpression("NonFlattenedListWithLocation/item", targetDepth)) {
                    queryTypesResult.withNonFlattenedListWithLocation(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("FlattenedListOfStructs", targetDepth)) {
                    queryTypesResult.withFlattenedListOfStructs(SimpleStructStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("item", targetDepth)) {
                    queryTypesResult.withFlattenedListWithLocation(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("FlattenedMap", targetDepth)) {
                    ...
                    queryTypesResult.addFlattenedMapEntry(entry.getKey(), entry.getValue());
                    continue;
                }
                ...
                if (context.testExpression("flatmap", targetDepth)) {
                    ...
                    queryTypesResult.addFlattenedMapWithLocationEntry(entry.getKey(), entry.getValue());
                    continue;
                }
                ...
                if (context.testExpression("themap/entry", targetDepth)) {
                    ...
                    queryTypesResult.addNonFlattenedMapWithLocationEntry(entry.getKey(), entry.getValue());
                    continue;
                }
    ...
    private static QueryTypesResultStaxUnmarshaller instance;

    public static QueryTypesResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new QueryTypesResultStaxUnmarshaller();
        return instance;
    }
}
