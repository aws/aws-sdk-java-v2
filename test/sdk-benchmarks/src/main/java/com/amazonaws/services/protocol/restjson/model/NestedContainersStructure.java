...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/restjson-2016-03-11/NestedContainersStructure" target="_top">AWS
 *      API Documentation</a>
 */

public class NestedContainersStructure implements Serializable, Cloneable, StructuredPojo {
    ...
    public NestedContainersStructure withListOfListsOfStrings(java.util.List<String>... listOfListsOfStrings) {
    ...
    public NestedContainersStructure withListOfListsOfStrings(java.util.Collection<java.util.List<String>> listOfListsOfStrings) {
    ...
    public NestedContainersStructure withListOfListsOfStructs(java.util.List<SimpleStruct>... listOfListsOfStructs) {
    ...
    public NestedContainersStructure withListOfListsOfStructs(java.util.Collection<java.util.List<SimpleStruct>> listOfListsOfStructs) {
    ...
    public NestedContainersStructure withListOfListsOfAllTypesStructs(java.util.List<AllTypesStructure>... listOfListsOfAllTypesStructs) {
    ...
    public NestedContainersStructure withListOfListsOfAllTypesStructs(java.util.Collection<java.util.List<AllTypesStructure>> listOfListsOfAllTypesStructs) {
    ...
    public NestedContainersStructure withListOfListOfListsOfStrings(java.util.List<java.util.List<String>>... listOfListOfListsOfStrings) {
    ...
    public NestedContainersStructure withListOfListOfListsOfStrings(java.util.Collection<java.util.List<java.util.List<String>>> listOfListOfListsOfStrings) {
    ...
    public NestedContainersStructure withMapOfStringToListOfListsOfStrings(
     ...
     *
     * @see NestedContainersStructure#withMapOfStringToListOfListsOfStrings
     * @returns a reference to this object so that method calls can be chained together.
     */

    public NestedContainersStructure addMapOfStringToListOfListsOfStringsEntry(String key, java.util.List<java.util.List<String>> value) {
    ...
    public NestedContainersStructure clearMapOfStringToListOfListsOfStringsEntries() {
    ...
    public NestedContainersStructure withStringMember(String stringMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NestedContainersStructure == false)
            return false;
    ...
    @Override
    public NestedContainersStructure clone() {
        try {
            return (NestedContainersStructure) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.protocol.restjson.model.transform.NestedContainersStructureMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
