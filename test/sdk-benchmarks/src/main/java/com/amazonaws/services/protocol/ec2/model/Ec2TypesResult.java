...
public class Ec2TypesResult extends AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public Ec2TypesResult withFlattenedListOfStrings(String... flattenedListOfStrings) {
    ...
    public Ec2TypesResult withFlattenedListOfStrings(java.util.Collection<String> flattenedListOfStrings) {
    ...
    public Ec2TypesResult withFlattenedListOfStructs(SimpleStruct... flattenedListOfStructs) {
    ...
    public Ec2TypesResult withFlattenedListOfStructs(java.util.Collection<SimpleStruct> flattenedListOfStructs) {
    ...
    public Ec2TypesResult withFlattenedListWithLocation(String... flattenedListWithLocation) {
    ...
    public Ec2TypesResult withFlattenedListWithLocation(java.util.Collection<String> flattenedListWithLocation) {
    ...
    public Ec2TypesResult withStringMemberWithLocation(String stringMemberWithLocation) {
    ...
    public Ec2TypesResult withStringMemberWithQueryName(String stringMemberWithQueryName) {
    ...
    public Ec2TypesResult withStringMemberWithLocationAndQueryName(String stringMemberWithLocationAndQueryName) {
    ...
    public Ec2TypesResult withListMemberWithLocationAndQueryName(String... listMemberWithLocationAndQueryName) {
    ...
    public Ec2TypesResult withListMemberWithLocationAndQueryName(java.util.Collection<String> listMemberWithLocationAndQueryName) {
    ...
    public Ec2TypesResult withListMemberWithOnlyMemberLocation(String... listMemberWithOnlyMemberLocation) {
    ...
    public Ec2TypesResult withListMemberWithOnlyMemberLocation(java.util.Collection<String> listMemberWithOnlyMemberLocation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Ec2TypesResult == false)
            return false;
        Ec2TypesResult other = (Ec2TypesResult) obj;
    ...
    @Override
    public Ec2TypesResult clone() {
        try {
            return (Ec2TypesResult) super.clone();
