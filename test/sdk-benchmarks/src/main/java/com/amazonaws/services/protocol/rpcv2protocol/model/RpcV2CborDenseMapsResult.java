...
public class RpcV2CborDenseMapsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public RpcV2CborDenseMapsResult withDenseStructMap(java.util.Map<String, GreetingStruct> denseStructMap) {
     ...
     *
     * @see RpcV2CborDenseMapsResult#withDenseStructMap
     * @returns a reference to this object so that method calls can be chained together.
     */

    public RpcV2CborDenseMapsResult addDenseStructMapEntry(String key, GreetingStruct value) {
    ...
    public RpcV2CborDenseMapsResult clearDenseStructMapEntries() {
    ...
    public RpcV2CborDenseMapsResult withDenseNumberMap(java.util.Map<String, Integer> denseNumberMap) {
     ...
     *
     * @see RpcV2CborDenseMapsResult#withDenseNumberMap
     * @returns a reference to this object so that method calls can be chained together.
     */

    public RpcV2CborDenseMapsResult addDenseNumberMapEntry(String key, Integer value) {
    ...
    public RpcV2CborDenseMapsResult clearDenseNumberMapEntries() {
    ...
    public RpcV2CborDenseMapsResult withDenseBooleanMap(java.util.Map<String, Boolean> denseBooleanMap) {
     ...
     *
     * @see RpcV2CborDenseMapsResult#withDenseBooleanMap
     * @returns a reference to this object so that method calls can be chained together.
     */

    public RpcV2CborDenseMapsResult addDenseBooleanMapEntry(String key, Boolean value) {
    ...
    public RpcV2CborDenseMapsResult clearDenseBooleanMapEntries() {
    ...
    public RpcV2CborDenseMapsResult withDenseStringMap(java.util.Map<String, String> denseStringMap) {
     ...
     *
     * @see RpcV2CborDenseMapsResult#withDenseStringMap
     * @returns a reference to this object so that method calls can be chained together.
     */

    public RpcV2CborDenseMapsResult addDenseStringMapEntry(String key, String value) {
    ...
    public RpcV2CborDenseMapsResult clearDenseStringMapEntries() {
    ...
    public RpcV2CborDenseMapsResult withDenseSetMap(java.util.Map<String, java.util.List<String>> denseSetMap) {
     ...
     *
     * @see RpcV2CborDenseMapsResult#withDenseSetMap
     * @returns a reference to this object so that method calls can be chained together.
     */

    public RpcV2CborDenseMapsResult addDenseSetMapEntry(String key, java.util.List<String> value) {
    ...
    public RpcV2CborDenseMapsResult clearDenseSetMapEntries() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RpcV2CborDenseMapsResult == false)
            return false;
        RpcV2CborDenseMapsResult other = (RpcV2CborDenseMapsResult) obj;
    ...
    @Override
    public RpcV2CborDenseMapsResult clone() {
        try {
            return (RpcV2CborDenseMapsResult) super.clone();
