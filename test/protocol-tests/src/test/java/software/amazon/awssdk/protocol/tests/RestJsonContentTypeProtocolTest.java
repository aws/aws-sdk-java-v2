...
public class RestJsonContentTypeProtocolTest extends ProtocolTestBase {
    ...
    public static List<TestCase> data() throws IOException {
        return testSuiteLoader.load("restjson-contenttype-suite.json");
    }

    @BeforeClass
    public static void setupFixture() {
        testRunner = new ProtocolTestRunner("/models/rest-test-2021-05-13-intermediate.json");
    }
