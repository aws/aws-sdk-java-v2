...
public class SmithyRpcV2CborNonQueryCompatibleProtocolTest extends ProtocolTestBase {
    ...
    public static List<TestCase> data() throws IOException {
        return TEST_SUITE_LOADER.load("smithy-rpcv2-nonquerycompatible-suite.json");
    }
