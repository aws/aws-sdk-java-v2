 ...
 *
 * <p>The test body is relocated from sdk-core's {@code AsyncHttpClientApiCallTimeoutTests#slowApiAttempt...}; the only change
 * is that the transport is obtained from {@link #createSdkAsyncHttpClient()} instead of a ServiceLoader default.</p>
 */
