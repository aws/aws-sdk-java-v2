...
/**
 * {@link ListProjectsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListProjectsRequestMarshaller implements Marshaller<ListProjectsRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder()
            .requestUri("/v1/spaces/{spaceName}/projects").httpMethod(SdkHttpMethod.POST).hasExplicitPayloadMember(false)
    ...
    public SdkHttpFullRequest marshall(ListProjectsRequest listProjectsRequest) {
        Validate.paramNotNull(listProjectsRequest, "listProjectsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listProjectsRequest);
        } catch (Exception e) {
