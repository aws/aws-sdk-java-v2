...
public final class ThrottlingException extends CodeCatalystException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ThrottlingException>, CodeCatalystException.Builder {
        @Override
