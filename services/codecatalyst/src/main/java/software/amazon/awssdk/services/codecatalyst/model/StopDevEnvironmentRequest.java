...
public final class StopDevEnvironmentRequest extends CodeCatalystRequest implements
        ToCopyableBuilder<StopDevEnvironmentRequest.Builder, StopDevEnvironmentRequest> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(StopDevEnvironmentRequest::spaceName)).setter(setter(Builder::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(StopDevEnvironmentRequest::projectName))
    ...
    private static final SdkField<String> ID_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("id")
            .getter(getter(StopDevEnvironmentRequest::id)).setter(setter(Builder::id))
    ...
    private StopDevEnvironmentRequest(BuilderImpl builder) {
        super(builder);
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof StopDevEnvironmentRequest)) {
            return false;
        }
        StopDevEnvironmentRequest other = (StopDevEnvironmentRequest) obj;
    ...
    public final String toString() {
        return ToString.builder("StopDevEnvironmentRequest").add("SpaceName", spaceName()).add("ProjectName", projectName())
                .add("Id", id()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<StopDevEnvironmentRequest, T> g) {
        return obj -> g.apply((StopDevEnvironmentRequest) obj);
    }
    ...
    public interface Builder extends CodeCatalystRequest.Builder, SdkPojo, CopyableBuilder<Builder, StopDevEnvironmentRequest> {
        /**
         * <p>
         * The name of the space.
         * </p>
    ...
    static final class BuilderImpl extends CodeCatalystRequest.BuilderImpl implements Builder {
        ...
        private BuilderImpl(StopDevEnvironmentRequest model) {
            super(model);
        ...
        @Override
        public StopDevEnvironmentRequest build() {
            return new StopDevEnvironmentRequest(this);
        }
