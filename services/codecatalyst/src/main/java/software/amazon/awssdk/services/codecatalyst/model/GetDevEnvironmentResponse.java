...
public final class GetDevEnvironmentResponse extends CodeCatalystResponse implements
        ToCopyableBuilder<GetDevEnvironmentResponse.Builder, GetDevEnvironmentResponse> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(GetDevEnvironmentResponse::spaceName)).setter(setter(Builder::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(GetDevEnvironmentResponse::projectName))
    ...
    private static final SdkField<String> ID_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("id")
            .getter(getter(GetDevEnvironmentResponse::id)).setter(setter(Builder::id))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("id").build()).build();

    private static final SdkField<Instant> LAST_UPDATED_TIME_FIELD = SdkField
            .<Instant> builder(MarshallingType.INSTANT)
            .memberName("lastUpdatedTime")
            .getter(getter(GetDevEnvironmentResponse::lastUpdatedTime))
    ...
    private static final SdkField<String> CREATOR_ID_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("creatorId").getter(getter(GetDevEnvironmentResponse::creatorId)).setter(setter(Builder::creatorId))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("creatorId").build()).build();

    private static final SdkField<String> STATUS_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("status")
            .getter(getter(GetDevEnvironmentResponse::statusAsString)).setter(setter(Builder::status))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("status").build()).build();

    private static final SdkField<String> STATUS_REASON_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("statusReason").getter(getter(GetDevEnvironmentResponse::statusReason))
    ...
    private static final SdkField<List<DevEnvironmentRepositorySummary>> REPOSITORIES_FIELD = SdkField
            ...
            .getter(getter(GetDevEnvironmentResponse::repositories))
    ...
    private static final SdkField<String> ALIAS_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("alias")
            .getter(getter(GetDevEnvironmentResponse::alias)).setter(setter(Builder::alias))
    ...
    private static final SdkField<List<Ide>> IDES_FIELD = SdkField
            ...
            .memberName("ides")
            .getter(getter(GetDevEnvironmentResponse::ides))
    ...
    private static final SdkField<String> INSTANCE_TYPE_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("instanceType").getter(getter(GetDevEnvironmentResponse::instanceTypeAsString))
    ...
    private static final SdkField<Integer> INACTIVITY_TIMEOUT_MINUTES_FIELD = SdkField.<Integer> builder(MarshallingType.INTEGER)
            .memberName("inactivityTimeoutMinutes").getter(getter(GetDevEnvironmentResponse::inactivityTimeoutMinutes))
    ...
    private static final SdkField<PersistentStorage> PERSISTENT_STORAGE_FIELD = SdkField
            ...
            .getter(getter(GetDevEnvironmentResponse::persistentStorage)).setter(setter(Builder::persistentStorage))
    ...
    private GetDevEnvironmentResponse(BuilderImpl builder) {
        super(builder);
     ...
     * </p>
     * 
     * @return The current status of the Dev Environment.
     ...
     * </p>
     * 
     * @return The source repository that contains the branch cloned into the Dev Environment.
     */
     ...
     * </p>
     * 
     * @return Information about the integrated development environment (IDE) configured for the Dev Environment.
     */
    ...
    /**
     * <p>
     * Information about the amount of storage allocated to the Dev Environment. By default, a Dev Environment is
     * configured to have 16GB of persistent storage.
     * </p>
     * 
     * @return Information about the amount of storage allocated to the Dev Environment. By default, a Dev Environment
     *         is configured to have 16GB of persistent storage.
     */
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        GetDevEnvironmentResponse other = (GetDevEnvironmentResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("GetDevEnvironmentResponse").add("SpaceName", spaceName()).add("ProjectName", projectName())
    ...
    private static <T> Function<Object, T> getter(Function<GetDevEnvironmentResponse, T> g) {
        return obj -> g.apply((GetDevEnvironmentResponse) obj);
    }
    ...
    static final class BuilderImpl extends CodeCatalystResponse.BuilderImpl implements Builder {
        ...
        private BuilderImpl(GetDevEnvironmentResponse model) {
            super(model);
        ...
        @Override
        public GetDevEnvironmentResponse build() {
