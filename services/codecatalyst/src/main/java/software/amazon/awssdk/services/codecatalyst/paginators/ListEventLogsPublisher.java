 ...
 * {@link software.amazon.awssdk.services.codecatalyst.CodeCatalystAsyncClient#listEventLogsPaginator(software.amazon.awssdk.services.codecatalyst.model.ListEventLogsRequest)}
 * operation which is a paginated operation. This class is a type of {@link org.reactivestreams.Publisher} which can be
 * used to provide a sequence of {@link software.amazon.awssdk.services.codecatalyst.model.ListEventLogsResponse}
...
public class ListEventLogsPublisher implements SdkPublisher<ListEventLogsResponse> {
    ...
    public final SdkPublisher<EventLogEntry> items() {
        ...
        return PaginatedItemsPublisher.builder().nextPageFetcher(new ListEventLogsResponseFetcher())
    ...
    private class ListEventLogsResponseFetcher implements AsyncPageFetcher<ListEventLogsResponse> {
        @Override
        public boolean hasNextPage(final ListEventLogsResponse previousPage) {
            return PaginatorUtils.isOutputTokenAvailable(previousPage.nextToken());
        }

        @Override
        public CompletableFuture<ListEventLogsResponse> nextPage(final ListEventLogsResponse previousPage) {
