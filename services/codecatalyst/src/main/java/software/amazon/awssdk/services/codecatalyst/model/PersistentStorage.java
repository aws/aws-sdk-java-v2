...
public final class PersistentStorage implements SdkPojo, Serializable,
        ToCopyableBuilder<PersistentStorage.Builder, PersistentStorage> {
    private static final SdkField<Integer> SIZE_IN_GIB_FIELD = SdkField.<Integer> builder(MarshallingType.INTEGER)
            .memberName("sizeInGiB").getter(getter(PersistentStorage::sizeInGiB)).setter(setter(Builder::sizeInGiB))
    ...
    private PersistentStorage(BuilderImpl builder) {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof PersistentStorage)) {
            return false;
        }
        PersistentStorage other = (PersistentStorage) obj;
    ...
    public final String toString() {
        return ToString.builder("PersistentStorage").add("SizeInGiB", sizeInGiB()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<PersistentStorage, T> g) {
        return obj -> g.apply((PersistentStorage) obj);
    }
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, PersistentStorage> {
        /**
         * <p>
         * The size of the persistent storage in gigabytes (specifically GiB).
         * </p>
    ...
    static final class BuilderImpl implements Builder {
        ...
        private BuilderImpl(PersistentStorage model) {
        ...
        @Override
        public PersistentStorage build() {
            return new PersistentStorage(this);
        }
