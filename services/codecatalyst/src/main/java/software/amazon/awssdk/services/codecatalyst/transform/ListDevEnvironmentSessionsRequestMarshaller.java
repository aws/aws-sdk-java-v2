...
/**
 * {@link ListDevEnvironmentSessionsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListDevEnvironmentSessionsRequestMarshaller implements Marshaller<ListDevEnvironmentSessionsRequest> {
    ...
    public SdkHttpFullRequest marshall(ListDevEnvironmentSessionsRequest listDevEnvironmentSessionsRequest) {
        Validate.paramNotNull(listDevEnvironmentSessionsRequest, "listDevEnvironmentSessionsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listDevEnvironmentSessionsRequest);
        } catch (Exception e) {
