...
public final class StopDevEnvironmentSessionResponse extends CodeCatalystResponse implements
        ToCopyableBuilder<StopDevEnvironmentSessionResponse.Builder, StopDevEnvironmentSessionResponse> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(StopDevEnvironmentSessionResponse::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(StopDevEnvironmentSessionResponse::projectName))
    ...
    private static final SdkField<String> ID_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("id")
            .getter(getter(StopDevEnvironmentSessionResponse::id)).setter(setter(Builder::id))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("id").build()).build();

    private static final SdkField<String> SESSION_ID_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("sessionId").getter(getter(StopDevEnvironmentSessionResponse::sessionId))
    ...
    private StopDevEnvironmentSessionResponse(BuilderImpl builder) {
        super(builder);
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        StopDevEnvironmentSessionResponse other = (StopDevEnvironmentSessionResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("StopDevEnvironmentSessionResponse").add("SpaceName", spaceName())
    ...
    private static <T> Function<Object, T> getter(Function<StopDevEnvironmentSessionResponse, T> g) {
        return obj -> g.apply((StopDevEnvironmentSessionResponse) obj);
    }
    ...
    public interface Builder extends CodeCatalystResponse.Builder, SdkPojo,
            CopyableBuilder<Builder, StopDevEnvironmentSessionResponse> {
        /**
         * <p>
         * The name of the space.
         * </p>
    ...
    static final class BuilderImpl extends CodeCatalystResponse.BuilderImpl implements Builder {
        ...
        private BuilderImpl(StopDevEnvironmentSessionResponse model) {
            super(model);
        ...
        @Override
        public StopDevEnvironmentSessionResponse build() {
            return new StopDevEnvironmentSessionResponse(this);
        }
