...
/**
 * {@link ListSourceRepositoryBranchesRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListSourceRepositoryBranchesRequestMarshaller implements Marshaller<ListSourceRepositoryBranchesRequest> {
    ...
    public SdkHttpFullRequest marshall(ListSourceRepositoryBranchesRequest listSourceRepositoryBranchesRequest) {
        Validate.paramNotNull(listSourceRepositoryBranchesRequest, "listSourceRepositoryBranchesRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listSourceRepositoryBranchesRequest);
        } catch (Exception e) {
