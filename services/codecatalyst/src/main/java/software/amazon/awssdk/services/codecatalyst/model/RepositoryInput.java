...
public final class RepositoryInput implements SdkPojo, Serializable, ToCopyableBuilder<RepositoryInput.Builder, RepositoryInput> {
    private static final SdkField<String> REPOSITORY_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("repositoryName").getter(getter(RepositoryInput::repositoryName)).setter(setter(Builder::repositoryName))
    ...
    private static final SdkField<String> BRANCH_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("branchName").getter(getter(RepositoryInput::branchName)).setter(setter(Builder::branchName))
    ...
    private RepositoryInput(BuilderImpl builder) {
    ...
    public final String toString() {
        return ToString.builder("RepositoryInput").add("RepositoryName", repositoryName()).add("BranchName", branchName())
                .build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<RepositoryInput, T> g) {
        return obj -> g.apply((RepositoryInput) obj);
    }
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, RepositoryInput> {
        /**
         * <p>
         * The name of the source repository.
         * </p>
    ...
    static final class BuilderImpl implements Builder {
        ...
        private BuilderImpl(RepositoryInput model) {
        ...
        public RepositoryInput build() {
            return new RepositoryInput(this);
        }
