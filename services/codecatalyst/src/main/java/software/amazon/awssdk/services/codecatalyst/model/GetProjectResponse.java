...
public final class GetProjectResponse extends CodeCatalystResponse implements
    ...
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(GetProjectResponse::spaceName)).setter(setter(Builder::spaceName))
    ...
    private static final SdkField<String> DISPLAY_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("displayName").getter(getter(GetProjectResponse::displayName)).setter(setter(Builder::displayName))
     ...
     * </p>
     * 
     * @return The friendly name of the project displayed to users in Amazon CodeCatalyst.
     */
    ...
    public final String toString() {
        return ToString.builder("GetProjectResponse").add("SpaceName", spaceName()).add("Name", name())
    ...
    public interface Builder extends CodeCatalystResponse.Builder, SdkPojo, CopyableBuilder<Builder, GetProjectResponse> {
        /**
         * <p>
         * The name of the space.
         * </p>
