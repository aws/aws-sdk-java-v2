...
public final class ListDevEnvironmentSessionsRequest extends CodeCatalystRequest implements
        ToCopyableBuilder<ListDevEnvironmentSessionsRequest.Builder, ListDevEnvironmentSessionsRequest> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(ListDevEnvironmentSessionsRequest::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(ListDevEnvironmentSessionsRequest::projectName))
    ...
    private static final SdkField<String> DEV_ENVIRONMENT_ID_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("devEnvironmentId").getter(getter(ListDevEnvironmentSessionsRequest::devEnvironmentId))
            .setter(setter(Builder::devEnvironmentId))
            .traits(LocationTrait.builder().location(MarshallLocation.PATH).locationName("devEnvironmentId").build()).build();

    private static final SdkField<String> NEXT_TOKEN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("nextToken").getter(getter(ListDevEnvironmentSessionsRequest::nextToken))
            .setter(setter(Builder::nextToken))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("nextToken").build()).build();

    private static final SdkField<Integer> MAX_RESULTS_FIELD = SdkField.<Integer> builder(MarshallingType.INTEGER)
            .memberName("maxResults").getter(getter(ListDevEnvironmentSessionsRequest::maxResults))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(SPACE_NAME_FIELD,
            PROJECT_NAME_FIELD, DEV_ENVIRONMENT_ID_FIELD, NEXT_TOKEN_FIELD, MAX_RESULTS_FIELD));
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        ListDevEnvironmentSessionsRequest other = (ListDevEnvironmentSessionsRequest) obj;
        return Objects.equals(spaceName(), other.spaceName()) && Objects.equals(projectName(), other.projectName())
                && Objects.equals(devEnvironmentId(), other.devEnvironmentId()) && Objects.equals(nextToken(), other.nextToken())
    ...
    public final String toString() {
        return ToString.builder("ListDevEnvironmentSessionsRequest").add("SpaceName", spaceName())
                .add("ProjectName", projectName()).add("DevEnvironmentId", devEnvironmentId()).add("NextToken", nextToken())
    ...
    private static <T> Function<Object, T> getter(Function<ListDevEnvironmentSessionsRequest, T> g) {
        return obj -> g.apply((ListDevEnvironmentSessionsRequest) obj);
    }
