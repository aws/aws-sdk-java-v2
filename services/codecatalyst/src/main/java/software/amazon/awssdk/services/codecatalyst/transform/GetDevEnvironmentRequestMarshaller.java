...
/**
 * {@link GetDevEnvironmentRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetDevEnvironmentRequestMarshaller implements Marshaller<GetDevEnvironmentRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder()
            .requestUri("/v1/spaces/{spaceName}/projects/{projectName}/devEnvironments/{id}").httpMethod(SdkHttpMethod.GET)
    ...
    public SdkHttpFullRequest marshall(GetDevEnvironmentRequest getDevEnvironmentRequest) {
        Validate.paramNotNull(getDevEnvironmentRequest, "getDevEnvironmentRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getDevEnvironmentRequest);
        } catch (Exception e) {
