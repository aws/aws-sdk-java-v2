...
/**
 * {@link ListEventLogsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListEventLogsRequestMarshaller implements Marshaller<ListEventLogsRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder()
            .requestUri("/v1/spaces/{spaceName}/eventLogs").httpMethod(SdkHttpMethod.POST).hasExplicitPayloadMember(false)
    ...
    public SdkHttpFullRequest marshall(ListEventLogsRequest listEventLogsRequest) {
        Validate.paramNotNull(listEventLogsRequest, "listEventLogsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listEventLogsRequest);
        } catch (Exception e) {
