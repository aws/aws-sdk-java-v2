...
/**
 * {@link StopDevEnvironmentSessionRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class StopDevEnvironmentSessionRequestMarshaller implements Marshaller<StopDevEnvironmentSessionRequest> {
    ...
    public SdkHttpFullRequest marshall(StopDevEnvironmentSessionRequest stopDevEnvironmentSessionRequest) {
        Validate.paramNotNull(stopDevEnvironmentSessionRequest, "stopDevEnvironmentSessionRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(stopDevEnvironmentSessionRequest);
        } catch (Exception e) {
