...
/**
 * {@link ListSpacesRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListSpacesRequestMarshaller implements Marshaller<ListSpacesRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/v1/spaces")
    ...
    public SdkHttpFullRequest marshall(ListSpacesRequest listSpacesRequest) {
        Validate.paramNotNull(listSpacesRequest, "listSpacesRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listSpacesRequest);
        } catch (Exception e) {
