...
public final class CreateDevEnvironmentResponse extends CodeCatalystResponse implements
        ToCopyableBuilder<CreateDevEnvironmentResponse.Builder, CreateDevEnvironmentResponse> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(CreateDevEnvironmentResponse::spaceName)).setter(setter(Builder::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(CreateDevEnvironmentResponse::projectName))
    ...
    private static final SdkField<String> ID_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("id")
            .getter(getter(CreateDevEnvironmentResponse::id)).setter(setter(Builder::id))
    ...
    private CreateDevEnvironmentResponse(BuilderImpl builder) {
        super(builder);
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        CreateDevEnvironmentResponse other = (CreateDevEnvironmentResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("CreateDevEnvironmentResponse").add("SpaceName", spaceName()).add("ProjectName", projectName())
                .add("Id", id()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<CreateDevEnvironmentResponse, T> g) {
        return obj -> g.apply((CreateDevEnvironmentResponse) obj);
    }
    ...
    public interface Builder extends CodeCatalystResponse.Builder, SdkPojo,
            CopyableBuilder<Builder, CreateDevEnvironmentResponse> {
        /**
         * <p>
         * The name of the space.
         * </p>
    ...
    static final class BuilderImpl extends CodeCatalystResponse.BuilderImpl implements Builder {
        ...
        private BuilderImpl(CreateDevEnvironmentResponse model) {
            super(model);
        ...
        @Override
        public CreateDevEnvironmentResponse build() {
            return new CreateDevEnvironmentResponse(this);
        }
