 ...
 * {@link software.amazon.awssdk.services.codecatalyst.CodeCatalystClient#listProjectsPaginator(software.amazon.awssdk.services.codecatalyst.model.ListProjectsRequest)}
 * operation which is a paginated operation. This class is an iterable of
 * {@link software.amazon.awssdk.services.codecatalyst.model.ListProjectsResponse} that can be used to iterate through
...
public class ListProjectsIterable implements SdkIterable<ListProjectsResponse> {
    ...
    public ListProjectsIterable(CodeCatalystClient client, ListProjectsRequest firstRequest) {
        this.client = client;
    ...
    /**
     * Returns an iterable to iterate through the paginated {@link ListProjectsResponse#items()} member. The returned
    ...
    public final SdkIterable<ProjectSummary> items() {
        ...
        return PaginatedItemsIterable.<ListProjectsResponse, ProjectSummary> builder().pagesIterable(this)
