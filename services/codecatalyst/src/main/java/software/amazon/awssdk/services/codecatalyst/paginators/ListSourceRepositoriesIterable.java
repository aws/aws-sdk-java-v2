 ...
 * {@link software.amazon.awssdk.services.codecatalyst.CodeCatalystClient#listSourceRepositoriesPaginator(software.amazon.awssdk.services.codecatalyst.model.ListSourceRepositoriesRequest)}
 * operation which is a paginated operation. This class is an iterable of
 * {@link software.amazon.awssdk.services.codecatalyst.model.ListSourceRepositoriesResponse} that can be used to iterate
...
public class ListSourceRepositoriesIterable implements SdkIterable<ListSourceRepositoriesResponse> {
    ...
    /**
     * Returns an iterable to iterate through the paginated {@link ListSourceRepositoriesResponse#items()} member. The
    ...
    public final SdkIterable<ListSourceRepositoriesItem> items() {
        ...
        return PaginatedItemsIterable.<ListSourceRepositoriesResponse, ListSourceRepositoriesItem> builder().pagesIterable(this)
