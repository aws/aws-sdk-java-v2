...
public final class GetProjectRequest extends CodeCatalystRequest implements
        ToCopyableBuilder<GetProjectRequest.Builder, GetProjectRequest> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(GetProjectRequest::spaceName)).setter(setter(Builder::spaceName))
            .traits(LocationTrait.builder().location(MarshallLocation.PATH).locationName("spaceName").build()).build();

    private static final SdkField<String> NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("name")
            .getter(getter(GetProjectRequest::name)).setter(setter(Builder::name))
    ...
    private GetProjectRequest(BuilderImpl builder) {
        super(builder);
    ...
    public final String toString() {
        return ToString.builder("GetProjectRequest").add("SpaceName", spaceName()).add("Name", name()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetProjectRequest, T> g) {
        return obj -> g.apply((GetProjectRequest) obj);
    }
    ...
    public interface Builder extends CodeCatalystRequest.Builder, SdkPojo, CopyableBuilder<Builder, GetProjectRequest> {
        /**
         * <p>
         * The name of the space.
         * </p>
    ...
    static final class BuilderImpl extends CodeCatalystRequest.BuilderImpl implements Builder {
        ...
        private BuilderImpl(GetProjectRequest model) {
            super(model);
