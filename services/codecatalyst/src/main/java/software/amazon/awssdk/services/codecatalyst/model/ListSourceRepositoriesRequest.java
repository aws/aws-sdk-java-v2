...
public final class ListSourceRepositoriesRequest extends CodeCatalystRequest implements
        ToCopyableBuilder<ListSourceRepositoriesRequest.Builder, ListSourceRepositoriesRequest> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(ListSourceRepositoriesRequest::spaceName)).setter(setter(Builder::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(ListSourceRepositoriesRequest::projectName))
    ...
    private static final SdkField<String> NEXT_TOKEN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("nextToken").getter(getter(ListSourceRepositoriesRequest::nextToken)).setter(setter(Builder::nextToken))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("nextToken").build()).build();

    private static final SdkField<Integer> MAX_RESULTS_FIELD = SdkField.<Integer> builder(MarshallingType.INTEGER)
            .memberName("maxResults").getter(getter(ListSourceRepositoriesRequest::maxResults))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(SPACE_NAME_FIELD,
            PROJECT_NAME_FIELD, NEXT_TOKEN_FIELD, MAX_RESULTS_FIELD));
    ...
    private ListSourceRepositoriesRequest(BuilderImpl builder) {
        super(builder);
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof ListSourceRepositoriesRequest)) {
            return false;
        }
        ListSourceRepositoriesRequest other = (ListSourceRepositoriesRequest) obj;
    ...
    public final String toString() {
        return ToString.builder("ListSourceRepositoriesRequest").add("SpaceName", spaceName()).add("ProjectName", projectName())
    ...
    private static <T> Function<Object, T> getter(Function<ListSourceRepositoriesRequest, T> g) {
        return obj -> g.apply((ListSourceRepositoriesRequest) obj);
    }
    ...
    public interface Builder extends CodeCatalystRequest.Builder, SdkPojo,
            CopyableBuilder<Builder, ListSourceRepositoriesRequest> {
        /**
         * <p>
         * The name of the space.
         * </p>
    ...
    static final class BuilderImpl extends CodeCatalystRequest.BuilderImpl implements Builder {
        ...
        private BuilderImpl(ListSourceRepositoriesRequest model) {
            super(model);
        ...
        @Override
        public ListSourceRepositoriesRequest build() {
            return new ListSourceRepositoriesRequest(this);
        }
