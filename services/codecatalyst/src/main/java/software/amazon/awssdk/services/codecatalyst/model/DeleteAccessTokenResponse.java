...
public final class DeleteAccessTokenResponse extends CodeCatalystResponse implements
    ...
    public final String toString() {
        return ToString.builder("DeleteAccessTokenResponse").build();
    }
    ...
    public interface Builder extends CodeCatalystResponse.Builder, SdkPojo, CopyableBuilder<Builder, DeleteAccessTokenResponse> {
    }
