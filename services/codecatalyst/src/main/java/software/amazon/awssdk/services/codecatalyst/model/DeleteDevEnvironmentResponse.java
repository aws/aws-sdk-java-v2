...
public final class DeleteDevEnvironmentResponse extends CodeCatalystResponse implements
        ToCopyableBuilder<DeleteDevEnvironmentResponse.Builder, DeleteDevEnvironmentResponse> {
    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(DeleteDevEnvironmentResponse::spaceName)).setter(setter(Builder::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(DeleteDevEnvironmentResponse::projectName))
    ...
    private static final SdkField<String> ID_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("id")
            .getter(getter(DeleteDevEnvironmentResponse::id)).setter(setter(Builder::id))
    ...
    private DeleteDevEnvironmentResponse(BuilderImpl builder) {
        super(builder);
     ...
     * </p>
     * 
     * @return The system-generated unique ID of the deleted Dev Environment.
     */
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof DeleteDevEnvironmentResponse)) {
            return false;
        }
        DeleteDevEnvironmentResponse other = (DeleteDevEnvironmentResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("DeleteDevEnvironmentResponse").add("SpaceName", spaceName()).add("ProjectName", projectName())
                .add("Id", id()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<DeleteDevEnvironmentResponse, T> g) {
        return obj -> g.apply((DeleteDevEnvironmentResponse) obj);
    }
    ...
    public interface Builder extends CodeCatalystResponse.Builder, SdkPojo,
            CopyableBuilder<Builder, DeleteDevEnvironmentResponse> {
        /**
         * <p>
         * The name of the space.
         * </p>
    ...
    static final class BuilderImpl extends CodeCatalystResponse.BuilderImpl implements Builder {
        ...
        private BuilderImpl(DeleteDevEnvironmentResponse model) {
            super(model);
        ...
        @Override
        public DeleteDevEnvironmentResponse build() {
            return new DeleteDevEnvironmentResponse(this);
        }
