...
public final class UpdateDevEnvironmentResponse extends CodeCatalystResponse implements
        ToCopyableBuilder<UpdateDevEnvironmentResponse.Builder, UpdateDevEnvironmentResponse> {
    private static final SdkField<String> ID_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("id")
            .getter(getter(UpdateDevEnvironmentResponse::id)).setter(setter(Builder::id))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("id").build()).build();

    private static final SdkField<String> SPACE_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("spaceName").getter(getter(UpdateDevEnvironmentResponse::spaceName)).setter(setter(Builder::spaceName))
    ...
    private static final SdkField<String> PROJECT_NAME_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("projectName").getter(getter(UpdateDevEnvironmentResponse::projectName))
    ...
    private static final SdkField<String> ALIAS_FIELD = SdkField.<String> builder(MarshallingType.STRING).memberName("alias")
            .getter(getter(UpdateDevEnvironmentResponse::alias)).setter(setter(Builder::alias))
    ...
    private static final SdkField<List<IdeConfiguration>> IDES_FIELD = SdkField
            ...
            .memberName("ides")
            .getter(getter(UpdateDevEnvironmentResponse::ides))
    ...
    private static final SdkField<String> INSTANCE_TYPE_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("instanceType").getter(getter(UpdateDevEnvironmentResponse::instanceTypeAsString))
    ...
    private static final SdkField<Integer> INACTIVITY_TIMEOUT_MINUTES_FIELD = SdkField.<Integer> builder(MarshallingType.INTEGER)
            .memberName("inactivityTimeoutMinutes").getter(getter(UpdateDevEnvironmentResponse::inactivityTimeoutMinutes))
    ...
    private static final SdkField<String> CLIENT_TOKEN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("clientToken").getter(getter(UpdateDevEnvironmentResponse::clientToken))
            .setter(setter(Builder::clientToken))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("clientToken").build()).build();

    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(ID_FIELD, SPACE_NAME_FIELD,
            PROJECT_NAME_FIELD, ALIAS_FIELD, IDES_FIELD, INSTANCE_TYPE_FIELD, INACTIVITY_TIMEOUT_MINUTES_FIELD,
            CLIENT_TOKEN_FIELD));
    ...
    private UpdateDevEnvironmentResponse(BuilderImpl builder) {
        super(builder);
        this.id = builder.id;
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        UpdateDevEnvironmentResponse other = (UpdateDevEnvironmentResponse) obj;
        return Objects.equals(id(), other.id()) && Objects.equals(spaceName(), other.spaceName())
                && Objects.equals(projectName(), other.projectName()) && Objects.equals(alias(), other.alias())
    ...
    public final String toString() {
        return ToString.builder("UpdateDevEnvironmentResponse").add("Id", id()).add("SpaceName", spaceName())
                .add("ProjectName", projectName()).add("Alias", alias()).add("Ides", hasIdes() ? ides() : null)
    ...
    private static <T> Function<Object, T> getter(Function<UpdateDevEnvironmentResponse, T> g) {
        return obj -> g.apply((UpdateDevEnvironmentResponse) obj);
    }
    ...
    public interface Builder extends CodeCatalystResponse.Builder, SdkPojo,
            CopyableBuilder<Builder, UpdateDevEnvironmentResponse> {
        /**
         * <p>
         * The system-generated unique ID of the Dev Environment.
         * </p>
    ...
    static final class BuilderImpl extends CodeCatalystResponse.BuilderImpl implements Builder {
        ...
        private BuilderImpl(UpdateDevEnvironmentResponse model) {
            super(model);
            id(model.id);
        ...
        @Override
        public UpdateDevEnvironmentResponse build() {
            return new UpdateDevEnvironmentResponse(this);
        }
