...
@SdkInternalApi
public final class Optimized2RulesDynamoDbEndpointProvider implements DynamoDbEndpointProvider {
    @Override
    ...
    private static Endpoint endpointRule1(DynamoDbEndpointParams params, String region) {
        if (params.endpoint() != null && region != null) {
            ...
            if (partitionResult != null) {
                ...
                if (params.endpoint().equals("https://dynamodb." + region + "." + partitionResult.dualStackDnsSuffix())) {
    ...
    private static Endpoint endpointRule11(DynamoDbEndpointParams params, String region) {
        ...
        if (partitionResult != null) {
            ...
            if (params.accountIdEndpointMode() != null && !("disabled".equals(params.accountIdEndpointMode()))
                ...
                if (parsedArn != null) {
                    if ("dynamodb".equals(parsedArn.service()) && RulesFunctions.isValidHostLabelSingle(parsedArn.region())
                            && parsedArn.region().equals(region) && RulesFunctions.isValidHostLabelSingle(parsedArn.accountId())) {
                        return Endpoint
                                .builder()
                                .endpointUrl(
            ...
            if (params.accountIdEndpointMode() != null && !("disabled".equals(params.accountIdEndpointMode()))
                ...
                if (firstArn != null) {
                    ...
                    if (parsedArn != null) {
                        if ("dynamodb".equals(parsedArn.service()) && RulesFunctions.isValidHostLabelSingle(parsedArn.region())
                                && parsedArn.region().equals(region)
                                && RulesFunctions.isValidHostLabelSingle(parsedArn.accountId())) {
                            return Endpoint
                                    .builder()
                                    .endpointUrl(
                                            EndpointUrl.fromComponents("https", parsedArn.accountId() + ".ddb." + region + "."
    ...
    private static Endpoint endpointRule37(DynamoDbEndpointParams params, String region, RulePartition partitionResult) {
        if (RulesFunctions.isValidHostLabelSingle(params.accountId())) {
            return Endpoint
                    .builder()
                    .endpointUrl(
