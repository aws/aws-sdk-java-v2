...
@SdkInternalApi
public final class Optimized3BddDynamoDbEndpointProvider implements DynamoDbEndpointProvider {
    @Override
    ...
    private static final class Evaluator {
        ...
        private boolean cond8() {
            return (("https://dynamodb." + region + "." + partitionResult.dualStackDnsSuffix()).equals(params.endpoint()));
        }
        ...
        private boolean cond14() {
            return (parsedArn_ssa_2.region().equals(region));
        }
        ...
        private boolean cond16() {
            return (RulesFunctions.isValidHostLabelSingle(parsedArn_ssa_2.accountId()));
        }

        private boolean cond17() {
            return (RulesFunctions.isValidHostLabelSingle(parsedArn_ssa_2.region()));
        }
        ...
        private boolean cond21() {
            return (parsedArn_ssa_1.region().equals(region));
        }
        ...
        private boolean cond23() {
            return (RulesFunctions.isValidHostLabelSingle(parsedArn_ssa_1.accountId()));
        }

        private boolean cond24() {
            return (RulesFunctions.isValidHostLabelSingle(parsedArn_ssa_1.region()));
        }

        private boolean cond27() {
            return (RulesFunctions.isValidHostLabelSingle(params.accountId()));
        }
        ...
        private Endpoint result8() {
            return Endpoint.of(EndpointUrl.fromComponents("https",
                    "dynamodb-fips." + region + "." + partitionResult.dualStackDnsSuffix(), -1, ""));
        }
        ...
        private Endpoint result10() {
            return Endpoint.of(EndpointUrl.fromComponents("https", "dynamodb." + region + "." + partitionResult.dnsSuffix(), -1,
                    ""));
        }

        private Endpoint result11() {
            return Endpoint.of(EndpointUrl.fromComponents("https", "dynamodb-fips." + region + "." + partitionResult.dnsSuffix(),
                    -1, ""));
        }
        ...
        private Endpoint result19() {
            return Endpoint.of(EndpointUrl.fromComponents("https",
                    "dynamodb." + region + "." + partitionResult.dualStackDnsSuffix(), -1, ""));
        }
