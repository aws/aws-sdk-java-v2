...
@SdkInternalApi
public final class BaselineRulesResolver implements ConnectEndpointProvider {
    @Override
    ...
    private static RuleResult endpointRule5(ConnectEndpointParams params, String region) {
        if (region != null) {
    ...
    private static RuleResult endpointRule6(ConnectEndpointParams params, String region) {
    ...
    private static RuleResult endpointRule7(ConnectEndpointParams params, RulePartition partitionResult, String region) {
    ...
    private static RuleResult endpointRule8(ConnectEndpointParams params, RulePartition partitionResult, String region) {
    ...
    private static RuleResult endpointRule11(ConnectEndpointParams params, RulePartition partitionResult, String region) {
        if (params.useFips()) {
    ...
    private static RuleResult endpointRule12(ConnectEndpointParams params, RulePartition partitionResult, String region) {
        if (partitionResult.supportsFIPS()) {
            if ("aws-us-gov".equals(partitionResult.name())) {
                return RuleResult.endpoint(Endpoint.builder().url(URI.create("https://connect." + region + ".amazonaws.com"))
                                                   .build());
            }
            return RuleResult.endpoint(Endpoint.builder()
