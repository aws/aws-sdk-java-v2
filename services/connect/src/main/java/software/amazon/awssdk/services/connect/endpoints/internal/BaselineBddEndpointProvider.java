...
@SdkInternalApi
public final class BaselineBddEndpointProvider implements ConnectEndpointProvider {
    private static final int[] BDD_DEFINITION;

    static {
        try (InputStream in = DefaultConnectEndpointProvider.class.getResourceAsStream("/endpoints_bdd_90e0cfe8.bin")) {
            if (in == null) {
                throw new IllegalStateException("Resource /endpoints_bdd_90e0cfe8.bin not found");
            }
