...
@SdkInternalApi
public final class BaselineRulesEndpointResolver implements ConnectEndpointProvider {
    @Override
            ...
            if ("aws-us-gov".equals(partitionResult.name())) {
                return RuleResult
                    .endpoint(Endpoint.builder()
                                      .endpointUrl(EndpointUrl.fromComponents("https", "connect." + region + ".amazonaws.com", -1, ""))
                                      .build());
            }
            return RuleResult.endpoint(Endpoint
                                           .builder()
