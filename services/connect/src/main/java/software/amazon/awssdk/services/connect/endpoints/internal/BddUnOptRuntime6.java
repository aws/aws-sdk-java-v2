...
@SdkInternalApi
public final class BddUnOptRuntime6 implements ConnectEndpointProvider {
    private static final int[] BDD_DEFINITION;

    static {
        try (InputStream in = DefaultConnectEndpointProvider.class.getResourceAsStream("/endpoints_bdd_36637f94.bin")) {
            if (in == null) {
                throw new IllegalStateException("Resource /endpoints_bdd_36637f94.bin not found");
            }
            BDD_DEFINITION = new int[45];
