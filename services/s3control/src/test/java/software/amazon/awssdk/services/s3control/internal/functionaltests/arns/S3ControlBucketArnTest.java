...
public class S3ControlBucketArnTest extends S3ControlWireMockTestBase {
    private S3ControlClient s3Control;

    private static final String EXPECTED_URL = "/v20180820/bucket/mybucket";
    private static final String EXPECTED_HOST = "123456789012.s3-control.%s.amazonaws.com";
    ...
    public void malformedArn_missingBucketName_shouldThrowException() {
        ...
        String bucketArn = "arn:aws:s3:us-west-2:123456789012:bucket";
    ...
    public void bucketArnInvalidPartition_throwsIllegalArgumentException() {
        S3ControlClient s3ControlForTest = initializedBuilder().region(Region.US_WEST_2)
                                                               .serviceConfiguration(b -> b.useArnRegionEnabled(true))
                                                               .build();
        String bucketArn = "arn:aws-cn:s3:cn-north-1:123456789012:bucket:mybucket";
    ...
    public void bucketArnDifferentRegionNoConfigFlag_throwsIllegalArgumentException() {
        S3ControlClient s3ControlForTest = initializedBuilder().region(Region.US_WEST_2).build();
        String bucketArn = "arn:aws:s3:us-east-1:123456789012:bucket:mybucket";
    ...
    public void bucketArnWithCustomEndpoint_throwsIllegalArgumentException() {
        ...
        String bucketArn = "arn:aws:s3:us-west-2:123456789012:bucket:mybucket";
    ...
    @Test
    public void bucketArn_accountIdPresent_shouldThrowException() {
        S3ControlClient s3ControlForTest = initializedBuilder().region(Region.US_WEST_2).build();
        String bucketArn = "arn:aws:s3:us-west-2:123456789012:bucket:mybucket";
    ...
    @Test
    public void bucketArn_fipsEnabled() {
        S3ControlClient s3ControlForTest = buildClientCustom().region(Region.of("us-gov-east-1"))
                                                              .serviceConfiguration(b -> b.fipsModeEnabled(true))
                                                              .build();

        String bucketArn = "arn:aws-us-gov:s3:us-gov-east-1:123456789012:bucket:mybucket";

        stubResponse();
        s3ControlForTest.getBucket(b -> b.bucket(bucketArn));
        verifyS3ControlRequest("us-gov-east-1", "123456789012.s3-control.fips-us-gov-east-1.amazonaws.com");
    }

    @Test
    public void bucketArnFipsRegionProvided_fipsEnabled() {
    ...
    @Test
    public void bucketArn_dualstackEnabled() {
        S3ControlClient s3ControlForTest = buildClientCustom().region(Region.US_WEST_2)
                                                              .serviceConfiguration(b -> b.dualstackEnabled(true))
                                                              .build();
        ...
        stubResponse();
        s3ControlForTest.getBucket(b -> b.bucket(bucketArn));
        verifyS3ControlRequest("us-west-2", "123456789012.s3-control.dualstack.us-west-2.amazonaws.com");
    }
    ...
    @Test
    public void bucketArn_listAccessPoints() {
        S3ControlClient s3ControlForTest = initializedBuilder().region(Region.US_WEST_2).build();
    ...
    @Test
    public void bucketArn_createAccessPoint() {
        S3ControlClient s3ControlForTest = initializedBuilder().region(Region.US_WEST_2).build();
    ...
    public void bucketArn_futureRegion_US() {
        ...
        String bucketArn = "arn:aws:s3:us-future-1:123456789012:bucket:mybucket";
    ...
    public void bucketArn_futureRegion_CN() {
        ...
        String bucketArn = "arn:aws-cn:s3:cn-future-1:123456789012:bucket:mybucket";
        stubResponse();

        s3ControlForTest.getBucket(b -> b.bucket(bucketArn));
        verifyS3ControlRequest("cn-future-1", "123456789012.s3-control.cn-future-1.amazonaws.com.cn");
    }
    ...
    public void bucketArnDifferentRegion_useArnRegionSet_shouldUseRegionFromArn() {
        ...
        S3ControlClient s3WithUseArnRegion = initializedBuilder().region(Region.US_WEST_2).serviceConfiguration(b -> b.useArnRegionEnabled(true)).build();

        s3WithUseArnRegion.getBucket(b -> b.bucket(bucketArn));

        verifyRequest("us-east-1");
    }

    @Test
    public void fipsRegionInClient_bucketArnDifferentRegionUseArnRegionSet_shouldUseRegionFromArn() {
        String bucketArn = "arn:aws-us-gov:s3:us-gov-east-1:123456789012:bucket:mybucket";
        stubResponse();

        S3ControlClient s3WithUseArnRegion = initializedBuilder().region(Region.of("fips-us-gov-east-1")).serviceConfiguration(b -> b.useArnRegionEnabled(true)).build();
    ...
    private void verifyRequest( String region) {
        verifyS3ControlRequest(region, String.format(EXPECTED_HOST, region));
    }
