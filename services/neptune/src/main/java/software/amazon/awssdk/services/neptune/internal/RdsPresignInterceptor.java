...
import software.amazon.awssdk.services.neptune.endpoints.NeptuneEndpointParams;
...
public abstract class RdsPresignInterceptor<T extends NeptuneRequest> implements ExecutionInterceptor {
    ...
    private URI createEndpoint(String regionName, String serviceName, ExecutionAttributes attributes) {
        NeptuneEndpointProvider provider = NeptuneEndpointProvider.defaultProvider();
        NeptuneEndpointParams params = NeptuneEndpointParams.builder()
