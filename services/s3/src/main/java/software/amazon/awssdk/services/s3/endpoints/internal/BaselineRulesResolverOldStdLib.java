...
@SdkInternalApi
public final class BaselineRulesResolverOldStdLib implements S3EndpointProvider {
    ...
    private static RuleResult endpointRule1(S3EndpointParams params, String region) {
        if (region != null) {
            ...
            if (params.useFips()) {
                RulePartition partitionResult = RulesFunctionsBaseline.awsPartition(region);
    ...
    private static RuleResult endpointRule7(S3EndpointParams params, String region) {
        if (params.bucket() != null) {
            String bucketSuffix = RulesFunctionsBaseline.substring(params.bucket(), 0, 6, true);
    ...
    private static RuleResult endpointRule9(S3EndpointParams params, String region) {
        if (params.endpoint() != null) {
            RuleUrl url = RulesFunctionsBaseline.parseURL(params.endpoint());
            if (url != null) {
    ...
    private static RuleResult endpointRule12(S3EndpointParams params, RuleUrl url, String region) {
        String uriEncodedBucket = RulesFunctionsBaseline.uriEncode(params.bucket());
        if (uriEncodedBucket != null) {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create(url.scheme() + "://" + url.authority() + "/" + uriEncodedBucket + url.path()))
    ...
    private static RuleResult endpointRule14(S3EndpointParams params, RuleUrl url, String region) {
        if (RulesFunctionsBaseline.awsIsVirtualHostableS3Bucket(params.bucket(), false)) {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create(url.scheme() + "://" + params.bucket() + "." + url.authority() + url.path()))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3express")
    ...
    private static RuleResult endpointRule33(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 6, 14, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 14, 16, true);
    ...
    private static RuleResult endpointRule38(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 6, 15, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 15, 17, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule43(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 6, 19, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 19, 21, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule48(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 6, 20, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 20, 22, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule53(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 6, 26, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 26, 28, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule86(S3EndpointParams params, String region) {
        if (params.bucket() != null) {
            String accessPointSuffix = RulesFunctionsBaseline.substring(params.bucket(), 0, 7, true);
    ...
    private static RuleResult endpointRule105(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 7, 15, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 15, 17, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
    ...
    private static RuleResult endpointRule110(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 7, 16, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 16, 18, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule115(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 7, 20, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 20, 22, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
    ...
    private static RuleResult endpointRule120(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 7, 21, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 21, 23, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule125(S3EndpointParams params, String region, RulePartition partitionResult) {
        String s3ExpressAvailabilityZoneId = RulesFunctionsBaseline.substring(params.bucket(), 7, 27, true);
        if (s3ExpressAvailabilityZoneId != null) {
            String s3ExpressAvailabilityZoneDelim = RulesFunctionsBaseline.substring(params.bucket(), 27, 29, true);
            if (s3ExpressAvailabilityZoneDelim != null) {
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule165(S3EndpointParams params, String region) {
        if (params.bucket() != null) {
            String hardwareType = RulesFunctionsBaseline.substring(params.bucket(), 49, 50, true);
            if (hardwareType != null) {
                String regionPrefix = RulesFunctionsBaseline.substring(params.bucket(), 8, 12, true);
                if (regionPrefix != null) {
                    String bucketAliasSuffix = RulesFunctionsBaseline.substring(params.bucket(), 0, 7, true);
                    if (bucketAliasSuffix != null) {
                        String outpostId = RulesFunctionsBaseline.substring(params.bucket(), 32, 49, true);
                        if (outpostId != null) {
                            RulePartition regionPartition = RulesFunctionsBaseline.awsPartition(region);
    ...
    private static RuleResult endpointRule166(S3EndpointParams params, String outpostId, String hardwareType,
        ...
        if (RulesFunctionsBaseline.isValidHostLabel(outpostId, false)) {
    ...
    private static RuleResult endpointRule167(S3EndpointParams params, String hardwareType, String regionPrefix, String region,
        ...
        if ("e".equals(hardwareType)) {
            ...
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".ec2.s3-outposts." + region + "."
        ...
        if ("beta".equals(regionPrefix)) {
            ...
            if (params.endpoint() != null) {
                ...
                if (url != null) {
                    return RuleResult.endpoint(Endpoint
                                                   .builder()
                                                   .url(URI.create("https://" + params.bucket() + ".ec2." + url.authority()))
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                                                       Arrays.asList(
    ...
    private static RuleResult endpointRule172(S3EndpointParams params, String hardwareType, String regionPrefix,
        ...
        if ("o".equals(hardwareType)) {
            ...
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".op-" + outpostId + ".s3-outposts." + region + "."
                                                           + regionPartition.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4aAuthScheme.builder().disableDoubleEncoding(true).signingName("s3-outposts")
        ...
        if ("beta".equals(regionPrefix)) {
            ...
            if (params.endpoint() != null) {
                ...
                if (url != null) {
                    return RuleResult.endpoint(Endpoint
                                                   .builder()
                                                   .url(URI.create("https://" + params.bucket() + ".op-" + outpostId + "." + url.authority()))
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                                                       Arrays.asList(
                                                           SigV4aAuthScheme.builder().disableDoubleEncoding(true).signingName("s3-outposts")
    ...
    private static RuleResult endpointRule179(S3EndpointParams params, String region) {
        if (params.bucket() != null) {
            if (params.endpoint() != null && RulesFunctionsBaseline.parseURL(params.endpoint()) == null) {
            ...
            String arnPrefix = RulesFunctionsBaseline.substring(params.bucket(), 0, 4, false);
            if (arnPrefix != null) {
                if ("arn:".equals(arnPrefix) && RulesFunctionsBaseline.awsParseArn(params.bucket()) == null) {
                    return RuleResult.error("Invalid ARN: `" + params.bucket() + "` was not a valid ARN");
                }
            }
            if (params.forcePathStyle() && RulesFunctionsBaseline.awsParseArn(params.bucket()) != null) {
    ...
    private static RuleResult endpointRule181(S3EndpointParams params, String region) {
        if (!params.forcePathStyle() && RulesFunctionsBaseline.awsIsVirtualHostableS3Bucket(params.bucket(), false)) {
    ...
    private static RuleResult endpointRule183(S3EndpointParams params, String region, RulePartition partitionResult) {
        if (RulesFunctionsBaseline.isValidHostLabel(region, false)) {
            ...
            if (params.useDualStack() && params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3-fips.dualstack." + region + "."
                                                               + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
            ...
            if (!params.useDualStack() && params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3-fips.us-east-1." + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion("us-east-1").build())).build());
            ...
            if (!params.useDualStack() && params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3-fips." + region + "." + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion(region).build())).build());
            ...
            if (params.useDualStack() && !params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3.dualstack.us-east-1." + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion("us-east-1").build())).build());
            ...
            if (params.useDualStack() && !params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3.dualstack." + region + "."
                                                               + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
            ...
            if (!params.useDualStack() && !params.useFips() && !params.accelerate() && params.endpoint() != null) {
                ...
                if (url != null) {
                    if (url.isIp() && "aws-global".equals(region)) {
                        return RuleResult.endpoint(Endpoint
                                                       .builder()
                                                       .url(URI.create(url.scheme() + "://" + url.authority() + url.normalizedPath() + params.bucket()))
                                                       .putAttribute(
                                                           AwsEndpointAttribute.AUTH_SCHEMES,
                                                           Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                        .signingRegion("us-east-1").build())).build());
            ...
            if (!params.useDualStack() && !params.useFips() && params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3-accelerate." + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion("us-east-1").build())).build());
            ...
            if (!params.useDualStack() && !params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3." + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion("us-east-1").build())).build());
            ...
            if (!params.useDualStack() && !params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + params.bucket() + ".s3." + region + "." + partitionResult.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion(region).build())).build());
    ...
    private static RuleResult endpointRule194(S3EndpointParams params, String region, RulePartition partitionResult) {
        if (params.useDualStack() && !params.useFips() && params.accelerate() && params.endpoint() == null
            ...
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".s3-accelerate.dualstack." + partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                            .signingRegion(region).build())).build());
    ...
    private static RuleResult endpointRule222(S3EndpointParams params, String region) {
        if (params.endpoint() != null) {
            RuleUrl url = RulesFunctionsBaseline.parseURL(params.endpoint());
            if (url != null) {
                if ("http".equals(url.scheme()) && RulesFunctionsBaseline.awsIsVirtualHostableS3Bucket(params.bucket(), true)
    ...
    private static RuleResult endpointRule227(S3EndpointParams params, String region) {
        if (!params.forcePathStyle()) {
            RuleArn bucketArn = RulesFunctionsBaseline.awsParseArn(params.bucket());
            if (bucketArn != null) {
    ...
    private static RuleResult endpointRule228(S3EndpointParams params, RuleArn bucketArn, String region) {
        String arnType = RulesFunctionsBaseline.listAccess(bucketArn.resourceId(), 0);
        if (arnType != null) {
            if (!("".equals(arnType))) {
    ...
    private static RuleResult endpointRule231(S3EndpointParams params, RuleArn bucketArn, String region) {
        String accessPointName = RulesFunctionsBaseline.listAccess(bucketArn.resourceId(), 1);
    ...
    private static RuleResult endpointRule236(S3EndpointParams params, RuleArn bucketArn, String region, String accessPointName) {
        if (RulesFunctionsBaseline.listAccess(bucketArn.resourceId(), 2) == null) {
            if (params.useArnRegion() != null && !params.useArnRegion()
                && !(RulesFunctionsBaseline.stringEquals(bucketArn.region(), region))) {
    ...
    private static RuleResult endpointRule238(S3EndpointParams params, RuleArn bucketArn, String region, String accessPointName) {
        RulePartition bucketPartition = RulesFunctionsBaseline.awsPartition(bucketArn.region());
    ...
    private static RuleResult endpointRule240(S3EndpointParams params, RulePartition bucketPartition,
        ...
        if (RulesFunctionsBaseline.stringEquals(bucketPartition.name(), partitionResult.name())) {
    ...
    private static RuleResult endpointRule241(S3EndpointParams params, RuleArn bucketArn, String accessPointName,
        ...
        if (RulesFunctionsBaseline.isValidHostLabel(bucketArn.region(), true)) {
    ...
    private static RuleResult endpointRule243(S3EndpointParams params, RuleArn bucketArn, String accessPointName,
                                              RulePartition bucketPartition) {
        if (RulesFunctionsBaseline.isValidHostLabel(bucketArn.accountId(), false)) {
    ...
    private static RuleResult endpointRule244(S3EndpointParams params, String accessPointName, RuleArn bucketArn,
                                              RulePartition bucketPartition) {
        if (RulesFunctionsBaseline.isValidHostLabel(accessPointName, false)) {
            if (params.endpoint() != null) {
                RuleUrl url = RulesFunctionsBaseline.parseURL(params.endpoint());
                if (url != null) {
                    return RuleResult.endpoint(Endpoint
                                                   .builder()
                                                   .url(URI.create(url.scheme() + "://" + accessPointName + "-" + bucketArn.accountId() + "."
            ...
            if (params.useFips()) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + accessPointName + "-" + bucketArn.accountId() + ".s3-object-lambda-fips."
            ...
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + accessPointName + "-" + bucketArn.accountId() + ".s3-object-lambda."
                                                           + bucketArn.region() + "." + bucketPartition.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
    ...
    private static RuleResult endpointRule270(S3EndpointParams params, String accessPointName, RuleArn bucketArn,
        ...
        if (RulesFunctionsBaseline.isValidHostLabel(accessPointName, false)) {
            ...
            if (params.useFips() && params.useDualStack()) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + accessPointName + "-" + bucketArn.accountId()
            ...
            if (params.useFips() && !params.useDualStack()) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + accessPointName + "-" + bucketArn.accountId() + ".s3-accesspoint-fips."
                                                               + bucketArn.region() + "." + bucketPartition.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
            ...
            if (!params.useFips() && params.useDualStack()) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + accessPointName + "-" + bucketArn.accountId() + ".s3-accesspoint.dualstack."
                                                               + bucketArn.region() + "." + bucketPartition.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
            ...
            if (!params.useFips() && !params.useDualStack()) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://" + accessPointName + "-" + bucketArn.accountId() + ".s3-accesspoint."
                                                               + bucketArn.region() + "." + bucketPartition.dnsSuffix()))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
    ...
    private static RuleResult endpointRule283(S3EndpointParams params, String accessPointName, String region, RuleArn bucketArn) {
        if (RulesFunctionsBaseline.isValidHostLabel(accessPointName, true)) {
            if (params.useDualStack()) {
    ...
    private static RuleResult endpointRule288(S3EndpointParams params, String region, RuleArn bucketArn, String accessPointName) {
        RulePartition mrapPartition = RulesFunctionsBaseline.awsPartition(region);
    ...
    private static RuleResult endpointRule289(S3EndpointParams params, RulePartition mrapPartition, RuleArn bucketArn,
                                              String accessPointName) {
        if (RulesFunctionsBaseline.stringEquals(mrapPartition.name(), bucketArn.partition())) {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + accessPointName + ".accesspoint.s3-global." + mrapPartition.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
    ...
    private static RuleResult endpointRule294(S3EndpointParams params, RuleArn bucketArn, String region) {
        if ("s3-outposts".equals(bucketArn.service())) {
            ...
            if (RulesFunctionsBaseline.listAccess(bucketArn.resourceId(), 4) != null) {
    ...
    private static RuleResult endpointRule299(S3EndpointParams params, RuleArn bucketArn, String region) {
        String outpostId = RulesFunctionsBaseline.listAccess(bucketArn.resourceId(), 1);
        if (outpostId != null) {
    ...
    private static RuleResult endpointRule307(S3EndpointParams params, RuleArn bucketArn, String outpostId,
                                              RulePartition bucketPartition) {
        String outpostType = RulesFunctionsBaseline.listAccess(bucketArn.resourceId(), 2);
        if (outpostType != null) {
    ...
    private static RuleResult endpointRule308(S3EndpointParams params, RuleArn bucketArn, String outpostType, String outpostId,
                                              RulePartition bucketPartition) {
        String accessPointName = RulesFunctionsBaseline.listAccess(bucketArn.resourceId(), 3);
        if (accessPointName != null) {
        ...
        if ("accesspoint".equals(outpostType)) {
            if (params.endpoint() != null) {
                ...
                if (url != null) {
                    return RuleResult.endpoint(Endpoint
                                                   .builder()
                                                   .url(URI.create("https://" + accessPointName + "-" + bucketArn.accountId() + "." + outpostId + "."
                                                                   + url.authority()))
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                                                       Arrays.asList(
    ...
    private static RuleResult endpointRule326(S3EndpointParams params, String region, RulePartition partitionResult,
        ...
        if (!params.accelerate()) {
            ...
            if (!params.useDualStack() && params.endpoint() == null && params.useFips() && "aws-global".equals(region)) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://s3-fips.us-east-1." + partitionResult.dnsSuffix() + "/" + uriEncodedBucket))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion("us-east-1").build())).build());
                ...
                if (url != null) {
                    if (!params.useFips() && "aws-global".equals(region)) {
                        return RuleResult
                            .endpoint(Endpoint
                                          .builder()
                                          .url(URI.create(url.scheme() + "://" + url.authority() + url.normalizedPath()
                                                          + uriEncodedBucket))
                                          .putAttribute(
                                              AwsEndpointAttribute.AUTH_SCHEMES,
                                              Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true)
            ...
            if (!params.useDualStack() && params.endpoint() == null && !params.useFips() && "aws-global".equals(region)) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://s3." + partitionResult.dnsSuffix() + "/" + uriEncodedBucket))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion("us-east-1").build())).build());
            ...
            if (!params.useDualStack() && params.endpoint() == null && !params.useFips() && !("aws-global".equals(region))
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .url(URI.create("https://s3." + region + "." + partitionResult.dnsSuffix() + "/" + uriEncodedBucket))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                .signingRegion(region).build())).build());
    ...
    private static RuleResult endpointRule332(S3EndpointParams params, String region, RulePartition partitionResult,
        ...
        if (!params.useDualStack() && params.endpoint() == null && params.useFips() && !("aws-global".equals(region))
            ...
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://s3-fips." + region + "." + partitionResult.dnsSuffix() + "/" + uriEncodedBucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                            .signingRegion(region).build())).build());
        ...
        if (!params.useDualStack() && params.endpoint() != null) {
            ...
            if (url != null) {
                if (!params.useFips() && !("aws-global".equals(region)) && params.useGlobalEndpoint()) {
                    ...
                    return RuleResult.endpoint(Endpoint
                                                   .builder()
                                                   .url(URI.create(url.scheme() + "://" + url.authority() + url.normalizedPath() + uriEncodedBucket))
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                                                       Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                                    .signingRegion(region).build())).build());
    ...
    private static RuleResult endpointRule352(S3EndpointParams params, String region, RulePartition partitionResult) {
        if (RulesFunctionsBaseline.isValidHostLabel(region, true)) {
            if (params.useDualStack()) {
                return RuleResult.error("S3 Object Lambda does not support Dual-stack");
            }
            if (params.accelerate()) {
