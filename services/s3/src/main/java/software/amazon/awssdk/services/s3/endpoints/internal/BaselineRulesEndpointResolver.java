...
@SdkInternalApi
public final class BaselineRulesEndpointResolver implements S3EndpointProvider {
    @Override
            ...
            if (params.endpoint() == null) {
                ...
                if (params.useFips() && !params.useDualStack()) {
                    return RuleResult.endpoint(Endpoint
                                                   .builder()
                                                   .endpointUrl(
                                                       EndpointUrl.fromComponents("https", "s3express-control-fips." + region + "."
                                                                                           + partitionResult.dnsSuffix(), -1, "/" + uriEncodedBucket))
                                                   .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                ...
                if (!params.useFips() && params.useDualStack()) {
                    return RuleResult.endpoint(Endpoint
                                                   .builder()
                                                   .endpointUrl(
                                                       EndpointUrl.fromComponents("https", "s3express-control.dualstack." + region + "."
                                                                                           + partitionResult.dnsSuffix(), -1, "/" + uriEncodedBucket))
                                                   .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                    ...
                    return RuleResult.endpoint(Endpoint
                                                   ...
                                                   .endpointUrl(
                                                       EndpointUrl.fromComponents("https",
                                                                                  "s3express-control." + region + "." + partitionResult.dnsSuffix(), -1, "/"
                                                                                                                                                         + uriEncodedBucket))
                                                   .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                ...
                if ("--".equals(s3ExpressAvailabilityZoneDelim)) {
                    if (params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
                                                       ...
                                                       .endpointUrl(
                                                           EndpointUrl.fromComponents("https",
                                                                                      params.bucket() + ".s3express-fips-" + s3ExpressAvailabilityZoneId
                    ...
                    if (!params.useFips() && params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
                                                       ...
                                                       .endpointUrl(
                                                           EndpointUrl.fromComponents("https",
                                                                                      params.bucket() + ".s3express-" + s3ExpressAvailabilityZoneId + ".dualstack."
                    ...
                    if (!params.useFips() && !params.useDualStack()) {
                        return RuleResult.endpoint(Endpoint
                                                       .builder()
                                                       .endpointUrl(
                                                           EndpointUrl.fromComponents("https", params.bucket() + ".s3express-"
                                                                                               + s3ExpressAvailabilityZoneId + "." + region + "." + partitionResult.dnsSuffix(),
                                                                                      -1, ""))
                                                       .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                                       .putAttribute(
    ...
    private static RuleResult endpointRule166(S3EndpointParams params, String outpostId, String hardwareType,
        ...
        if (RulesFunctions.isValidHostLabel(outpostId, false)) {
            RuleResult result = endpointRule167(params, hardwareType, regionPrefix, region, regionPartition, outpostId);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule167(S3EndpointParams params, String hardwareType, String regionPrefix, String region,
        ...
        if (RulesFunctions.awsIsVirtualHostableS3Bucket(params.bucket(), false)) {
            RuleResult result = endpointRule168(params, hardwareType, regionPrefix, region, regionPartition);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule168(S3EndpointParams params, String hardwareType, String regionPrefix, String region,
                                              RulePartition regionPartition) {
        if ("e".equals(hardwareType)) {
            RuleResult result = endpointRule169(params, regionPrefix, region);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule173(S3EndpointParams params, String hardwareType, String regionPrefix,
                                              String outpostId, String region, RulePartition regionPartition) {
        if ("o".equals(hardwareType)) {
            RuleResult result = endpointRule174(params, regionPrefix, outpostId, region);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.endpoint(Endpoint
            ...
            if (params.endpoint() != null) {
                ...
                if (url != null) {
                    return RuleResult.endpoint(Endpoint
                                                   ...
                                                   .endpointUrl(
                                                       EndpointUrl.fromComponents("https",
                                                                                  params.bucket() + ".op-" + outpostId + "." + url.authority(), -1, ""))
                                                   .putAttribute(
                                                       AwsEndpointAttribute.AUTH_SCHEMES,
                                                       Arrays.asList(
    ...
    private static RuleResult endpointRule181(S3EndpointParams params, String region) {
        if (params.bucket() != null) {
            ...
            RuleResult result = endpointRule183(params, region);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule184(S3EndpointParams params, String region) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule185(params, region, partitionResult);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule185(S3EndpointParams params, String region, RulePartition partitionResult) {
        if (RulesFunctions.isValidHostLabel(region, false)) {
            ...
            RuleResult result = endpointRule188(params, region, partitionResult);
            if (result.isResolved()) {
                return result;
            }
            if (params.useDualStack() && params.useFips() && !params.accelerate() && params.endpoint() == null
            ...
            if (!params.useDualStack() && params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .endpointUrl(
                                                   EndpointUrl.fromComponents("https", params.bucket() + ".s3-fips." + region + "."
                                                                                       + partitionResult.dnsSuffix(), -1, ""))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
            ...
            if (params.useDualStack() && !params.useFips() && params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .endpointUrl(
                                                   EndpointUrl.fromComponents("https", params.bucket() + ".s3-accelerate.dualstack."
                                                                                       + partitionResult.dnsSuffix(), -1, ""))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
            ...
            if (params.useDualStack() && !params.useFips() && !params.accelerate() && params.endpoint() == null
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .endpointUrl(
                                                   EndpointUrl.fromComponents("https", params.bucket() + ".s3.dualstack.us-east-1."
                                                                                       + partitionResult.dnsSuffix(), -1, ""))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
    ...
    private static RuleResult endpointRule225(S3EndpointParams params, String region, RuleUrl url) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule226(params, region, url);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid region: region was not a valid DNS name.");
    ...
    private static RuleResult endpointRule229(S3EndpointParams params, String region) {
        if (!params.forcePathStyle()) {
            ...
            if (bucketArn != null) {
                RuleResult result = endpointRule230(params, bucketArn, region);
                if (result.isResolved()) {
                    return result;
                }
    ...
    private static RuleResult endpointRule230(S3EndpointParams params, RuleArn bucketArn, String region) {
        ...
        if (arnType != null) {
            if (!("".equals(arnType))) {
                RuleResult result = endpointRule231(params, bucketArn, arnType, region);
                if (result.isResolved()) {
                    return result;
                }
    ...
    private static RuleResult endpointRule231(S3EndpointParams params, RuleArn bucketArn, String arnType, String region) {
        if ("s3-object-lambda".equals(bucketArn.service())) {
            RuleResult result = endpointRule232(params, arnType, bucketArn, region);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule232(S3EndpointParams params, String arnType, RuleArn bucketArn, String region) {
        if ("accesspoint".equals(arnType)) {
            RuleResult result = endpointRule233(params, bucketArn, region);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult
    ...
    private static RuleResult endpointRule236(S3EndpointParams params, RuleArn bucketArn, String region, String accessPointName) {
        if (!("".equals(bucketArn.region()))) {
            ...
            RuleResult result = endpointRule238(params, bucketArn, region, accessPointName);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule241(S3EndpointParams params, String region, RulePartition bucketPartition,
                                              RuleArn bucketArn, String accessPointName) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule242(params, bucketPartition, partitionResult, bucketArn, accessPointName);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule242(S3EndpointParams params, RulePartition bucketPartition,
    ...
    private static RuleResult endpointRule243(S3EndpointParams params, RuleArn bucketArn, String accessPointName,
        ...
        if (RulesFunctions.isValidHostLabel(bucketArn.region(), true)) {
            ...
            RuleResult result = endpointRule245(params, bucketArn, accessPointName, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule245(S3EndpointParams params, RuleArn bucketArn, String accessPointName,
                                              RulePartition bucketPartition) {
        if (RulesFunctions.isValidHostLabel(bucketArn.accountId(), false)) {
            RuleResult result = endpointRule246(params, accessPointName, bucketArn, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule246(S3EndpointParams params, String accessPointName, RuleArn bucketArn,
                                              RulePartition bucketPartition) {
    ...
    private static RuleResult endpointRule258(S3EndpointParams params, String arnType, RuleArn bucketArn, String region) {
        if ("accesspoint".equals(arnType)) {
            RuleResult result = endpointRule259(params, bucketArn, arnType, region);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult
    ...
    private static RuleResult endpointRule259(S3EndpointParams params, RuleArn bucketArn, String arnType, String region) {
        ...
        if (accessPointName != null) {
            if (!("".equals(accessPointName))) {
                RuleResult result = endpointRule260(params, bucketArn, arnType, region, accessPointName);
                if (result.isResolved()) {
                    return result;
                }
    ...
    private static RuleResult endpointRule260(S3EndpointParams params, RuleArn bucketArn, String arnType, String region,
    ...
    private static RuleResult endpointRule261(S3EndpointParams params, String arnType, RuleArn bucketArn, String region,
                                              String accessPointName) {
        if ("accesspoint".equals(arnType)) {
    ...
    private static RuleResult endpointRule262(S3EndpointParams params, RuleArn bucketArn, String region, String accessPointName) {
        if (!("".equals(bucketArn.region()))) {
            ...
            RuleResult result = endpointRule264(params, bucketArn, region, accessPointName);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid ARN: The ARN may only contain a single resource component after `accesspoint`.");
    ...
    private static RuleResult endpointRule267(S3EndpointParams params, String region, RulePartition bucketPartition,
                                              RuleArn bucketArn, String accessPointName) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule268(params, bucketPartition, partitionResult, bucketArn, accessPointName);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Client was configured for partition `" + partitionResult.name() + "` but ARN (`"
    ...
    private static RuleResult endpointRule268(S3EndpointParams params, RulePartition bucketPartition,
                                              RulePartition partitionResult, RuleArn bucketArn, String accessPointName) {
        if (RulesFunctions.stringEquals(bucketPartition.name(), partitionResult.name())) {
    ...
    private static RuleResult endpointRule269(S3EndpointParams params, RuleArn bucketArn, String accessPointName,
                                              RulePartition bucketPartition) {
        if (RulesFunctions.isValidHostLabel(bucketArn.region(), true)) {
            RuleResult result = endpointRule270(params, bucketArn, accessPointName, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule270(S3EndpointParams params, RuleArn bucketArn, String accessPointName,
                                              RulePartition bucketPartition) {
        if ("s3".equals(bucketArn.service())) {
            RuleResult result = endpointRule271(params, bucketArn, accessPointName, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid ARN: The account id may only contain a-z, A-Z, 0-9 and `-`. Found: `"
    ...
    private static RuleResult endpointRule271(S3EndpointParams params, RuleArn bucketArn, String accessPointName,
                                              RulePartition bucketPartition) {
        if (RulesFunctions.isValidHostLabel(bucketArn.accountId(), false)) {
            RuleResult result = endpointRule272(params, accessPointName, bucketArn, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid ARN: The access point name may only contain a-z, A-Z, 0-9 and `-`. Found: `"
    ...
    private static RuleResult endpointRule272(S3EndpointParams params, String accessPointName, RuleArn bucketArn,
                                              RulePartition bucketPartition) {
        if (RulesFunctions.isValidHostLabel(accessPointName, false)) {
            if (params.accelerate()) {
            ...
            if (params.useFips() && params.useDualStack()) {
                return RuleResult.endpoint(Endpoint
                                               ...
                                               .endpointUrl(
                                                   EndpointUrl.fromComponents("https",
                                                                              accessPointName + "-" + bucketArn.accountId() + ".s3-accesspoint-fips.dualstack."
    ...
    private static RuleResult endpointRule290(S3EndpointParams params, String region, RuleArn bucketArn, String accessPointName) {
        ...
        if (mrapPartition != null) {
            RuleResult result = endpointRule291(params, mrapPartition, bucketArn, accessPointName);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule291(S3EndpointParams params, RulePartition mrapPartition, RuleArn bucketArn,
                                              String accessPointName) {
        if (RulesFunctions.stringEquals(mrapPartition.name(), bucketArn.partition())) {
            return RuleResult.endpoint(Endpoint
                                           ...
                                           .endpointUrl(
                                               EndpointUrl.fromComponents("https",
                                                                          accessPointName + ".accesspoint.s3-global." + mrapPartition.dnsSuffix(), -1, ""))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
    ...
    private static RuleResult endpointRule296(S3EndpointParams params, RuleArn bucketArn, String region) {
        if ("s3-outposts".equals(bucketArn.service())) {
            ...
            RuleResult result = endpointRule301(params, bucketArn, region);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule301(S3EndpointParams params, RuleArn bucketArn, String region) {
        ...
        if (outpostId != null) {
            RuleResult result = endpointRule302(params, outpostId, bucketArn, region);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule305(S3EndpointParams params, String region, RulePartition bucketPartition,
                                              RuleArn bucketArn, String outpostId) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule306(params, bucketPartition, partitionResult, bucketArn, outpostId);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Client was configured for partition `" + partitionResult.name() + "` but ARN (`"
    ...
    private static RuleResult endpointRule306(S3EndpointParams params, RulePartition bucketPartition,
    ...
    private static RuleResult endpointRule307(S3EndpointParams params, RuleArn bucketArn, String outpostId,
                                              RulePartition bucketPartition) {
        if (RulesFunctions.isValidHostLabel(bucketArn.region(), true)) {
            RuleResult result = endpointRule308(params, bucketArn, outpostId, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid ARN: The account id may only contain a-z, A-Z, 0-9 and `-`. Found: `"
    ...
    private static RuleResult endpointRule308(S3EndpointParams params, RuleArn bucketArn, String outpostId,
                                              RulePartition bucketPartition) {
        if (RulesFunctions.isValidHostLabel(bucketArn.accountId(), false)) {
            RuleResult result = endpointRule309(params, bucketArn, outpostId, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule309(S3EndpointParams params, RuleArn bucketArn, String outpostId,
                                              RulePartition bucketPartition) {
        String outpostType = RulesFunctions.listAccess(bucketArn.resourceId(), 2);
        if (outpostType != null) {
            RuleResult result = endpointRule310(params, bucketArn, outpostType, outpostId, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule310(S3EndpointParams params, RuleArn bucketArn, String outpostType, String outpostId,
                                              RulePartition bucketPartition) {
        String accessPointName = RulesFunctions.listAccess(bucketArn.resourceId(), 3);
        if (accessPointName != null) {
            RuleResult result = endpointRule311(params, outpostType, accessPointName, bucketArn, outpostId, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule311(S3EndpointParams params, String outpostType, String accessPointName,
                                              RuleArn bucketArn, String outpostId, RulePartition bucketPartition) {
        if ("accesspoint".equals(outpostType)) {
            RuleResult result = endpointRule312(params, accessPointName, bucketArn, outpostId, bucketPartition);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid ARN: The access point name may only contain a-z, A-Z, 0-9 and `-`. Found: `"
    ...
    private static RuleResult endpointRule312(S3EndpointParams params, String accessPointName, RuleArn bucketArn,
                                              String outpostId, RulePartition bucketPartition) {
        if (RulesFunctions.isValidHostLabel(accessPointName, false)) {
            if (params.endpoint() != null) {
                RuleUrl url = RulesFunctions.parseURL(params.endpoint());
                if (url != null) {
    ...
    private static RuleResult endpointRule328(S3EndpointParams params, String region) {
        String uriEncodedBucket = RulesFunctions.uriEncode(params.bucket());
        if (uriEncodedBucket != null) {
    ...
    private static RuleResult endpointRule329(S3EndpointParams params, String region, String uriEncodedBucket) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule330(params, region, partitionResult, uriEncodedBucket);
            if (result.isResolved()) {
                return result;
            }
    ...
    private static RuleResult endpointRule330(S3EndpointParams params, String region, RulePartition partitionResult,
        ...
        if (!params.accelerate()) {
            if (params.useDualStack() && params.endpoint() == null && params.useFips() && "aws-global".equals(region)) {
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .endpointUrl(
                                                   EndpointUrl.fromComponents("https", "s3-fips.dualstack.us-east-1." + partitionResult.dnsSuffix(),
                                                                              -1, "/" + uriEncodedBucket))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
            ...
            RuleResult result = endpointRule332(params, region, partitionResult, uriEncodedBucket);
            if (result.isResolved()) {
                return result;
            }
            if (params.useDualStack() && params.endpoint() == null && params.useFips() && !("aws-global".equals(region))
            ...
            if (params.useDualStack() && params.endpoint() == null && !params.useFips() && !("aws-global".equals(region))
                ...
                return RuleResult.endpoint(Endpoint
                                               .builder()
                                               .endpointUrl(
                                                   EndpointUrl.fromComponents("https", "s3.dualstack." + region + "." + partitionResult.dnsSuffix(),
                                                                              -1, "/" + uriEncodedBucket))
                                               .putAttribute(
                                                   AwsEndpointAttribute.AUTH_SCHEMES,
                                                   Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
    ...
    private static RuleResult endpointRule340(S3EndpointParams params, String region, RulePartition partitionResult,
                                              String uriEncodedBucket) {
        if (params.useDualStack() && params.endpoint() == null && !params.useFips() && !("aws-global".equals(region))
            && params.useGlobalEndpoint()) {
            return RuleResult.endpoint(Endpoint
    ...
    private static RuleResult endpointRule344(S3EndpointParams params, String region, String uriEncodedBucket) {
        if (!params.useDualStack() && params.endpoint() != null) {
            RuleUrl url = RulesFunctions.parseURL(params.endpoint());
            if (url != null) {
                if (!params.useFips() && !("aws-global".equals(region)) && params.useGlobalEndpoint()) {
    ...
    private static RuleResult endpointRule349(S3EndpointParams params, String region, RulePartition partitionResult,
                                              String uriEncodedBucket) {
        if (!params.useDualStack() && params.endpoint() == null && !params.useFips() && !("aws-global".equals(region))
            && params.useGlobalEndpoint()) {
            if ("us-east-1".equals(region)) {
    ...
    private static RuleResult endpointRule354(S3EndpointParams params, String region) {
    ...
    private static RuleResult endpointRule355(S3EndpointParams params, String region) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule356(params, region, partitionResult);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid region: region was not a valid DNS name.");
    ...
    private static RuleResult endpointRule356(S3EndpointParams params, String region, RulePartition partitionResult) {
    ...
    private static RuleResult endpointRule363(S3EndpointParams params, String region) {
        if (params.bucket() == null) {
    ...
    private static RuleResult endpointRule364(S3EndpointParams params, String region) {
        RulePartition partitionResult = RulesFunctions.awsPartition(region);
        if (partitionResult != null) {
            RuleResult result = endpointRule365(params, region, partitionResult);
            if (result.isResolved()) {
                return result;
            }
            return RuleResult.error("Invalid region: region was not a valid DNS name.");
    ...
    private static RuleResult endpointRule365(S3EndpointParams params, String region, RulePartition partitionResult) {
        if (RulesFunctions.isValidHostLabel(region, true)) {
            ...
            RuleResult result = endpointRule367(params, region, partitionResult);
            if (result.isResolved()) {
                return result;
            }
            if (params.useFips() && params.useDualStack() && params.endpoint() == null && !("aws-global".equals(region))
    ...
    private static RuleResult endpointRule375(S3EndpointParams params, String region, RulePartition partitionResult) {
        if (!params.useFips() && params.useDualStack() && params.endpoint() == null && !("aws-global".equals(region))
            && params.useGlobalEndpoint()) {
            return RuleResult.endpoint(Endpoint
                                           .builder()
    ...
    private static RuleResult endpointRule379(S3EndpointParams params, String region) {
        if (!params.useFips() && !params.useDualStack() && params.endpoint() != null) {
            RuleUrl url = RulesFunctions.parseURL(params.endpoint());
            if (url != null) {
                if (!("aws-global".equals(region)) && params.useGlobalEndpoint()) {
    ...
    private static RuleResult endpointRule384(S3EndpointParams params, String region, RulePartition partitionResult) {
        if (!params.useFips() && !params.useDualStack() && params.endpoint() == null && !("aws-global".equals(region))
            && params.useGlobalEndpoint()) {
            if ("us-east-1".equals(region)) {
                return RuleResult.endpoint(Endpoint
