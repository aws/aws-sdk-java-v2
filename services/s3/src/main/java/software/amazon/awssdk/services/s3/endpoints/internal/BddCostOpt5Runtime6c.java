...
// Optimized loop (no complimented nodes)[codegenerated]
// Optimize params - access directly rather than copying into Evaluator members
public final class BddCostOpt5Runtime6c implements S3EndpointProvider {
    ...
    private static final class Evaluator {
        ...
        public final boolean cond(int i) {
            switch (i) {
                ...
                case 4: {
                    return (RulesFunctions.coalesce(params.disableS3ExpressSessionAuth(), false));
                }
                case 5: {
                ...
                case 23: {
                    s3expressAvailabilityZoneId = RulesFunctions.listAccess(RulesFunctions.split(params.bucket(), "--", 0), 1);
                ...
                case 34: {
                    _effective_arn_region = RulesFunctions.ite(RulesFunctions.coalesce(params.useArnRegion(), true),
        ...
        private final RuleResult result10() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".s3express" + _s3e_fips + "-" + s3expressAvailabilityZoneId
                                                           + _s3e_ds + "." + _effective_std_region + "." + partitionResult.dnsSuffix()))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(AwsEndpointAttribute.AUTH_SCHEMES,
                                                         Arrays.asList(DynamicAuthBuilder.builder().name(_s3e_auth).build())).build());
        }
        ...
        private final RuleResult result16() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".ec2.s3-outposts." + _effective_std_region + "."
                                                           + partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4aAuthScheme.builder().disableDoubleEncoding(true).signingName("s3-outposts")
        ...
        private final RuleResult result17() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".op-" + outpostId_ssa_2 + "." + url.authority()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4aAuthScheme.builder().disableDoubleEncoding(true).signingName("s3-outposts")
                                                                             .signingRegionSet(Arrays.asList("*")).build(), SigV4AuthScheme.builder()
        ...
        private final RuleResult result18() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".op-" + outpostId_ssa_2 + ".s3-outposts."
        ...
        private final RuleResult result23() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".s3-fips.dualstack." + _effective_std_region + "."
                                                           + partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        private final RuleResult result24() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".s3-fips." + _effective_std_region + "."
                                                           + partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        private final RuleResult result25() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".s3-accelerate.dualstack." + _effective_std_region + "."
                                                           + partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        private final RuleResult result27() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".s3.dualstack." + _effective_std_region + "."
                                                           + partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        private final RuleResult result32() {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(URI.create("https://" + params.bucket() + ".s3." + _effective_std_region + "."
                                                           + partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
