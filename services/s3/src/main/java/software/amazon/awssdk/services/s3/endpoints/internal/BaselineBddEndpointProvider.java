...
@SdkInternalApi
public final class BaselineBddEndpointProvider implements S3EndpointProvider {
    private static final int[] BDD_DEFINITION;

    static {
        try (InputStream in = DefaultS3EndpointProvider.class.getResourceAsStream("/endpoints_bdd_e5f89a44.bin")) {
            if (in == null) {
                throw new IllegalStateException("Resource /endpoints_bdd_e5f89a44.bin not found");
            }
            BDD_DEFINITION = new int[1659];
    ...
    private static final class Evaluator {
        ...
        private final RuleResult result113() {
            return RuleResult.endpoint(Endpoint
                    .builder()
        ...
        private final RuleResult result114() {
