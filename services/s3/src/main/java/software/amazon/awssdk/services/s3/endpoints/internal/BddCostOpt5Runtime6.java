    ...
    private static final class Evaluator {
        ...
        public final boolean cond(int i) {
            switch (i) {
                ...
                case 4: {
                    return (RulesFunctions.coalesce(disableS3ExpressSessionAuth, false) != null);
                }
                case 5: {
                ...
                case 25: {
                    return (RulesFunctions.coalesce(useS3ExpressControlEndpoint, false) != null);
                }
                case 26: {
                ...
                case 38: {
                    return (RulesFunctions.coalesce(useObjectLambdaEndpoint, false) != null);
                }
                case 39: {
                ...
                case 54: {
                    return (RulesFunctions.coalesce(disableAccessPoints, false) != null);
                }
                case 55: {
                ...
                case 59: {
                    return (RulesFunctions.coalesce(useArnRegion, true) != null);
                }
                case 60: {
