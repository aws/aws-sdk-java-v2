...
@SdkInternalApi
public final class BddCostOpt2Runtime3 implements S3EndpointProvider {
    private static final int[] BDD_DEFINITION = { -1, 1, -1, 0, 3, 100000200, 4, 828, 4, 5, 569, 5, 1, 163, 6, 2, 12, 7, 19, 8,
    ...
    private static final ConditionFn[] CONDITION_FNS = {
        ...
        }, // condition 19, assign partitionResult
        (registers) -> {
        ...
        }, // condition 30, assign s3expressAvailabilityZoneId_ssa_6
        (registers) -> {
        ...
        }, // condition 32, assign s3expressAvailabilityZoneId_ssa_7
        (registers) -> {
        ...
        }, // condition 43, assign outpostId_ssa_1
        (registers) -> {
        ...
        }, // condition 44, assign s3expressAvailabilityZoneId_ssa_1
        (registers) -> {
        ...
        }, // condition 45, assign s3expressAvailabilityZoneId_ssa_8
        (registers) -> {
        ...
        }, // condition 46, assign s3expressAvailabilityZoneId_ssa_3
        (registers) -> {
        ...
        }, // condition 47, assign s3expressAvailabilityZoneId_ssa_4
        (registers) -> {
        ...
        }, // condition 49, assign accessPointName_ssa_1
        (registers) -> {
        ...
        }, // condition 53, assign s3expressAvailabilityZoneId_ssa_9
        (registers) -> {
        ...
        }, // condition 54, assign s3expressAvailabilityZoneId_ssa_5
        (registers) -> {
        ...
        }, // condition 55, assign s3expressAvailabilityZoneId_ssa_10
        (registers) -> {
        ...
        }, // condition 78, assign bucketPartition
        (registers) -> {
