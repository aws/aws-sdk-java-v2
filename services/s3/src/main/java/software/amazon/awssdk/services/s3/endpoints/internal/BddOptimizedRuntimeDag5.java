...
@SdkInternalApi
public final class BddOptimizedRuntimeDag5 implements S3EndpointProvider {
    ...
    private static final ResultFn[] RESULT_FNS = {
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI(registers.url.scheme(), registers.url.authority() + "/"
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI(registers.url.scheme(), registers.bucket + "." + registers.url.authority()
                                                                                                 + registers.url.path()))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3express-control-fips.dualstack." + registers.region + "."
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3express-control-fips." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix() + "/" + registers.uri_encoded_bucket))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3express-control.dualstack." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix() + "/" + registers.uri_encoded_bucket))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3express-control." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix() + "/" + registers.uri_encoded_bucket))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3express-fips-"
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3express-"
                                                                                  + registers.s3expressAvailabilityZoneId_ssa_1 + ".dualstack." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI(registers.url.scheme(), registers.url.authority() + registers.url.path()))
                                           .putAttribute(KnownS3ExpressEndpointProperty.BACKEND, "S3Express")
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3express")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".ec2." + registers.url.authority()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".ec2.s3-outposts." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4aAuthScheme.builder().disableDoubleEncoding(true).signingName("s3-outposts")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".op-" + registers.outpostId_ssa_2 + "."
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".op-" + registers.outpostId_ssa_2
                                                                                  + ".s3-outposts." + registers.region + "." + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4aAuthScheme.builder().disableDoubleEncoding(true).signingName("s3-outposts")
                                                                             .signingRegionSet(Arrays.asList("*")).build(), SigV4AuthScheme.builder()
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3-fips.dualstack.us-east-1."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3-fips.dualstack." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3-fips.us-east-1."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3-fips." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3-accelerate.dualstack.us-east-1."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3-accelerate.dualstack."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3.dualstack.us-east-1."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3.dualstack." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI(registers.url.scheme(),
                                                                         registers.url.authority() + registers.url.normalizedPath() + registers.bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                            .signingRegion("us-east-1").build())).build());
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         registers.bucket + ".s3-accelerate." + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                            .signingRegion("us-east-1").build())).build());
        ...
        (registers) -> {
            return RuleResult
                .endpoint(Endpoint
                              .builder()
                              .url(RulesFunctions.createURI("https",
                                                            registers.bucket + ".s3." + registers.partitionResult.dnsSuffix()))
                              .putAttribute(
                                  AwsEndpointAttribute.AUTH_SCHEMES,
                                  Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                               .signingRegion("us-east-1").build())).build());
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.bucket + ".s3." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI(registers.url.scheme(), registers.accessPointName_ssa_1 + "-"
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         registers.accessPointName_ssa_1 + "-" + registers.bucketArn.accountId()
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         registers.accessPointName_ssa_1 + "-" + registers.bucketArn.accountId() + ".s3-object-lambda."
                                                                         + registers.bucketArn.region() + "." + registers.bucketPartition.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true)
                                                                            .signingName("s3-object-lambda").signingRegion(registers.bucketArn.region()).build()))
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         registers.accessPointName_ssa_1 + "-" + registers.bucketArn.accountId() + ".s3-accesspoint-fips."
                                                                         + registers.bucketArn.region() + "." + registers.bucketPartition.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         registers.accessPointName_ssa_1 + "-" + registers.bucketArn.accountId() + ".s3-accesspoint."
                                                                         + registers.bucketArn.region() + "." + registers.bucketPartition.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", registers.accessPointName_ssa_1 + ".accesspoint.s3-global."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         registers.accessPointName_ssa_2 + "-" + registers.bucketArn.accountId() + "."
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         "s3-fips.dualstack.us-east-1." + registers.partitionResult.dnsSuffix() + "/"
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3-fips.dualstack." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix() + "/" + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3-fips.us-east-1." + registers.partitionResult.dnsSuffix() + "/"
                                                                                  + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         "s3-fips." + registers.region + "." + registers.partitionResult.dnsSuffix() + "/"
                                                                         + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3.dualstack.us-east-1." + registers.partitionResult.dnsSuffix()
                                                                                  + "/" + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3.dualstack." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix() + "/" + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI(registers.url.scheme(),
                                                                         registers.url.authority() + registers.url.normalizedPath() + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                                            .signingRegion("us-east-1").build())).build());
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3." + registers.partitionResult.dnsSuffix() + "/"
                                                                                  + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https",
                                                                         "s3." + registers.region + "." + registers.partitionResult.dnsSuffix() + "/"
                                                                         + registers.uri_encoded_bucket))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3-object-lambda-fips." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true)
        ...
        (registers) -> {
            return RuleResult.endpoint(Endpoint
                                           .builder()
                                           .url(RulesFunctions.createURI("https", "s3-object-lambda." + registers.region + "."
                                                                                  + registers.partitionResult.dnsSuffix()))
                                           .putAttribute(
                                               AwsEndpointAttribute.AUTH_SCHEMES,
                                               Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true)
        ...
        (registers) -> {
            return RuleResult
                .endpoint(Endpoint
                              .builder()
                              .url(RulesFunctions.createURI("https",
                                                            "s3.dualstack.us-east-1." + registers.partitionResult.dnsSuffix()))
                              .putAttribute(
                                  AwsEndpointAttribute.AUTH_SCHEMES,
                                  Arrays.asList(SigV4AuthScheme.builder().disableDoubleEncoding(true).signingName("s3")
                                                               .signingRegion("us-east-1").build())).build());
