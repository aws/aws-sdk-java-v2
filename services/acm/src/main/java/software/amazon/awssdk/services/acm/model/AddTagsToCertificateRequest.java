...
public final class AddTagsToCertificateRequest extends AcmRequest implements
        ToCopyableBuilder<AddTagsToCertificateRequest.Builder, AddTagsToCertificateRequest> {
    private static final SdkField<String> CERTIFICATE_ARN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("CertificateArn").getter(getter(AddTagsToCertificateRequest::certificateArn))
    ...
    private static final SdkField<List<Tag>> TAGS_FIELD = SdkField
            ...
            .memberName("Tags")
            .getter(getter(AddTagsToCertificateRequest::tags))
    ...
    private AddTagsToCertificateRequest(BuilderImpl builder) {
        super(builder);
    ...
    public final String toString() {
        return ToString.builder("AddTagsToCertificateRequest").add("CertificateArn", certificateArn())
    ...
    private static <T> Function<Object, T> getter(Function<AddTagsToCertificateRequest, T> g) {
        return obj -> g.apply((AddTagsToCertificateRequest) obj);
    }
    ...
    public interface Builder extends AcmRequest.Builder, SdkPojo, CopyableBuilder<Builder, AddTagsToCertificateRequest> {
        /**
         * <p>
         ...
         *        String that contains the ARN of the ACM certificate to which the tag is to be applied. This must be of
         *        the form:</p>
         *        <p>
         *        <code>arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012</code>
         *        </p>
    ...
    static final class BuilderImpl extends AcmRequest.BuilderImpl implements Builder {
        ...
        private BuilderImpl(AddTagsToCertificateRequest model) {
            super(model);
        ...
        @Override
        public AddTagsToCertificateRequest build() {
