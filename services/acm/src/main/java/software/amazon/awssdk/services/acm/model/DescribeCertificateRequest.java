...
public final class DescribeCertificateRequest extends AcmRequest implements
        ToCopyableBuilder<DescribeCertificateRequest.Builder, DescribeCertificateRequest> {
    private static final SdkField<String> CERTIFICATE_ARN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("CertificateArn").getter(getter(DescribeCertificateRequest::certificateArn))
    ...
    private DescribeCertificateRequest(BuilderImpl builder) {
        super(builder);
    ...
    public final String toString() {
        return ToString.builder("DescribeCertificateRequest").add("CertificateArn", certificateArn()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<DescribeCertificateRequest, T> g) {
        return obj -> g.apply((DescribeCertificateRequest) obj);
    }
    ...
    public interface Builder extends AcmRequest.Builder, SdkPojo, CopyableBuilder<Builder, DescribeCertificateRequest> {
        /**
         * <p>
         * The Amazon Resource Name (ARN) of the ACM certificate. The ARN must have the following form:
         * </p>
    ...
    static final class BuilderImpl extends AcmRequest.BuilderImpl implements Builder {
        ...
        private BuilderImpl(DescribeCertificateRequest model) {
            super(model);
