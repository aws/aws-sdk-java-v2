...
public final class LimitExceededException extends AcmException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, LimitExceededException>, AcmException.Builder {
        @Override
