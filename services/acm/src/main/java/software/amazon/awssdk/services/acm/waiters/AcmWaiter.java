...
@SdkPublicApi
public interface AcmWaiter extends SdkAutoCloseable {
    /**
     * Polls {@link AcmClient#describeCertificate} API until the desired condition {@code CertificateValidated} is met,
     ...
     *         condition
     */
    default WaiterResponse<DescribeCertificateResponse> waitUntilCertificateValidated(
    ...
    /**
     * Create a builder that can be used to configure and create a {@link AcmWaiter}.
     *
     * @return a builder
     */
    static Builder builder() {
        return DefaultAcmWaiter.builder();
    }

    /**
     * Create an instance of {@link AcmWaiter} with the default configuration.
     * <p>
     * <b>A default {@link AcmClient} will be created to poll resources. It is recommended to share a single instance of
     ...
     */
    static AcmWaiter create() {
        return DefaultAcmWaiter.builder().build();
    }
    ...
    interface Builder {
        ...
        /**
         * Sets a custom {@link AcmClient} that will be used to poll the resource
         * <p>
         ...
         * @return a reference to this object so that method calls can be chained together.
         */
        Builder client(AcmClient client);

        /**
         * Builds an instance of {@link AcmWaiter} based on the configurations supplied to this builder
         *
         * @return An initialized {@link AcmWaiter}
         */
        AcmWaiter build();
    }
}
