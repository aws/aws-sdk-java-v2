...
public final class ThrottlingException extends AcmException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ThrottlingException>, AcmException.Builder {
        @Override
