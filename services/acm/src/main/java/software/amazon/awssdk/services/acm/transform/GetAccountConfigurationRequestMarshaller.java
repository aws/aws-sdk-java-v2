...
/**
 * {@link GetAccountConfigurationRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetAccountConfigurationRequestMarshaller implements Marshaller<GetAccountConfigurationRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/")
            ...
            .hasPayloadMembers(false).operationIdentifier("CertificateManager.GetAccountConfiguration").build();
    ...
    public SdkHttpFullRequest marshall(GetAccountConfigurationRequest getAccountConfigurationRequest) {
        Validate.paramNotNull(getAccountConfigurationRequest, "getAccountConfigurationRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getAccountConfigurationRequest);
        } catch (Exception e) {
