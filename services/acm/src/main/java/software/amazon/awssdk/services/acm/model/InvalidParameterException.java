...
public final class InvalidParameterException extends AcmException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, InvalidParameterException>, AcmException.Builder {
        @Override
