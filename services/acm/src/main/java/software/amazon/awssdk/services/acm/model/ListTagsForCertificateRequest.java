...
public final class ListTagsForCertificateRequest extends AcmRequest implements
        ToCopyableBuilder<ListTagsForCertificateRequest.Builder, ListTagsForCertificateRequest> {
    private static final SdkField<String> CERTIFICATE_ARN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("CertificateArn").getter(getter(ListTagsForCertificateRequest::certificateArn))
    ...
    private ListTagsForCertificateRequest(BuilderImpl builder) {
        super(builder);
    ...
    public final String toString() {
        return ToString.builder("ListTagsForCertificateRequest").add("CertificateArn", certificateArn()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<ListTagsForCertificateRequest, T> g) {
        return obj -> g.apply((ListTagsForCertificateRequest) obj);
    }
    ...
    public interface Builder extends AcmRequest.Builder, SdkPojo, CopyableBuilder<Builder, ListTagsForCertificateRequest> {
        /**
         * <p>
         * String that contains the ARN of the ACM certificate for which you want to list the tags. This must have the
         * following form:
    ...
    static final class BuilderImpl extends AcmRequest.BuilderImpl implements Builder {
        ...
        private BuilderImpl(ListTagsForCertificateRequest model) {
            super(model);
        ...
        @Override
        public ListTagsForCertificateRequest build() {
            return new ListTagsForCertificateRequest(this);
        }
