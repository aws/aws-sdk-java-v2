...
public final class AccessDeniedException extends AcmException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, AccessDeniedException>, AcmException.Builder {
        @Override
