...
public final class ValidationException extends AcmException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ValidationException>, AcmException.Builder {
        @Override
