...
@SdkInternalApi
public final class AcmAuthSchemeInterceptor implements ExecutionInterceptor {
    ...
    private List<AuthSchemeOption> resolveAuthOptions(ExecutionAttributes executionAttributes) {
        ...
        AcmAuthSchemeProvider authSchemeProvider =
            (AcmAuthSchemeProvider) executionAttributes.getAttribute(SdkExecutionAttribute.AUTH_SCHEME_RESOLVER);
