...
public final class GetAccountConfigurationResponse extends AcmResponse implements
        ToCopyableBuilder<GetAccountConfigurationResponse.Builder, GetAccountConfigurationResponse> {
    private static final SdkField<ExpiryEventsConfiguration> EXPIRY_EVENTS_FIELD = SdkField
            ...
            .getter(getter(GetAccountConfigurationResponse::expiryEvents)).setter(setter(Builder::expiryEvents))
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        GetAccountConfigurationResponse other = (GetAccountConfigurationResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("GetAccountConfigurationResponse").add("ExpiryEvents", expiryEvents()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetAccountConfigurationResponse, T> g) {
        return obj -> g.apply((GetAccountConfigurationResponse) obj);
    }
    ...
    public interface Builder extends AcmResponse.Builder, SdkPojo, CopyableBuilder<Builder, GetAccountConfigurationResponse> {
        /**
         * <p>
         * Expiration events configuration options associated with the Amazon Web Services account.
         * </p>
