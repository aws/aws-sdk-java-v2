 ...
 * {@link software.amazon.awssdk.services.acm.AcmClient#listCertificatesPaginator(software.amazon.awssdk.services.acm.model.ListCertificatesRequest)}
 * operation which is a paginated operation. This class is an iterable of
 * {@link software.amazon.awssdk.services.acm.model.ListCertificatesResponse} that can be used to iterate through all
...
public class ListCertificatesIterable implements SdkIterable<ListCertificatesResponse> {
    ...
    /**
     * Returns an iterable to iterate through the paginated {@link ListCertificatesResponse#certificateSummaryList()}
    ...
    public final SdkIterable<CertificateSummary> certificateSummaryList() {
        ...
        return PaginatedItemsIterable.<ListCertificatesResponse, CertificateSummary> builder().pagesIterable(this)
