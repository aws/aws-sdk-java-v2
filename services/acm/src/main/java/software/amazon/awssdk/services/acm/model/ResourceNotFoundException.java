...
public final class ResourceNotFoundException extends AcmException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ResourceNotFoundException>, AcmException.Builder {
        @Override
