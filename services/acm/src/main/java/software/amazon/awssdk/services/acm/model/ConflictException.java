...
public final class ConflictException extends AcmException implements
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ConflictException>, AcmException.Builder {
        @Override
