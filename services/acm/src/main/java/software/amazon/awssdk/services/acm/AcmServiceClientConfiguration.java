...
@SdkPublicApi
public final class AcmServiceClientConfiguration extends AwsServiceClientConfiguration {
    private AcmServiceClientConfiguration(Builder builder) {
        super(builder);
    }
    ...
    /**
     * A builder for creating a {@link AcmServiceClientConfiguration}
     */
    public interface Builder extends AwsServiceClientConfiguration.Builder {
        @Override
        AcmServiceClientConfiguration build();
    ...
    private static final class BuilderImpl extends AwsServiceClientConfiguration.BuilderImpl implements Builder {
        ...
        private BuilderImpl(AcmServiceClientConfiguration serviceClientConfiguration) {
        ...
        @Override
        public AcmServiceClientConfiguration build() {
            return new AcmServiceClientConfiguration(this);
        }
    }
}
