...
public final class DeleteCertificateRequest extends AcmRequest implements
        ToCopyableBuilder<DeleteCertificateRequest.Builder, DeleteCertificateRequest> {
    private static final SdkField<String> CERTIFICATE_ARN_FIELD = SdkField.<String> builder(MarshallingType.STRING)
            .memberName("CertificateArn").getter(getter(DeleteCertificateRequest::certificateArn))
    ...
    public final String toString() {
        return ToString.builder("DeleteCertificateRequest").add("CertificateArn", certificateArn()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<DeleteCertificateRequest, T> g) {
        return obj -> g.apply((DeleteCertificateRequest) obj);
    }
    ...
    public interface Builder extends AcmRequest.Builder, SdkPojo, CopyableBuilder<Builder, DeleteCertificateRequest> {
        /**
         * <p>
         * String that contains the ARN of the ACM certificate to be deleted. This must be of the form:
         * </p>
