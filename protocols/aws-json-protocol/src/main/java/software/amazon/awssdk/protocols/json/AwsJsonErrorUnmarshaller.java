...
import software.amazon.awssdk.protocols.json.internal.unmarshall.JsonErrorUnmarshaller;

/**
 * Unmarshaller for JSON error responses from AWS services.
 */
// TODO this is only protected due to an Ion test class. Can we fix that?
@SdkProtectedApi
@ThreadSafe
